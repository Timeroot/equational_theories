import equational_theories.Definability.Srch_S7R301_data
...
is `decide` on `Fin 7`; the searching is in `Definability/Certs/Srch7R301T*.lean`.
-/
...
theorem not_structuralFromFin_of_srch7R301 {L L' : Law.NatMagmaLaw} (v : Magma.tup7R301)
    (hsrc : @satisfies _ (Fin 7) (Magma.srch7R301 v) L')
    (htgt : ∀ u : Magma.tup7R301, ¬ @satisfies _ (Fin 7) (Magma.srch7R301 u) L) :
    ¬ L.StructuralFromFin L' :=
  Law.MagmaLaw.not_structuralFromFin_of_tupOK S7R301.E S7R301.Einv S7R301.X S7R301.Xinv S7R301.rep S7R301.tr
    S7R301.z S7R301.st S7R301.hl S7R301.hr S7R301.hxl S7R301.hxr S7R301.htr S7R301.hz S7R301.hst v.1 v.2 hsrc htgt
