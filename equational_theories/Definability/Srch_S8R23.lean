import equational_theories.Definability.Srch_S8R23_data
...
is `decide` on `Fin 8`; the searching is in `Definability/Certs/Srch8R23T*.lean`.
-/
...
theorem not_structuralFromFin_of_srch8R23 {L L' : Law.NatMagmaLaw} (v : Magma.tup8R23)
    (hsrc : @satisfies _ (Fin 8) (Magma.srch8R23 v) L')
    (htgt : ∀ u : Magma.tup8R23, ¬ @satisfies _ (Fin 8) (Magma.srch8R23 u) L) :
    ¬ L.StructuralFromFin L' :=
  Law.MagmaLaw.not_structuralFromFin_of_tupOK S8R23.E S8R23.Einv S8R23.X S8R23.Xinv S8R23.rep S8R23.tr
    S8R23.z S8R23.st S8R23.hl S8R23.hr S8R23.hxl S8R23.hxr S8R23.htr S8R23.hz S8R23.hst v.1 v.2 hsrc htgt
