import equational_theories.Definability.Srch_S10R801_data
...
is `decide` on `Fin 10`; the searching is in `Definability/Certs/Srch10R801T*.lean`.
-/
...
theorem not_structuralFromFin_of_srch10R801 {L L' : Law.NatMagmaLaw} (v : Magma.tup10R801)
    (hsrc : @satisfies _ (Fin 10) (Magma.srch10R801 v) L')
    (htgt : ∀ u : Magma.tup10R801, ¬ @satisfies _ (Fin 10) (Magma.srch10R801 u) L) :
    ¬ L.StructuralFromFin L' :=
  Law.MagmaLaw.not_structuralFromFin_of_tupOK S10R801.E S10R801.Einv S10R801.X S10R801.Xinv S10R801.rep S10R801.tr
    S10R801.z S10R801.st S10R801.hl S10R801.hr S10R801.hxl S10R801.hxr S10R801.htr S10R801.hz S10R801.hst v.1 v.2 hsrc htgt
