...
run_elab do
  let names : List Lean.Name := [
    ``GuardAut2_pxx_pypyx_x_y_pyx_pxx_pyx_Equation1,
    ``GuardAut2_pxx_x_pyx_y_pyx_y_pyx_Equation1,
    ``GuardAut2_pxy_pypyx_pyx_y_pyx_y_pyx_Equation1,
    ``GuardAut2_pxy_pyx_pyx_y_pxy_y_pyx_Equation1,
    ``GuardAut2_pypxy_pyx_x_y_pyx_pxx_pyx_Equation1,
    ``GuardAut2_pypxy_pyy_pxy_y_pxy_y_pxy_Equation1]
