...
/-- No aff13h156a-invariant operation on `Fin 13` satisfies equation 667. -/
theorem noaff13h156a_Law667 : ∀ v : ∀ i : Fin 2,
    {x : Fin 13 // Magma.orbitOK aff13h156a.E aff13h156a.z aff13h156a.st i x},
    ¬ @satisfies _ (Fin 13)
      (Magma.mk (Magma.transport aff13h156a.E aff13h156a.tr fun i ↦ (v i).1)) Law667 := by
