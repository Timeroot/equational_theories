import equational_theories.Definability.Srch_S10R401_data
...
is `decide` on `Fin 10`; the searching is in `Definability/Certs/Srch10R401T*.lean`.
-/
...
theorem not_structuralFromFin_of_srch10R401 {L L' : Law.NatMagmaLaw} (v : Magma.tup10R401)
    (hsrc : @satisfies _ (Fin 10) (Magma.srch10R401 v) L')
    (htgt : ∀ u : Magma.tup10R401, ¬ @satisfies _ (Fin 10) (Magma.srch10R401 u) L) :
    ¬ L.StructuralFromFin L' :=
  Law.MagmaLaw.not_structuralFromFin_of_tupOK S10R401.E S10R401.Einv S10R401.X S10R401.Xinv S10R401.rep S10R401.tr
    S10R401.z S10R401.st S10R401.hl S10R401.hr S10R401.hxl S10R401.hxr S10R401.htr S10R401.hz S10R401.hst v.1 v.2 hsrc htgt
