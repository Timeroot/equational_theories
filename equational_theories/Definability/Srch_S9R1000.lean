import equational_theories.Definability.Srch_S9R1000_data
...
is `decide` on `Fin 9`; the searching is in `Definability/Certs/Srch9R1000T*.lean`.
-/
...
theorem not_structuralFromFin_of_srch9R1000 {L L' : Law.NatMagmaLaw} (v : Magma.tup9R1000)
    (hsrc : @satisfies _ (Fin 9) (Magma.srch9R1000 v) L')
    (htgt : ∀ u : Magma.tup9R1000, ¬ @satisfies _ (Fin 9) (Magma.srch9R1000 u) L) :
    ¬ L.StructuralFromFin L' :=
  Law.MagmaLaw.not_structuralFromFin_of_tupOK S9R1000.E S9R1000.Einv S9R1000.X S9R1000.Xinv S9R1000.rep S9R1000.tr
    S9R1000.z S9R1000.st S9R1000.hl S9R1000.hr S9R1000.hxl S9R1000.hxr S9R1000.htr S9R1000.hz S9R1000.hst v.1 v.2 hsrc htgt
