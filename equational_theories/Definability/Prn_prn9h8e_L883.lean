...
/-- The orbits of the prn9h8e family, as the search takes them when refuting equation
883. This is a set, not an order: the kernel picks which one to branch on at each
node. -/
def ordprn9h8e_Law883 : List (Fin 11) := List.finRange 11
