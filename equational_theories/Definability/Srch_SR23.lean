import equational_theories.Definability.Srch_SR23_data
...
is `decide` on `Fin 6`; the searching is in `Definability/Certs/SrchR23T*.lean`.
-/
...
theorem not_structuralFromFin_of_srchR23 {L L' : Law.NatMagmaLaw} (v : Magma.tupR23)
    (hsrc : @satisfies _ (Fin 6) (Magma.srchR23 v) L')
    (htgt : ∀ u : Magma.tupR23, ¬ @satisfies _ (Fin 6) (Magma.srchR23 u) L) :
    ¬ L.StructuralFromFin L' :=
  Law.MagmaLaw.not_structuralFromFin_of_tupOK SR23.E SR23.Einv SR23.X SR23.Xinv SR23.rep SR23.tr
    SR23.z SR23.st SR23.hl SR23.hr SR23.hxl SR23.hxr SR23.htr SR23.hz SR23.hst v.1 v.2 hsrc htgt
