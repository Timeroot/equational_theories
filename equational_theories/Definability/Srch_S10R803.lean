import equational_theories.Definability.Srch_S10R803_data
...
is `decide` on `Fin 10`; the searching is in `Definability/Certs/Srch10R803T*.lean`.
-/
...
theorem not_structuralFromFin_of_srch10R803 {L L' : Law.NatMagmaLaw} (v : Magma.tup10R803)
    (hsrc : @satisfies _ (Fin 10) (Magma.srch10R803 v) L')
    (htgt : ∀ u : Magma.tup10R803, ¬ @satisfies _ (Fin 10) (Magma.srch10R803 u) L) :
    ¬ L.StructuralFromFin L' :=
  Law.MagmaLaw.not_structuralFromFin_of_tupOK S10R803.E S10R803.Einv S10R803.X S10R803.Xinv S10R803.rep S10R803.tr
    S10R803.z S10R803.st S10R803.hl S10R803.hr S10R803.hxl S10R803.hxr S10R803.htr S10R803.hz S10R803.hst v.1 v.2 hsrc htgt
