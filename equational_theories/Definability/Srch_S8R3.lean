import equational_theories.Definability.Srch_S8R3_data
...
is `decide` on `Fin 8`; the searching is in `Definability/Certs/Srch8R3T*.lean`.
-/
...
theorem not_structuralFromFin_of_srch8R3 {L L' : Law.NatMagmaLaw} (v : Magma.tup8R3)
    (hsrc : @satisfies _ (Fin 8) (Magma.srch8R3 v) L')
    (htgt : ∀ u : Magma.tup8R3, ¬ @satisfies _ (Fin 8) (Magma.srch8R3 u) L) :
    ¬ L.StructuralFromFin L' :=
  Law.MagmaLaw.not_structuralFromFin_of_tupOK S8R3.E S8R3.Einv S8R3.X S8R3.Xinv S8R3.rep S8R3.tr
    S8R3.z S8R3.st S8R3.hl S8R3.hr S8R3.hxl S8R3.hxr S8R3.htr S8R3.hz S8R3.hst v.1 v.2 hsrc htgt
