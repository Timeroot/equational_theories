...
/-!
# Source 43: cells landed by an idempotent iterate applied outside the defining term
...
/-- Equation 332 `x ◇ y = y ◇ (x ◇ x)` is term-definable from equation 43 over finite magmas, via the term
`x □ y := (x ◇ y)` with `u a = (a ◇ a)`
taken at x at u^[2N+1], y at u^[2N+1]. -/
private theorem aux43_332 [Magma G] (h : Equation43 G) (e v : G → G) (w : G → G → G)
    ...
    (w x y) =
      (w y (w x x)) := by
  by_contra nh
  have eq11 (X0 X1 : G) : (X0 ◇ X1) = (X1 ◇ X0) := mod_symm (h ..)
  ...
  have eq29 (X0 X1 : G) : (w X1 (e X0)) = ((e (v X1)) ◇ (e (e (v X0)))) := by first | exact superpose eq13 eq16 | exact mod_symm (superpose eq13 eq16) | exact superpose eq16 eq13 | exact mod_symm (superpose eq16 eq13)
  have eq34 (X0 X1 : G) : (w X0 X1) = ((e (v X1)) ◇ (e (v X0))) := by first | exact superpose eq16 eq11 | exact mod_symm (superpose eq16 eq11) | exact superpose eq11 eq16 | exact mod_symm (superpose eq11 eq16)
  have eq38 (X0 X1 : G) : (w X1 (e X0)) = ((e (v X1)) ◇ (e (v X0))) := by first | exact superpose eq12 eq29 | exact mod_symm (superpose eq12 eq29) | exact superpose eq29 eq12 | exact mod_symm (superpose eq29 eq12)
  ...
  have eq79 (X0 X1 : G) : (w X0 X1) = (w X1 X0) := by first | exact superpose eq34 eq16 | exact mod_symm (superpose eq34 eq16) | exact superpose eq16 eq34 | exact mod_symm (superpose eq16 eq34)
...
/-- Equation 3342 `x ◇ y = y ◇ (x ◇ (x ◇ x))` is term-definable from equation 43 over finite magmas, via the term
`x □ y := (x ◇ y)` with `u a = (a ◇ a)`
taken at x at u^[2N+1], y at u^[2N+1]. -/
private theorem aux43_3342 [Magma G] (h : Equation43 G) (e v : G → G) (w : G → G → G)
    (hee : ∀ a : G, e (e a) = e a) (hve : ∀ a : G, v (e a) = e (v a))
    (huv : ∀ a : G, ((v a) ◇ (v a)) = e a)
    (hvu : ∀ a : G, v (a ◇ a) = e a)
    (hw : ∀ a b : G, w a b = ((e (v a)) ◇ (e (v b))))
  ...
  have eq81 (X0 X1 : G) : (w X0 X1) = (w X1 X0) := by first | exact superpose eq34 eq16 | exact mod_symm (superpose eq34 eq16) | exact superpose eq16 eq34 | exact mod_symm (superpose eq16 eq34)
...
/-- Equation 3545 `x ◇ y = y ◇ ((x ◇ x) ◇ x)` is term-definable from equation 43 over finite magmas, via the term
`x □ y := (x ◇ y)` with `u a = (a ◇ a)`
taken at x at u^[2N+1], y at u^[2N+1]. -/
private theorem aux43_3545 [Magma G] (h : Equation43 G) (e v : G → G) (w : G → G → G)
    (hee : ∀ a : G, e (e a) = e a) (hve : ∀ a : G, v (e a) = e (v a))
    (huv : ∀ a : G, ((v a) ◇ (v a)) = e a)
    (hvu : ∀ a : G, v (a ◇ a) = e a)
    (hw : ∀ a b : G, w a b = ((e (v a)) ◇ (e (v b))))
  ...
  have eq27 (X0 X1 : G) : (w (e X0) X1) = ((e (e (v X0))) ◇ (e (v X1))) := by first | exact superpose eq13 eq16 | exact mod_symm (superpose eq13 eq16) | exact superpose eq16 eq13 | exact mod_symm (superpose eq16 eq13)
  have eq29 (X0 X1 : G) : (w X1 (e X0)) = ((e (v X1)) ◇ (e (e (v X0)))) := by first | exact superpose eq13 eq16 | exact mod_symm (superpose eq13 eq16) | exact superpose eq16 eq13 | exact mod_symm (superpose eq16 eq13)
  have eq34 (X0 X1 : G) : (w X0 X1) = ((e (v X1)) ◇ (e (v X0))) := by first | exact superpose eq16 eq11 | exact mod_symm (superpose eq16 eq11) | exact superpose eq11 eq16 | exact mod_symm (superpose eq11 eq16)
  have eq38 (X0 X1 : G) : (w X1 (e X0)) = ((e (v X1)) ◇ (e (v X0))) := by first | exact superpose eq12 eq29 | exact mod_symm (superpose eq12 eq29) | exact superpose eq29 eq12 | exact mod_symm (superpose eq29 eq12)
  have eq40 (X0 X1 : G) : ((e (v X0)) ◇ (e (v X1))) = (w (e X0) X1) := by first | exact superpose eq12 eq27 | exact mod_symm (superpose eq12 eq27) | exact superpose eq27 eq12 | exact mod_symm (superpose eq27 eq12)
  have eq42 (X0 X1 : G) : (w X1 (e X0)) = (w X1 X0) := by first | exact superpose eq16 eq38 | exact mod_symm (superpose eq16 eq38) | exact superpose eq38 eq16 | exact mod_symm (superpose eq38 eq16)
...
/-- Equation 4343 `x ◇ (y ◇ y) = y ◇ (x ◇ x)` is term-definable from equation 43 over finite magmas, via the term
`x □ y := (x ◇ y)` with `u a = (a ◇ a)`
taken at x at u^[2N+1], y at u^[2N+1]. -/
private theorem aux43_4343 [Magma G] (h : Equation43 G) (e v : G → G) (w : G → G → G)
    (hee : ∀ a : G, e (e a) = e a) (hve : ∀ a : G, v (e a) = e (v a))
    (huv : ∀ a : G, ((v a) ◇ (v a)) = e a)
    (hvu : ∀ a : G, v (a ◇ a) = e a)
    (hw : ∀ a b : G, w a b = ((e (v a)) ◇ (e (v b))))
  ...
  have eq30 (X0 X1 : G) : (w X1 (e X0)) = ((e (v X1)) ◇ (e (e (v X0)))) := by first | exact superpose eq13 eq16 | exact mod_symm (superpose eq13 eq16) | exact superpose eq16 eq13 | exact mod_symm (superpose eq16 eq13)
  have eq35 (X0 X1 : G) : (w X0 X1) = ((e (v X1)) ◇ (e (v X0))) := by first | exact superpose eq16 eq11 | exact mod_symm (superpose eq16 eq11) | exact superpose eq11 eq16 | exact mod_symm (superpose eq11 eq16)
  have eq39 (X0 X1 : G) : (w X1 (e X0)) = ((e (v X1)) ◇ (e (v X0))) := by first | exact superpose eq12 eq30 | exact mod_symm (superpose eq12 eq30) | exact superpose eq30 eq12 | exact mod_symm (superpose eq30 eq12)
...
theorem Equation332_termDefinableFromFin_Equation43 :
    Law332.TermDefinableFromFin Law43 := by
  ...
  letI : Magma G := M
  have h : Equation43 G := Law43.models_iff.mp hGL
  have huv : ∀ a : G, ((v a) ◇ (v a)) = e a := fun a ↦ he.u_comp_v a
  have hvu : ∀ a : G, v (a ◇ a) = e a := fun a ↦ he.v_comp_u a
  rw [@Law332.models_iff]
  intro x y
  exact aux43_332 h e v _ he.idem he.comm_v huv hvu (fun a b ↦ rfl) x y

theorem Equation3342_termDefinableFromFin_Equation43 :
    Law3342.TermDefinableFromFin Law43 := by
  refine termDefinableFromFin_of_iterate_pair (fun G ↦ (tm1 (Term.var 0) (Term.var 0)))
    (fun G ↦ (tm (Term.var 0) (Term.var 1))) 0 0 true true 1 1 ?_
  intro G _ M hGL N e v he
  letI : Magma G := M
  ...
  intro x y
  exact aux43_3342 h e v _ he.idem he.comm_v huv hvu (fun a b ↦ rfl) x y

theorem Equation3545_termDefinableFromFin_Equation43 :
    Law3545.TermDefinableFromFin Law43 := by
  refine termDefinableFromFin_of_iterate_pair (fun G ↦ (tm1 (Term.var 0) (Term.var 0)))
    (fun G ↦ (tm (Term.var 0) (Term.var 1))) 0 0 true true 1 1 ?_
  intro G _ M hGL N e v he
  letI : Magma G := M
  ...
  intro x y
  exact aux43_3545 h e v _ he.idem he.comm_v huv hvu (fun a b ↦ rfl) x y

theorem Equation4343_termDefinableFromFin_Equation43 :
    Law4343.TermDefinableFromFin Law43 := by
  refine termDefinableFromFin_of_iterate_pair (fun G ↦ (tm1 (Term.var 0) (Term.var 0)))
    (fun G ↦ (tm (Term.var 0) (Term.var 1))) 0 0 true true 1 1 ?_
  intro G _ M hGL N e v he
  letI : Magma G := M
  ...
  intro x y
  exact aux43_4343 h e v _ he.idem he.comm_v huv hvu (fun a b ↦ rfl) x y
