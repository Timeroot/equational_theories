import equational_theories.Definability.Srch_S8R52_data
...
is `decide` on `Fin 8`; the searching is in `Definability/Certs/Srch8R52T*.lean`.
-/
...
theorem not_structuralFromFin_of_srch8R52 {L L' : Law.NatMagmaLaw} (v : Magma.tup8R52)
    (hsrc : @satisfies _ (Fin 8) (Magma.srch8R52 v) L')
    (htgt : ∀ u : Magma.tup8R52, ¬ @satisfies _ (Fin 8) (Magma.srch8R52 u) L) :
    ¬ L.StructuralFromFin L' :=
  Law.MagmaLaw.not_structuralFromFin_of_tupOK S8R52.E S8R52.Einv S8R52.X S8R52.Xinv S8R52.rep S8R52.tr
    S8R52.z S8R52.st S8R52.hl S8R52.hr S8R52.hxl S8R52.hxr S8R52.htr S8R52.hz S8R52.hst v.1 v.2 hsrc htgt
