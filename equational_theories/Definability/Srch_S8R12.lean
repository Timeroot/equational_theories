import equational_theories.Definability.Srch_S8R12_data
...
is `decide` on `Fin 8`; the searching is in `Definability/Certs/Srch8R12T*.lean`.
-/
...
theorem not_structuralFromFin_of_srch8R12 {L L' : Law.NatMagmaLaw} (v : Magma.tup8R12)
    (hsrc : @satisfies _ (Fin 8) (Magma.srch8R12 v) L')
    (htgt : ∀ u : Magma.tup8R12, ¬ @satisfies _ (Fin 8) (Magma.srch8R12 u) L) :
    ¬ L.StructuralFromFin L' :=
  Law.MagmaLaw.not_structuralFromFin_of_tupOK S8R12.E S8R12.Einv S8R12.X S8R12.Xinv S8R12.rep S8R12.tr
    S8R12.z S8R12.st S8R12.hl S8R12.hr S8R12.hxl S8R12.hxr S8R12.htr S8R12.hz S8R12.hst v.1 v.2 hsrc htgt
