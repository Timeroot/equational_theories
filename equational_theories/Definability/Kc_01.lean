...
theorem GuardAut2_pxy_y_pxy_x_x_y_pxy_Equation3471 :
    AutBox.GuardAut2 ((Lf 0) ⋆ (Lf 1)) (Lf 1) ((Lf 0) ⋆ (Lf 1)) (Lf 0) (Lf 0) (Lf 1) ((Lf 0) ⋆ (Lf 1)) Law3471 := by
  classical
    ...
    · rcases eq_or_ne (M.op (σ x) (σ y)) ((σ x)) with h1b | h1b
      ...
      · have b2e15 : ∀ X0 X1 : G, (M.op X0 X1) ≠ X1 ∨ (k X0 X1) = X0 := by
        ...
        have b2e123 : ∀ X0 X1 : G, (σ X0) ≠ (σ (k X0 X1)) ∨ (σ X0) = (M.op (σ X0) (σ X1)) ∨ (σ X1) = (M.op (σ X0) (σ X1)) := by
          ...
          | grind (splits := 40) (ematch := 20)
        clear b2e54
        have b2e756 : (σ x) ≠ (σ x) ∨ (σ x) = (M.op (σ x) (σ y)) ∨ (σ y) = (M.op (σ x) (σ y)) := by
          first
          | (have i₁ := b2e123 x y
             have i₂ := b2e25
             grind)
          ...
          | grind (splits := 40) (ematch := 20)
        clear b2e25 b2e123
        have b2e759 : (σ x) = (M.op (σ x) (σ y)) ∨ (σ y) = (M.op (σ x) (σ y)) := by grind
        clear b2e756
        have b2e773 : (σ y) = (M.op (σ x) (σ y)) := by
          first
          | (have r₁ := b2e759
             have r₂ := b2e22
             grind)
          | exact resolve b2e759 b2e22
          | grind
          | grind (splits := 40)
          | grind (splits := 40) (ematch := 20)
        clear b2e759
        have b2e782 : False := by grind
        exact b2e782
        ...
        · have b5e17 : ∀ X0 X1 : G, (M.op X0 X1) ≠ X0 ∨ (M.op X0 X1) = X1 ∨ (k X0 X1) = X1 := by
          ...
          have b5e50 : y = (k x y) := by
            ...
            | (have r₁ := b5e49
               have r₂ := b5e25
               grind)
            | exact resolve b5e49 b5e25
            | grind
            | grind (splits := 40)
            | grind (splits := 40) (ematch := 20)
          clear b5e25 b5e49
          have b5e53 : ∀ X0 X1 : G, (σ (k X0 X1)) = (M.op (σ X0) (σ X1)) ∨ (σ X0) = (M.op (σ X0) (σ X1)) ∨ (σ X1) = (M.op (σ X0) (σ X1)) := by
            intro X0 X1
            first
            | (have i₁ := b5e19 X0 X1
          ...
          have b5e118 : ∀ X0 X1 : G, (σ (k X0 X1)) ≠ (σ X1) ∨ (σ X0) = (M.op (σ X0) (σ X1)) ∨ (σ X1) = (M.op (σ X0) (σ X1)) := by
            ...
            | grind (splits := 40) (ematch := 20)
          clear b5e53
          have b5e780 : (σ y) ≠ (σ y) ∨ (σ x) = (M.op (σ x) (σ y)) ∨ (σ y) = (M.op (σ x) (σ y)) := by
            first
            | (have i₁ := b5e118 x y
               have i₂ := b5e50
               grind)
            | exact superpose b5e50 b5e118
            | (have j0 := b5e118 x y
               grind)
            | exact resolve b5e118 b5e50
            | grind
            | grind (splits := 40)
            | grind (splits := 40) (ematch := 20)
          clear b5e50 b5e118
          have b5e783 : (σ x) = (M.op (σ x) (σ y)) ∨ (σ y) = (M.op (σ x) (σ y)) := by grind
          clear b5e780
          have b5e786 : (σ y) = (M.op (σ x) (σ y)) := by
            first
            | (have r₁ := b5e783
               have r₂ := b5e24
               grind)
            | exact resolve b5e783 b5e24
            | grind
            | grind (splits := 40)
            | grind (splits := 40) (ematch := 20)
          clear b5e783
          have b5e794 : False := by grind
          exact b5e794
    · rcases eq_or_ne (M.op (σ x) (σ y)) ((σ y)) with h1a | h1a
      ...
      · rcases eq_or_ne (M.op (σ x) (σ y)) ((σ x)) with h1b | h1b
        · have b7e14 : ∀ X0 : G, (τ (σ X0)) = X0 := by
          ...
          have b7e51 : y = (k x y) := by
            ...
            | grind (splits := 40) (ematch := 20)
          clear b7e50
          have b7e60 : y = (M.op x y) ∨ x = (M.op x y) ∨ y = (M.op x y) := by
            first
            | (have i₁ := b7e18 x y
               have i₂ := b7e51
               grind)
            ...
            | grind (splits := 40) (ematch := 20)
          clear b7e51
          have b7e61 : y = (M.op x y) ∨ x = (M.op x y) := by grind
          clear b7e60
...
`x □ y = if m(X,Y) = Y then X else if m(X,Y) = X then Y else m(X,Y)`, writing `X`, `Y` for `x`, `y`.
The obligation names no target, so any law the companion satisfies is one more cell for free. -/
theorem GuardAut2_pxy_y_pxy_x_x_y_pxy_Equation3473 :
    AutBox.GuardAut2 ((Lf 0) ⋆ (Lf 1)) (Lf 1) ((Lf 0) ⋆ (Lf 1)) (Lf 0) (Lf 0) (Lf 1) ((Lf 0) ⋆ (Lf 1)) Law3473 := by
  classical
  refine AutBox.guardAut2_of ((Lf 0) ⋆ (Lf 1)) (Lf 1) ((Lf 0) ⋆ (Lf 1)) (Lf 0) (Lf 0) (Lf 1) ((Lf 0) ⋆ (Lf 1))
    (fun {G} _ M hM σ τ hi1 hi2 k hc1 hc2 hc3 hcom x y ↦ ?_)
    ...
    · rcases eq_or_ne (M.op (σ x) (σ y)) ((σ x)) with h1b | h1b
      · have b1e15 : ∀ X0 X1 : G, (M.op X0 X1) ≠ X1 ∨ (k X0 X1) = X0 := by
        ...
        have b1e55 : (σ x) ≠ (σ x) ∨ (σ x) = (σ y) ∨ (σ y) = (k (σ x) (σ y)) := by
          ...
          | grind (splits := 40)
          | grind (splits := 40) (ematch := 20)
        have b1e59 : (σ x) = (σ y) ∨ (σ y) = (k (σ x) (σ y)) := by grind
        clear b1e55
        have b1e60 : (σ y) = (k (σ x) (σ y)) := by
          first
          | (have r₁ := b1e59
             have r₂ := b1e23
             grind)
          ...
          | grind (splits := 40) (ematch := 20)
        clear b1e59
        have b1e61 : (σ y) = (σ (k x y)) := by
          first
          | (have i₁ := b1e60
             have i₂ := b1e18 x y
             grind)
          | exact superpose b1e18 b1e60
          | exact resolve b1e60 b1e18
          | grind
          | grind (splits := 40)
          | grind (splits := 40) (ematch := 20)
        clear b1e60
        have b1e62 : (σ x) = (σ y) := by
          first
          | (have i₁ := b1e61
             have i₂ := b1e28
             grind)
          | exact superpose b1e28 b1e61
          | exact resolve b1e61 b1e28
          | grind
          | grind (splits := 40)
          | grind (splits := 40) (ematch := 20)
        clear b1e28 b1e61
      ...
      · have b2e15 : ∀ X0 X1 : G, (M.op X0 X1) ≠ X1 ∨ (k X0 X1) = X0 := by
        ...
        have b2e25 : x = (k x y) := by grind
        clear b2e24
        have b2e83 : ∀ X0 X1 : G, (σ (k X0 X1)) = (M.op (σ X0) (σ X1)) ∨ (σ X0) = (M.op (σ X0) (σ X1)) ∨ (σ X1) = (M.op (σ X0) (σ X1)) := by
          intro X0 X1
          first
          | (have i₁ := b2e18 X0 X1
             have i₂ := b2e17 (σ X0) (σ X1)
          ...
          | grind (splits := 40)
          | grind (splits := 40) (ematch := 20)
        have b2e144 : ∀ X0 X1 : G, (σ X0) ≠ (σ (k X0 X1)) ∨ (σ X0) = (M.op (σ X0) (σ X1)) ∨ (σ X1) = (M.op (σ X0) (σ X1)) := by
          intro X0 X1
          first
          | (have j0 := b2e83 X0 X1
             grind)
          ...
          | grind (splits := 40) (ematch := 20)
        clear b2e83
        have b2e2486 : (σ x) ≠ (σ x) ∨ (σ x) = (M.op (σ x) (σ y)) ∨ (σ y) = (M.op (σ x) (σ y)) := by
          first
          | (have i₁ := b2e144 x y
             have i₂ := b2e25
             grind)
          | exact superpose b2e25 b2e144
          | (have j0 := b2e144 x y
             grind)
          | exact resolve b2e144 b2e25
          | grind
          | grind (splits := 40)
          | grind (splits := 40) (ematch := 20)
        clear b2e25 b2e144
        have b2e2493 : (σ x) = (M.op (σ x) (σ y)) ∨ (σ y) = (M.op (σ x) (σ y)) := by grind
        clear b2e2486
        have b2e2510 : (σ y) = (M.op (σ x) (σ y)) := by
          first
          | (have r₁ := b2e2493
             have r₂ := b2e22
             grind)
          | exact resolve b2e2493 b2e22
          | grind
          | grind (splits := 40)
          | grind (splits := 40) (ematch := 20)
        clear b2e2493
        have b2e2519 : False := by grind
        exact b2e2519
  · rcases eq_or_ne (M.op x y) (x) with h0b | h0b
    · rcases eq_or_ne (M.op (σ x) (σ y)) ((σ y)) with h1a | h1a
      · have b3e15 : ∀ X0 X1 : G, (M.op X0 X1) ≠ X1 ∨ (k X0 X1) = X0 := by
      ...
      · rcases eq_or_ne (M.op (σ x) (σ y)) ((σ x)) with h1b | h1b
        ...
        · have b5e17 : ∀ X0 X1 : G, (M.op X0 X1) ≠ X0 ∨ (M.op X0 X1) = X1 ∨ (k X0 X1) = X1 := by
          ...
          have b5e62 : ∀ X0 X1 : G, (σ (k X0 X1)) = (M.op (σ X0) (σ X1)) ∨ (σ X0) = (M.op (σ X0) (σ X1)) ∨ (σ X1) = (M.op (σ X0) (σ X1)) := by
            ...
            | grind (splits := 40)
            | grind (splits := 40) (ematch := 20)
          have b5e159 : ∀ X0 X1 : G, (σ (k X0 X1)) ≠ (σ X1) ∨ (σ X0) = (M.op (σ X0) (σ X1)) ∨ (σ X1) = (M.op (σ X0) (σ X1)) := by
            intro X0 X1
            first
            | (have j0 := b5e62 X0 X1
               grind)
            ...
            | grind (splits := 40) (ematch := 20)
          clear b5e62
          have b5e2486 : (σ y) ≠ (σ y) ∨ (σ x) = (M.op (σ x) (σ y)) ∨ (σ y) = (M.op (σ x) (σ y)) := by
            first
            | (have i₁ := b5e159 x y
               have i₂ := b5e59
               grind)
            | exact superpose b5e59 b5e159
            | (have j0 := b5e159 x y
               grind)
            | exact resolve b5e159 b5e59
            | grind
            | grind (splits := 40)
            | grind (splits := 40) (ematch := 20)
          clear b5e59 b5e159
          have b5e2493 : (σ x) = (M.op (σ x) (σ y)) ∨ (σ y) = (M.op (σ x) (σ y)) := by grind
          clear b5e2486
          have b5e2496 : (σ y) = (M.op (σ x) (σ y)) := by
            first
            | (have r₁ := b5e2493
               have r₂ := b5e24
               grind)
            | exact resolve b5e2493 b5e24
            | grind
            | grind (splits := 40)
            | grind (splits := 40) (ematch := 20)
          clear b5e2493
          have b5e2505 : False := by grind
          exact b5e2505
    · rcases eq_or_ne (M.op (σ x) (σ y)) ((σ y)) with h1a | h1a
      · have b6e13 : ∀ X0 : G, (τ (σ X0)) = X0 := by
          intro X0
      ...
      · rcases eq_or_ne (M.op (σ x) (σ y)) ((σ x)) with h1b | h1b
        · have b7e14 : ∀ X0 : G, (τ (σ X0)) = X0 := by
          ...
          have b7e25 : (σ x) ≠ (σ y) := by
            ...
            | grind (splits := 40)
            | grind (splits := 40) (ematch := 20)
          have b7e50 : (σ x) ≠ (σ x) ∨ (σ x) = (σ y) ∨ (σ y) = (k (σ x) (σ y)) := by
            first
            | (have i₁ := b7e17 (σ x) (σ y)
               have i₂ := b7e24
               grind)
        ...
        · have b8e18 : ∀ X0 X1 : G, (M.op X0 X1) = (k X0 X1) ∨ (M.op X0 X1) = X0 ∨ (M.op X0 X1) = X1 := by
          ...
          have b8e24 : (σ x) ≠ (M.op (σ x) (σ y)) := by grind
          clear hm ht hu hv hd nh hM hi1 hi2 h0a h0b h1a h1b
          have b8e77 : ∀ X0 X1 : G, (σ (k X0 X1)) = (M.op (σ X0) (σ X1)) ∨ (σ X0) = (M.op (σ X0) (σ X1)) ∨ (σ X1) = (M.op (σ X0) (σ X1)) := by
            intro X0 X1
            first
            | (have i₁ := b8e19 X0 X1
               have i₂ := b8e18 (σ X0) (σ X1)
            ...
            | grind (splits := 40)
            | grind (splits := 40) (ematch := 20)
          have b8e137 : (σ (M.op x y)) ≠ (σ (k x y)) ∨ (σ x) = (M.op (σ x) (σ y)) ∨ (σ y) = (M.op (σ x) (σ y)) := by
            first
            | (have i₁ := b8e20
               have i₂ := b8e77 x y
               grind)
            ...
            | grind (splits := 40) (ematch := 20)
          clear b8e77
          have b8e161 : (σ (M.op x y)) ≠ (σ (k x y)) ∨ (σ y) = (M.op (σ x) (σ y)) := by
            first
            | (have r₁ := b8e137
               have r₂ := b8e24
               grind)
            | exact resolve b8e137 b8e24
            | grind
            | grind (splits := 40)
            | grind (splits := 40) (ematch := 20)
          clear b8e137
          have b8e164 : (σ (M.op x y)) ≠ (σ (k x y)) := by
            ...
            | grind (splits := 40) (ematch := 20)
          clear b8e161
          have b8e202 : (σ (M.op x y)) ≠ (σ (M.op x y)) ∨ x = (M.op x y) ∨ y = (M.op x y) := by
            first
            | (have i₁ := b8e164
               have i₂ := b8e18 x y
               grind)
            ...
            | grind (splits := 40) (ematch := 20)
          clear b8e164
          have b8e203 : x = (M.op x y) ∨ y = (M.op x y) := by grind
          clear b8e202
          have b8e204 : y = (M.op x y) := by
            first
            | (have r₁ := b8e203
               have r₂ := b8e22
               grind)
            | exact resolve b8e203 b8e22
            | grind
            | grind (splits := 40)
            | grind (splits := 40) (ematch := 20)
          clear b8e203
          have b8e205 : False := by grind
          exact b8e205
...
`x □ y = if m(X,Y) = Y then X else if m(X,Y) = X then Y else m(X,Y)`, writing `X`, `Y` for `x`, `y`.
The obligation names no target, so any law the companion satisfies is one more cell for free. -/
theorem GuardAut2_pxy_y_pxy_x_x_y_pxy_Equation3476 :
    AutBox.GuardAut2 ((Lf 0) ⋆ (Lf 1)) (Lf 1) ((Lf 0) ⋆ (Lf 1)) (Lf 0) (Lf 0) (Lf 1) ((Lf 0) ⋆ (Lf 1)) Law3476 := by
  classical
  refine AutBox.guardAut2_of ((Lf 0) ⋆ (Lf 1)) (Lf 1) ((Lf 0) ⋆ (Lf 1)) (Lf 0) (Lf 0) (Lf 1) ((Lf 0) ⋆ (Lf 1))
    (fun {G} _ M hM σ τ hi1 hi2 k hc1 hc2 hc3 hcom x y ↦ ?_)
    ...
    · rcases eq_or_ne (M.op (σ x) (σ y)) ((σ x)) with h1b | h1b
      · have b1e15 : ∀ X0 X1 : G, (M.op X0 X1) ≠ X1 ∨ (k X0 X1) = X0 := by
        ...
        have b1e50 : (σ x) ≠ (σ x) ∨ (σ x) = (σ y) ∨ (σ y) = (k (σ x) (σ y)) := by
          ...
          | grind (splits := 40)
          | grind (splits := 40) (ematch := 20)
        have b1e52 : (σ x) = (σ y) ∨ (σ y) = (k (σ x) (σ y)) := by grind
        clear b1e50
      ...
      · have b2e15 : ∀ X0 X1 : G, (M.op X0 X1) ≠ X1 ∨ (k X0 X1) = X0 := by
        ...
        have b2e73 : ∀ X0 X1 : G, (σ (k X0 X1)) = (M.op (σ X0) (σ X1)) ∨ (σ X0) = (M.op (σ X0) (σ X1)) ∨ (σ X1) = (M.op (σ X0) (σ X1)) := by
          ...
          | grind (splits := 40)
          | grind (splits := 40) (ematch := 20)
        have b2e782 : ∀ X0 X1 : G, (σ X0) ≠ (σ (k X0 X1)) ∨ (σ X0) = (M.op (σ X0) (σ X1)) ∨ (σ X1) = (M.op (σ X0) (σ X1)) := by
          intro X0 X1
          first
          | (have j0 := b2e73 X0 X1
             grind)
          ...
          | grind (splits := 40) (ematch := 20)
        clear b2e73
        have b2e55886 : (σ x) ≠ (σ x) ∨ (σ x) = (M.op (σ x) (σ y)) ∨ (σ y) = (M.op (σ x) (σ y)) := by
          first
          | (have i₁ := b2e782 x y
             have i₂ := b2e25
             grind)
          | exact superpose b2e25 b2e782
          | (have j0 := b2e782 x y
             grind)
          | exact resolve b2e782 b2e25
          | grind
          | grind (splits := 40)
          | grind (splits := 40) (ematch := 20)
        clear b2e25 b2e782
        have b2e55895 : (σ x) = (M.op (σ x) (σ y)) ∨ (σ y) = (M.op (σ x) (σ y)) := by grind
        clear b2e55886
        have b2e55936 : (σ y) = (M.op (σ x) (σ y)) := by
          first
          | (have r₁ := b2e55895
             have r₂ := b2e22
             grind)
          | exact resolve b2e55895 b2e22
          | grind
          | grind (splits := 40)
          | grind (splits := 40) (ematch := 20)
        clear b2e55895
        have b2e55953 : False := by grind
        exact b2e55953
  · rcases eq_or_ne (M.op x y) (x) with h0b | h0b
    · rcases eq_or_ne (M.op (σ x) (σ y)) ((σ y)) with h1a | h1a
      · have b3e15 : ∀ X0 X1 : G, (M.op X0 X1) ≠ X1 ∨ (k X0 X1) = X0 := by
      ...
      · rcases eq_or_ne (M.op (σ x) (σ y)) ((σ x)) with h1b | h1b
        ...
        · have b5e17 : ∀ X0 X1 : G, (M.op X0 X1) ≠ X0 ∨ (M.op X0 X1) = X1 ∨ (k X0 X1) = X1 := by
          ...
          have b5e51 : y = (k x y) := by
            ...
            | grind (splits := 40) (ematch := 20)
          clear b5e25 b5e50
          have b5e54 : ∀ X0 X1 : G, (σ (k X0 X1)) = (M.op (σ X0) (σ X1)) ∨ (σ X0) = (M.op (σ X0) (σ X1)) ∨ (σ X1) = (M.op (σ X0) (σ X1)) := by
            intro X0 X1
            first
            | (have i₁ := b5e19 X0 X1
               have i₂ := b5e18 (σ X0) (σ X1)
            ...
            | grind (splits := 40)
            | grind (splits := 40) (ematch := 20)
          have b5e807 : ∀ X0 X1 : G, (σ (k X0 X1)) ≠ (σ X1) ∨ (σ X0) = (M.op (σ X0) (σ X1)) ∨ (σ X1) = (M.op (σ X0) (σ X1)) := by
            intro X0 X1
            first
            | (have j0 := b5e54 X0 X1
               grind)
            ...
            | grind (splits := 40) (ematch := 20)
          clear b5e54
          have b5e55954 : (σ y) ≠ (σ y) ∨ (σ x) = (M.op (σ x) (σ y)) ∨ (σ y) = (M.op (σ x) (σ y)) := by
            first
            | (have i₁ := b5e807 x y
               have i₂ := b5e51
               grind)
            | exact superpose b5e51 b5e807
            | (have j0 := b5e807 x y
               grind)
            | exact resolve b5e807 b5e51
            | grind
            | grind (splits := 40)
            | grind (splits := 40) (ematch := 20)
          clear b5e51 b5e807
          have b5e55963 : (σ x) = (M.op (σ x) (σ y)) ∨ (σ y) = (M.op (σ x) (σ y)) := by grind
          clear b5e55954
          have b5e55967 : (σ y) = (M.op (σ x) (σ y)) := by
            first
            | (have r₁ := b5e55963
               have r₂ := b5e24
               grind)
            | exact resolve b5e55963 b5e24
            | grind
            | grind (splits := 40)
            | grind (splits := 40) (ematch := 20)
          clear b5e55963
          have b5e55992 : False := by grind
          exact b5e55992
    · rcases eq_or_ne (M.op (σ x) (σ y)) ((σ y)) with h1a | h1a
      · have b6e13 : ∀ X0 : G, (τ (σ X0)) = X0 := by
          intro X0
      ...
      · rcases eq_or_ne (M.op (σ x) (σ y)) ((σ x)) with h1b | h1b
        ...
        · have b8e18 : ∀ X0 X1 : G, (M.op X0 X1) = (k X0 X1) ∨ (M.op X0 X1) = X0 ∨ (M.op X0 X1) = X1 := by
          ...
          have b8e84 : ∀ X0 X1 : G, (σ (k X0 X1)) = (M.op (σ X0) (σ X1)) ∨ (σ X0) = (M.op (σ X0) (σ X1)) ∨ (σ X1) = (M.op (σ X0) (σ X1)) := by
            ...
            | grind (splits := 40)
            | grind (splits := 40) (ematch := 20)
          have b8e799 : (σ (M.op x y)) ≠ (σ (k x y)) ∨ (σ x) = (M.op (σ x) (σ y)) ∨ (σ y) = (M.op (σ x) (σ y)) := by
            first
            | (have i₁ := b8e20
               have i₂ := b8e84 x y
               grind)
            ...
            | grind (splits := 40) (ematch := 20)
          clear b8e84
          have b8e851 : (σ (M.op x y)) ≠ (σ (k x y)) ∨ (σ y) = (M.op (σ x) (σ y)) := by
            first
            | (have r₁ := b8e799
               have r₂ := b8e24
               grind)
            | exact resolve b8e799 b8e24
            | grind
            | grind (splits := 40)
            | grind (splits := 40) (ematch := 20)
          clear b8e799
          have b8e855 : (σ (M.op x y)) ≠ (σ (k x y)) := by
            first
            | (have r₁ := b8e851
               have r₂ := b8e23
               grind)
            | exact resolve b8e851 b8e23
            | grind
            | grind (splits := 40)
            | grind (splits := 40) (ematch := 20)
          clear b8e851
          have b8e898 : (σ (M.op x y)) ≠ (σ (M.op x y)) ∨ x = (M.op x y) ∨ y = (M.op x y) := by
            first
            | (have i₁ := b8e855
               have i₂ := b8e18 x y
               grind)
            | exact superpose b8e18 b8e855
            | (have j1 := b8e18 x y
               grind)
            | exact resolve b8e855 b8e18
            | grind
            | grind (splits := 40)
            | grind (splits := 40) (ematch := 20)
          clear b8e855
          have b8e899 : x = (M.op x y) ∨ y = (M.op x y) := by grind
          clear b8e898
          have b8e900 : y = (M.op x y) := by
            first
            | (have r₁ := b8e899
               have r₂ := b8e22
               grind)
            | exact resolve b8e899 b8e22
            | grind
            | grind (splits := 40)
            | grind (splits := 40) (ematch := 20)
          clear b8e899
          have b8e901 : False := by grind
          exact b8e901
...
`x □ y = if m(X,Y) = Y then X else if m(X,Y) = X then Y else m(X,Y)`, writing `X`, `Y` for `x`, `y`.
The obligation names no target, so any law the companion satisfies is one more cell for free. -/
theorem GuardAut2_pxy_y_pxy_x_x_y_pxy_Equation3480 :
    AutBox.GuardAut2 ((Lf 0) ⋆ (Lf 1)) (Lf 1) ((Lf 0) ⋆ (Lf 1)) (Lf 0) (Lf 0) (Lf 1) ((Lf 0) ⋆ (Lf 1)) Law3480 := by
  classical
  refine AutBox.guardAut2_of ((Lf 0) ⋆ (Lf 1)) (Lf 1) ((Lf 0) ⋆ (Lf 1)) (Lf 0) (Lf 0) (Lf 1) ((Lf 0) ⋆ (Lf 1))
    (fun {G} _ M hM σ τ hi1 hi2 k hc1 hc2 hc3 hcom x y ↦ ?_)
  ...
  · rcases eq_or_ne (M.op (σ x) (σ y)) ((σ y)) with h1a | h1a
    ...
    · rcases eq_or_ne (M.op (σ x) (σ y)) ((σ x)) with h1b | h1b
      · have b1e15 : ∀ X0 X1 : G, (M.op X0 X1) ≠ X1 ∨ (k X0 X1) = X0 := by
        ...
        have b1e28 : x = (k x y) := by grind
        clear b1e26
        have b1e65 : (σ x) ≠ (σ x) ∨ (σ x) = (σ y) ∨ (σ y) = (k (σ x) (σ y)) := by
          first
          | (have i₁ := b1e16 (σ x) (σ y)
             have i₂ := b1e22
             grind)
          ...
          | grind (splits := 40)
          | grind (splits := 40) (ematch := 20)
        have b1e70 : (σ x) = (σ y) ∨ (σ y) = (k (σ x) (σ y)) := by grind
        clear b1e65
        have b1e71 : (σ y) = (k (σ x) (σ y)) := by
          first
          | (have r₁ := b1e70
             have r₂ := b1e23
             grind)
      ...
      · have b2e15 : ∀ X0 X1 : G, (M.op X0 X1) ≠ X1 ∨ (k X0 X1) = X0 := by
        ...
        have b2e25 : x = (k x y) := by grind
        clear b2e24
        have b2e81 : ∀ X0 X1 : G, (σ (k X0 X1)) = (M.op (σ X0) (σ X1)) ∨ (σ X0) = (M.op (σ X0) (σ X1)) ∨ (σ X1) = (M.op (σ X0) (σ X1)) := by
          intro X0 X1
          first
          | (have i₁ := b2e18 X0 X1
             have i₂ := b2e17 (σ X0) (σ X1)
          ...
          | grind (splits := 40)
          | grind (splits := 40) (ematch := 20)
        have b2e835 : ∀ X0 X1 : G, (σ X0) ≠ (σ (k X0 X1)) ∨ (σ X0) = (M.op (σ X0) (σ X1)) ∨ (σ X1) = (M.op (σ X0) (σ X1)) := by
          intro X0 X1
          first
          | (have j0 := b2e81 X0 X1
             grind)
          ...
          | grind (splits := 40) (ematch := 20)
        clear b2e81
        have b2e44983 : (σ x) ≠ (σ x) ∨ (σ x) = (M.op (σ x) (σ y)) ∨ (σ y) = (M.op (σ x) (σ y)) := by
          first
          | (have i₁ := b2e835 x y
             have i₂ := b2e25
             grind)
          | exact superpose b2e25 b2e835
          | (have j0 := b2e835 x y
             grind)
          | exact resolve b2e835 b2e25
          | grind
          | grind (splits := 40)
          | grind (splits := 40) (ematch := 20)
        clear b2e25 b2e835
        have b2e44996 : (σ x) = (M.op (σ x) (σ y)) ∨ (σ y) = (M.op (σ x) (σ y)) := by grind
        clear b2e44983
        have b2e45022 : (σ y) = (M.op (σ x) (σ y)) := by
          first
          | (have r₁ := b2e44996
             have r₂ := b2e22
             grind)
          | exact resolve b2e44996 b2e22
          | grind
          | grind (splits := 40)
          | grind (splits := 40) (ematch := 20)
        clear b2e44996
        have b2e45034 : False := by grind
        exact b2e45034
  · rcases eq_or_ne (M.op x y) (x) with h0b | h0b
    · rcases eq_or_ne (M.op (σ x) (σ y)) ((σ y)) with h1a | h1a
      · have b3e15 : ∀ X0 X1 : G, (M.op X0 X1) ≠ X1 ∨ (k X0 X1) = X0 := by
      ...
      · rcases eq_or_ne (M.op (σ x) (σ y)) ((σ x)) with h1b | h1b
        ...
        · have b5e17 : ∀ X0 X1 : G, (M.op X0 X1) ≠ X0 ∨ (M.op X0 X1) = X1 ∨ (k X0 X1) = X1 := by
          ...
          have b5e72 : ∀ X0 X1 : G, (σ (k X0 X1)) = (M.op (σ X0) (σ X1)) ∨ (σ X0) = (M.op (σ X0) (σ X1)) ∨ (σ X1) = (M.op (σ X0) (σ X1)) := by
            ...
            | grind (splits := 40)
            | grind (splits := 40) (ematch := 20)
          have b5e1062 : ∀ X0 X1 : G, (σ (k X0 X1)) ≠ (σ X1) ∨ (σ X0) = (M.op (σ X0) (σ X1)) ∨ (σ X1) = (M.op (σ X0) (σ X1)) := by
            intro X0 X1
            first
            | (have j0 := b5e72 X0 X1
               grind)
            ...
            | grind (splits := 40) (ematch := 20)
          clear b5e72
          have b5e45229 : (σ y) ≠ (σ y) ∨ (σ x) = (M.op (σ x) (σ y)) ∨ (σ y) = (M.op (σ x) (σ y)) := by
            first
            | (have i₁ := b5e1062 x y
               have i₂ := b5e69
               grind)
            | exact superpose b5e69 b5e1062
            | (have j0 := b5e1062 x y
               grind)
            | exact resolve b5e1062 b5e69
            | grind
            | grind (splits := 40)
            | grind (splits := 40) (ematch := 20)
          clear b5e69 b5e1062
          have b5e45242 : (σ x) = (M.op (σ x) (σ y)) ∨ (σ y) = (M.op (σ x) (σ y)) := by grind
          clear b5e45229
          have b5e45245 : (σ y) = (M.op (σ x) (σ y)) := by
            first
            | (have r₁ := b5e45242
               have r₂ := b5e24
               grind)
            | exact resolve b5e45242 b5e24
            | grind
            | grind (splits := 40)
            | grind (splits := 40) (ematch := 20)
          clear b5e45242
          have b5e45256 : False := by grind
          exact b5e45256
    · rcases eq_or_ne (M.op (σ x) (σ y)) ((σ y)) with h1a | h1a
      · have b6e13 : ∀ X0 : G, (τ (σ X0)) = X0 := by
          intro X0
      ...
      · rcases eq_or_ne (M.op (σ x) (σ y)) ((σ x)) with h1b | h1b
        ...
        · have b8e18 : ∀ X0 X1 : G, (M.op X0 X1) = (k X0 X1) ∨ (M.op X0 X1) = X0 ∨ (M.op X0 X1) = X1 := by
          ...
          have b8e24 : (σ x) ≠ (M.op (σ x) (σ y)) := by grind
          clear hm ht hu hv hd nh hM hi1 hi2 h0a h0b h1a h1b
          have b8e95 : ∀ X0 X1 : G, (σ (k X0 X1)) = (M.op (σ X0) (σ X1)) ∨ (σ X0) = (M.op (σ X0) (σ X1)) ∨ (σ X1) = (M.op (σ X0) (σ X1)) := by
            intro X0 X1
            first
            | (have i₁ := b8e19 X0 X1
               have i₂ := b8e18 (σ X0) (σ X1)
            ...
            | grind (splits := 40)
            | grind (splits := 40) (ematch := 20)
          have b8e780 : (σ (M.op x y)) ≠ (σ (k x y)) ∨ (σ x) = (M.op (σ x) (σ y)) ∨ (σ y) = (M.op (σ x) (σ y)) := by
            first
            | (have i₁ := b8e20
               have i₂ := b8e95 x y
               grind)
            ...
            | grind (splits := 40) (ematch := 20)
          clear b8e95
          have b8e834 : (σ (M.op x y)) ≠ (σ (k x y)) ∨ (σ y) = (M.op (σ x) (σ y)) := by
            first
            | (have r₁ := b8e780
               have r₂ := b8e24
               grind)
            | exact resolve b8e780 b8e24
            | grind
            | grind (splits := 40)
            | grind (splits := 40) (ematch := 20)
          clear b8e780
          have b8e837 : (σ (M.op x y)) ≠ (σ (k x y)) := by
            first
            | (have r₁ := b8e834
               have r₂ := b8e23
               grind)
            | exact resolve b8e834 b8e23
            | grind
            | grind (splits := 40)
            | grind (splits := 40) (ematch := 20)
          clear b8e834
          have b8e838 : (σ (M.op x y)) ≠ (σ (M.op x y)) ∨ x = (M.op x y) ∨ y = (M.op x y) := by
            first
            | (have i₁ := b8e837
               have i₂ := b8e18 x y
               grind)
            | exact superpose b8e18 b8e837
            | (have j1 := b8e18 x y
               grind)
            | exact resolve b8e837 b8e18
            | grind
            | grind (splits := 40)
            | grind (splits := 40) (ematch := 20)
          clear b8e837
          have b8e839 : x = (M.op x y) ∨ y = (M.op x y) := by grind
          clear b8e838
          have b8e840 : y = (M.op x y) := by
            first
            | (have r₁ := b8e839
               have r₂ := b8e22
               grind)
            | exact resolve b8e839 b8e22
            | grind
            | grind (splits := 40)
            | grind (splits := 40) (ematch := 20)
          clear b8e839
          have b8e841 : False := by grind
          exact b8e841
...
`x □ y = if m(X,Y) = Y then X else if m(X,Y) = X then Y else m(X,Y)`, writing `X`, `Y` for `x`, `y`.
The obligation names no target, so any law the companion satisfies is one more cell for free. -/
theorem GuardAut2_pxy_y_pxy_x_x_y_pxy_Equation3487 :
    AutBox.GuardAut2 ((Lf 0) ⋆ (Lf 1)) (Lf 1) ((Lf 0) ⋆ (Lf 1)) (Lf 0) (Lf 0) (Lf 1) ((Lf 0) ⋆ (Lf 1)) Law3487 := by
  classical
  refine AutBox.guardAut2_of ((Lf 0) ⋆ (Lf 1)) (Lf 1) ((Lf 0) ⋆ (Lf 1)) (Lf 0) (Lf 0) (Lf 1) ((Lf 0) ⋆ (Lf 1))
    (fun {G} _ M hM σ τ hi1 hi2 k hc1 hc2 hc3 hcom x y ↦ ?_)
  ...
  · rcases eq_or_ne (M.op (σ x) (σ y)) ((σ y)) with h1a | h1a
    ...
    · rcases eq_or_ne (M.op (σ x) (σ y)) ((σ x)) with h1b | h1b
      · have b1e15 : ∀ X0 X1 : G, (M.op X0 X1) ≠ X1 ∨ (k X0 X1) = X0 := by
        ...
        have b1e28 : x = (k x y) := by grind
        clear b1e26
        have b1e52 : (σ x) ≠ (σ x) ∨ (σ x) = (σ y) ∨ (σ y) = (k (σ x) (σ y)) := by
          first
          | (have i₁ := b1e16 (σ x) (σ y)
             have i₂ := b1e22
             grind)
          ...
          | grind (splits := 40)
          | grind (splits := 40) (ematch := 20)
        have b1e56 : (σ x) = (σ y) ∨ (σ y) = (k (σ x) (σ y)) := by grind
        clear b1e52
      ...
      · have b2e15 : ∀ X0 X1 : G, (M.op X0 X1) ≠ X1 ∨ (k X0 X1) = X0 := by
        ...
        have b2e25 : x = (k x y) := by grind
        clear b2e24
        have b2e62 : ∀ X0 X1 : G, (σ (k X0 X1)) = (M.op (σ X0) (σ X1)) ∨ (σ X0) = (M.op (σ X0) (σ X1)) ∨ (σ X1) = (M.op (σ X0) (σ X1)) := by
          intro X0 X1
          first
          | (have i₁ := b2e18 X0 X1
             have i₂ := b2e17 (σ X0) (σ X1)
          ...
          | grind (splits := 40)
          | grind (splits := 40) (ematch := 20)
        have b2e1113 : ∀ X0 X1 : G, (σ X0) ≠ (σ (k X0 X1)) ∨ (σ X0) = (M.op (σ X0) (σ X1)) ∨ (σ X1) = (M.op (σ X0) (σ X1)) := by
          intro X0 X1
          first
          | (have j0 := b2e62 X0 X1
             grind)
          ...
          | grind (splits := 40) (ematch := 20)
        clear b2e62
        have b2e13415 : (σ x) ≠ (σ x) ∨ (σ x) = (M.op (σ x) (σ y)) ∨ (σ y) = (M.op (σ x) (σ y)) := by
          first
          | (have i₁ := b2e1113 x y
             have i₂ := b2e25
             grind)
          | exact superpose b2e25 b2e1113
          | (have j0 := b2e1113 x y
             grind)
          | exact resolve b2e1113 b2e25
          | grind
          | grind (splits := 40)
          | grind (splits := 40) (ematch := 20)
        clear b2e25 b2e1113
        have b2e13424 : (σ x) = (M.op (σ x) (σ y)) ∨ (σ y) = (M.op (σ x) (σ y)) := by grind
        clear b2e13415
        have b2e13456 : (σ y) = (M.op (σ x) (σ y)) := by
          first
          | (have r₁ := b2e13424
             have r₂ := b2e22
             grind)
          | exact resolve b2e13424 b2e22
          | grind
          | grind (splits := 40)
          | grind (splits := 40) (ematch := 20)
        clear b2e13424
        have b2e13472 : False := by grind
        exact b2e13472
  · rcases eq_or_ne (M.op x y) (x) with h0b | h0b
    · rcases eq_or_ne (M.op (σ x) (σ y)) ((σ y)) with h1a | h1a
      · have b3e15 : ∀ X0 X1 : G, (M.op X0 X1) ≠ X1 ∨ (k X0 X1) = X0 := by
      ...
      · rcases eq_or_ne (M.op (σ x) (σ y)) ((σ x)) with h1b | h1b
        ...
        · have b5e17 : ∀ X0 X1 : G, (M.op X0 X1) ≠ X0 ∨ (M.op X0 X1) = X1 ∨ (k X0 X1) = X1 := by
          ...
          have b5e59 : ∀ X0 X1 : G, (σ (k X0 X1)) = (M.op (σ X0) (σ X1)) ∨ (σ X0) = (M.op (σ X0) (σ X1)) ∨ (σ X1) = (M.op (σ X0) (σ X1)) := by
            ...
            | grind (splits := 40)
            | grind (splits := 40) (ematch := 20)
          have b5e1143 : ∀ X0 X1 : G, (σ (k X0 X1)) ≠ (σ X1) ∨ (σ X0) = (M.op (σ X0) (σ X1)) ∨ (σ X1) = (M.op (σ X0) (σ X1)) := by
            intro X0 X1
            first
            | (have j0 := b5e59 X0 X1
               grind)
            ...
            | grind (splits := 40) (ematch := 20)
          clear b5e59
          have b5e12461 : (σ y) ≠ (σ y) ∨ (σ x) = (M.op (σ x) (σ y)) ∨ (σ y) = (M.op (σ x) (σ y)) := by
            first
            | (have i₁ := b5e1143 x y
               have i₂ := b5e56
               grind)
            | exact superpose b5e56 b5e1143
            | (have j0 := b5e1143 x y
               grind)
            | exact resolve b5e1143 b5e56
            | grind
            | grind (splits := 40)
            | grind (splits := 40) (ematch := 20)
          clear b5e56 b5e1143
          have b5e12472 : (σ x) = (M.op (σ x) (σ y)) ∨ (σ y) = (M.op (σ x) (σ y)) := by grind
          clear b5e12461
          have b5e12477 : (σ y) = (M.op (σ x) (σ y)) := by
            first
            | (have r₁ := b5e12472
               have r₂ := b5e24
               grind)
            | exact resolve b5e12472 b5e24
            | grind
            | grind (splits := 40)
            | grind (splits := 40) (ematch := 20)
          clear b5e12472
          have b5e12496 : False := by grind
          exact b5e12496
    · rcases eq_or_ne (M.op (σ x) (σ y)) ((σ y)) with h1a | h1a
      · have b6e13 : ∀ X0 : G, (τ (σ X0)) = X0 := by
          intro X0
      ...
      · rcases eq_or_ne (M.op (σ x) (σ y)) ((σ x)) with h1b | h1b
        · have b7e14 : ∀ X0 : G, (τ (σ X0)) = X0 := by
          ...
          have b7e51 : y = (k x y) := by
            ...
            | grind (splits := 40) (ematch := 20)
          clear b7e50
          have b7e61 : y = (M.op x y) ∨ x = (M.op x y) ∨ y = (M.op x y) := by
            first
            | (have i₁ := b7e18 x y
               have i₂ := b7e51
               grind)
            ...
            | grind (splits := 40) (ematch := 20)
          clear b7e51
          have b7e62 : y = (M.op x y) ∨ x = (M.op x y) := by grind
          clear b7e61
        ...
        · have b8e18 : ∀ X0 X1 : G, (M.op X0 X1) = (k X0 X1) ∨ (M.op X0 X1) = X0 ∨ (M.op X0 X1) = X1 := by
          ...
          have b8e24 : (σ x) ≠ (M.op (σ x) (σ y)) := by grind
          clear hm ht hu hv hd nh hM hi1 hi2 h0a h0b h1a h1b
          have b8e49 : ∀ X0 X1 : G, (σ (k X0 X1)) = (M.op (σ X0) (σ X1)) ∨ (σ X0) = (M.op (σ X0) (σ X1)) ∨ (σ X1) = (M.op (σ X0) (σ X1)) := by
            intro X0 X1
            first
            | (have i₁ := b8e19 X0 X1
               have i₂ := b8e18 (σ X0) (σ X1)
            ...
            | grind (splits := 40)
            | grind (splits := 40) (ematch := 20)
          have b8e640 : (σ (M.op x y)) ≠ (σ (k x y)) ∨ (σ x) = (M.op (σ x) (σ y)) ∨ (σ y) = (M.op (σ x) (σ y)) := by
            first
            | (have i₁ := b8e20
               have i₂ := b8e49 x y
               grind)
          ...
          have b8e687 : (σ (M.op x y)) ≠ (σ (k x y)) := by
            ...
            | grind (splits := 40) (ematch := 20)
          clear b8e684
          have b8e688 : (σ (M.op x y)) ≠ (σ (M.op x y)) ∨ x = (M.op x y) ∨ y = (M.op x y) := by
            first
            | (have i₁ := b8e687
               have i₂ := b8e18 x y
               grind)
            ...
            | grind (splits := 40) (ematch := 20)
          clear b8e687
          have b8e689 : x = (M.op x y) ∨ y = (M.op x y) := by grind
          clear b8e688
          have b8e690 : y = (M.op x y) := by
            first
            | (have r₁ := b8e689
               have r₂ := b8e22
               grind)
            | exact resolve b8e689 b8e22
            | grind
            | grind (splits := 40)
            | grind (splits := 40) (ematch := 20)
          clear b8e689
          have b8e691 : False := by grind
          exact b8e691
...
The obligation names no target, so any law the companion satisfies is one more cell for free. -/
theorem GuardAut2_x_y_pxx_y_pxx_x_pxy_Equation3495 :
    AutBox.GuardAut2 (Lf 0) (Lf 1) ((Lf 0) ⋆ (Lf 0)) (Lf 1) ((Lf 0) ⋆ (Lf 0)) (Lf 0) ((Lf 0) ⋆ (Lf 1)) Law3495 := by
  classical
      ...
      · rcases eq_or_ne (M.op (σ x) (σ x)) ((σ y)) with h1b | h1b
        · have b4e13 : ∀ X0 X1 X2 : G, (M.op X0 X0) = (M.op X1 (M.op (M.op X2 X1) X0)) := by
          ...
          have b4e35 : ∀ X0 : G, (M.op X0 X0) = (M.op (σ x) (M.op (σ y) X0)) := by
            ...
            | grind (splits := 40)
            | grind (splits := 40) (ematch := 20)
          have b4e36 : ∀ X0 X1 X2 X3 : G, (M.op X3 X3) = (M.op X2 (M.op (M.op X0 (M.op (M.op X1 X0) X2)) X3)) := by
            intro X0 X1 X2 X3
            first
            ...
            | grind (splits := 40)
            | grind (splits := 40) (ematch := 20)
          have b4e38 : ∀ X0 X1 X2 X3 : G, (M.op X0 (M.op (M.op X1 X0) (M.op X2 X3))) = (M.op X3 (M.op X0 (M.op (M.op X1 X0) (M.op X2 X3)))) := by
            intro X0 X1 X2 X3
            first
          ...
          have b4e44 : ∀ X0 X1 : G, (M.op X1 X1) = (M.op (M.op y X0) (M.op (M.op X0 X0) X1)) := by
            ...
            | grind (splits := 40)
            | grind (splits := 40) (ematch := 20)
          have b4e120 : (σ (M.op y y)) = (M.op (σ x) (σ (M.op y y))) := by
            first
            | (have i₁ := b4e35 (σ y)
               have i₂ := b4e31 y
               grind)
            | exact superpose b4e31 b4e35
            | exact resolve b4e35 b4e31
            | grind
            | grind (splits := 40)
            | grind (splits := 40) (ematch := 20)
          clear b4e31 b4e35
          have b4e1267 : ∀ X0 X1 : G, (M.op X1 (M.op X0 X0)) = (M.op X0 (M.op X1 (M.op X0 X0))) := by
            intro X0 X1
            first
            | (have i₁ := b4e38 X0 X1 (M.op X0 (M.op (M.op X1 X0) (M.op X1 X0))) x
               have i₂ := b4e36 X0 X1 (M.op X1 X0) x
               grind)
            ...
            | grind (splits := 40) (ematch := 20)
          clear b4e36 b4e38
          have b4e3098 : ∀ X0 : G, (M.op X0 X0) = (M.op (M.op y x) (M.op y X0)) := by
            intro X0
            first
            | (have i₁ := b4e44 x X0
               have i₂ := b4e22
            ...
            | grind (splits := 40) (ematch := 20)
          clear b4e44
          have b4e3748 : (M.op x x) = (M.op x (M.op y (M.op y x))) := by
            first
            | (have i₁ := b4e3098 x
               have i₂ := b4e34 (M.op y x)
               grind)
            | exact superpose b4e34 b4e3098
            | exact resolve b4e3098 b4e34
            | grind
            | grind (splits := 40)
            | grind (splits := 40) (ematch := 20)
          clear b4e34
          have b4e3806 : ∀ X0 : G, (M.op x (M.op y (M.op y X0))) = (M.op x (M.op X0 X0)) := by
            intro X0
            first
            | (have i₁ := b4e41 (M.op y X0) x y
               have i₂ := b4e3098 X0
               grind)
            | exact superpose b4e3098 b4e41
            | exact resolve b4e41 b4e3098
            | grind
            | grind (splits := 40)
            | grind (splits := 40) (ematch := 20)
          clear b4e41
          have b4e3893 : (M.op x x) = (M.op x (M.op x x)) := by
            first
            | (have i₁ := b4e3748
               have i₂ := b4e3806 x
               grind)
            | exact superpose b4e3806 b4e3748
            | exact resolve b4e3748 b4e3806
            | grind
            | grind (splits := 40)
            | grind (splits := 40) (ematch := 20)
          clear b4e3748 b4e3806
          have b4e3923 : y = (M.op x y) := by
            first
            | (have i₁ := b4e3893
               have i₂ := b4e22
               grind)
            | exact superpose b4e22 b4e3893
            | exact resolve b4e3893 b4e22
            | grind
            | grind (splits := 40)
            | grind (splits := 40) (ematch := 20)
          clear b4e3893
          have b4e4944 : ∀ X0 : G, (M.op X0 (M.op x x)) = (M.op (M.op y x) (M.op X0 (M.op x x))) := by
            intro X0
            first
            | (have i₁ := b4e1267 (M.op y x) x
               have i₂ := b4e3098 x
               grind)
            | exact superpose b4e3098 b4e1267
            | exact resolve b4e1267 b4e3098
            | grind
            | grind (splits := 40)
            | grind (splits := 40) (ematch := 20)
          clear b4e3098
          have b4e4950 : ∀ X0 : G, (M.op X0 y) = (M.op x (M.op X0 y)) := by
            intro X0
            first
            | (have i₁ := b4e1267 x x
               have i₂ := b4e22
               grind)
            | exact superpose b4e22 b4e1267
            | exact resolve b4e1267 b4e22
            | grind
            | grind (splits := 40)
            | grind (splits := 40) (ematch := 20)
          clear b4e1267
          have b4e5100 : ∀ X0 : G, (M.op X0 y) = (M.op (M.op y x) (M.op X0 y)) := by
            intro X0
            first
            | (have i₁ := b4e4944 X0
               have i₂ := b4e22
               grind)
            | exact superpose b4e22 b4e4944
            | exact resolve b4e4944 b4e22
            | grind
            | grind (splits := 40)
            | grind (splits := 40) (ematch := 20)
          clear b4e4944
          have b4e5192 : ∀ X0 : G, (M.op y y) = (M.op (M.op X0 x) y) := by
            intro X0
            first
            | (have i₁ := b4e13 y x X0
               have i₂ := b4e4950 (M.op X0 x)
               grind)
            | exact superpose b4e4950 b4e13
            | exact resolve b4e13 b4e4950
            | grind
            | grind (splits := 40)
            | grind (splits := 40) (ematch := 20)
          clear b4e4950
          have b4e5830 : y = (M.op (M.op y x) y) := by
            first
            | (have i₁ := b4e5100 x
               have i₂ := b4e3923
               grind)
            | exact superpose b4e3923 b4e5100
            | exact resolve b4e5100 b4e3923
            | grind
            | grind (splits := 40)
            | grind (splits := 40) (ematch := 20)
          clear b4e5100
          have b4e5893 : y = (M.op y y) := by
            first
            | (have i₁ := b4e5830
               have i₂ := b4e5192 y
               grind)
            | exact superpose b4e5192 b4e5830
            | exact resolve b4e5830 b4e5192
            | grind
            | grind (splits := 40)
            | grind (splits := 40) (ematch := 20)
          clear b4e5192 b4e5830
          have b4e5977 : (σ y) = (M.op (σ x) (σ y)) := by
            first
            | (have i₁ := b4e120
               have i₂ := b4e5893
               grind)
            | exact superpose b4e5893 b4e120
            | exact resolve b4e120 b4e5893
            | grind
            | grind (splits := 40)
            | grind (splits := 40) (ematch := 20)
          clear b4e120 b4e5893
          have b4e6114 : (σ (M.op x y)) ≠ (σ y) := by
            first
            | (have i₁ := b4e20
               have i₂ := b4e5977
               grind)
            | exact superpose b4e5977 b4e20
            | exact resolve b4e20 b4e5977
            | grind
            | grind (splits := 40)
            | grind (splits := 40) (ematch := 20)
          clear b4e5977
          have b4e6137 : (σ y) ≠ (σ y) := by
            first
            | (have i₁ := b4e6114
               have i₂ := b4e3923
               grind)
            | exact superpose b4e3923 b4e6114
            | exact resolve b4e6114 b4e3923
            | grind
            | grind (splits := 40)
            | grind (splits := 40) (ematch := 20)
          clear b4e3923 b4e6114
          have b4e6138 : False := by grind
          exact b4e6138
    ...
    · rcases eq_or_ne ((σ x)) ((σ y)) with h1a | h1a
      ...
      · rcases eq_or_ne (M.op (σ x) (σ x)) ((σ y)) with h1b | h1b
        ...
        · have b8e18 : ∀ X0 X1 : G, (k X0 X1) = (M.op X0 X1) ∨ (M.op X0 X0) = X1 ∨ X0 = X1 := by
          ...
          clear hm ht hu hv hd nh hM hi1 hi2 h0a h0b h1a h1b
          have b8e70 : ∀ X0 : G, (σ y) ≠ X0 ∨ (k (σ x) X0) = (M.op (σ x) X0) ∨ (σ x) = X0 := by
            intro X0
            first
            | (have i₁ := b8e24
               have i₂ := b8e18 (σ x) X0
            ...
            | grind (splits := 40)
            | grind (splits := 40) (ematch := 20)
          have b8e355 : (M.op (σ x) (σ y)) = (k (σ x) (σ y)) ∨ (σ x) = (σ y) := by
            first
            | (have j0 := b8e70 (σ y)
               grind)
            | grind
            ...
            | grind (splits := 40) (ematch := 20)
          clear b8e70
          have b8e356 : (M.op (σ x) (σ y)) = (k (σ x) (σ y)) := by
            first
            | (have r₁ := b8e355
               have r₂ := b8e23
               grind)
            ...
            | grind (splits := 40) (ematch := 20)
          clear b8e355
          have b8e357 : (M.op (σ x) (σ y)) = (σ (k x y)) := by
            first
            | (have i₁ := b8e356
               have i₂ := b8e19 x y
               grind)
            ...
            | grind (splits := 40) (ematch := 20)
          clear b8e356
          have b8e358 : (σ (M.op x y)) ≠ (σ (k x y)) := by
            first
            | (have i₁ := b8e20
               have i₂ := b8e357
               grind)
            | exact superpose b8e357 b8e20
            | exact resolve b8e20 b8e357
            | grind
            | grind (splits := 40)
            | grind (splits := 40) (ematch := 20)
          clear b8e357
          have b8e427 : (σ (M.op x y)) ≠ (σ (M.op x y)) ∨ y = (M.op x x) ∨ x = y := by
            first
            | (have i₁ := b8e358
               have i₂ := b8e18 x y
               grind)
            | exact superpose b8e18 b8e358
            | (have j1 := b8e18 x y
               grind)
            | (have r₁ := b8e358
            ...
            | (have r₁ := b8e358
               ...
               grind)
            | exact resolve b8e358 b8e18
            | grind
            | grind (splits := 40)
            | grind (splits := 40) (ematch := 20)
          clear b8e358
          have b8e428 : y = (M.op x x) ∨ x = y := by grind
          clear b8e427
          have b8e430 : x = y := by
            first
            | (have r₁ := b8e428
               have r₂ := b8e22
               grind)
            | exact resolve b8e428 b8e22
            | grind
            | grind (splits := 40)
            | grind (splits := 40) (ematch := 20)
          clear b8e428
          have b8e432 : False := by grind
          exact b8e432
