import equational_theories.Definability.Srch_S8R108_data
...
is `decide` on `Fin 8`; the searching is in `Definability/Certs/Srch8R108T*.lean`.
-/
...
theorem not_structuralFromFin_of_srch8R108 {L L' : Law.NatMagmaLaw} (v : Magma.tup8R108)
    (hsrc : @satisfies _ (Fin 8) (Magma.srch8R108 v) L')
    (htgt : ∀ u : Magma.tup8R108, ¬ @satisfies _ (Fin 8) (Magma.srch8R108 u) L) :
    ¬ L.StructuralFromFin L' :=
  Law.MagmaLaw.not_structuralFromFin_of_tupOK S8R108.E S8R108.Einv S8R108.X S8R108.Xinv S8R108.rep S8R108.tr
    S8R108.z S8R108.st S8R108.hl S8R108.hr S8R108.hxl S8R108.hxr S8R108.htr S8R108.hz S8R108.hst v.1 v.2 hsrc htgt
