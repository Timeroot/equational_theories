import equational_theories.Definability.Srch_S9R317_data
...
is `decide` on `Fin 9`; the searching is in `Definability/Certs/Srch9R317T*.lean`.
-/
...
theorem not_structuralFromFin_of_srch9R317 {L L' : Law.NatMagmaLaw} (v : Magma.tup9R317)
    (hsrc : @satisfies _ (Fin 9) (Magma.srch9R317 v) L')
    (htgt : ∀ u : Magma.tup9R317, ¬ @satisfies _ (Fin 9) (Magma.srch9R317 u) L) :
    ¬ L.StructuralFromFin L' :=
  Law.MagmaLaw.not_structuralFromFin_of_tupOK S9R317.E S9R317.Einv S9R317.X S9R317.Xinv S9R317.rep S9R317.tr
    S9R317.z S9R317.st S9R317.hl S9R317.hr S9R317.hxl S9R317.hxr S9R317.htr S9R317.hz S9R317.hst v.1 v.2 hsrc htgt
