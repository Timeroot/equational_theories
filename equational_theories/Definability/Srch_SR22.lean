import equational_theories.Definability.Srch_SR22_data
...
is `decide` on `Fin 6`; the searching is in `Definability/Certs/SrchR22T*.lean`.
-/
...
theorem not_structuralFromFin_of_srchR22 {L L' : Law.NatMagmaLaw} (v : Magma.tupR22)
    (hsrc : @satisfies _ (Fin 6) (Magma.srchR22 v) L')
    (htgt : ∀ u : Magma.tupR22, ¬ @satisfies _ (Fin 6) (Magma.srchR22 u) L) :
    ¬ L.StructuralFromFin L' :=
  Law.MagmaLaw.not_structuralFromFin_of_tupOK SR22.E SR22.Einv SR22.X SR22.Xinv SR22.rep SR22.tr
    SR22.z SR22.st SR22.hl SR22.hr SR22.hxl SR22.hxr SR22.htr SR22.hz SR22.hst v.1 v.2 hsrc htgt
