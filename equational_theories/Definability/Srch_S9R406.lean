import equational_theories.Definability.Srch_S9R406_data
...
is `decide` on `Fin 9`; the searching is in `Definability/Certs/Srch9R406T*.lean`.
-/
...
theorem not_structuralFromFin_of_srch9R406 {L L' : Law.NatMagmaLaw} (v : Magma.tup9R406)
    (hsrc : @satisfies _ (Fin 9) (Magma.srch9R406 v) L')
    (htgt : ∀ u : Magma.tup9R406, ¬ @satisfies _ (Fin 9) (Magma.srch9R406 u) L) :
    ¬ L.StructuralFromFin L' :=
  Law.MagmaLaw.not_structuralFromFin_of_tupOK S9R406.E S9R406.Einv S9R406.X S9R406.Xinv S9R406.rep S9R406.tr
    S9R406.z S9R406.st S9R406.hl S9R406.hr S9R406.hxl S9R406.hxr S9R406.htr S9R406.hz S9R406.hst v.1 v.2 hsrc htgt
