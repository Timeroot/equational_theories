...
run_elab do
  let names : List Lean.Name := [
    ``GuardAut2_pxpxx_pyx_pxy_x_pxy_x_pxy_Equation1,
    ``GuardAut2_pxpxy_pxy_x_y_pxy_pxx_pxy_Equation1,
    ``GuardAut2_pxpyx_pxy_pxy_y_pxy_y_pxy_Equation1,
    ``GuardAut2_pxpyx_pxy_x_y_pxy_pxx_pxy_Equation1,
    ``GuardAut2_pxpyy_pypxy_x_y_pyx_x_pyx_Equation1,
    ``GuardAut2_pxx_pxy_pyx_y_pyx_y_pyx_Equation1]
