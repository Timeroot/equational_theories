import equational_theories.Definability.Srch_S8R44_data
...
is `decide` on `Fin 8`; the searching is in `Definability/Certs/Srch8R44T*.lean`.
-/
...
theorem not_structuralFromFin_of_srch8R44 {L L' : Law.NatMagmaLaw} (v : Magma.tup8R44)
    (hsrc : @satisfies _ (Fin 8) (Magma.srch8R44 v) L')
    (htgt : ∀ u : Magma.tup8R44, ¬ @satisfies _ (Fin 8) (Magma.srch8R44 u) L) :
    ¬ L.StructuralFromFin L' :=
  Law.MagmaLaw.not_structuralFromFin_of_tupOK S8R44.E S8R44.Einv S8R44.X S8R44.Xinv S8R44.rep S8R44.tr
    S8R44.z S8R44.st S8R44.hl S8R44.hr S8R44.hxl S8R44.hxr S8R44.htr S8R44.hz S8R44.hst v.1 v.2 hsrc htgt
