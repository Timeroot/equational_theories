import equational_theories.Definability.Srch_S4R1_data
...
is `decide` on `Fin 4`; the searching is in `Definability/Certs/Srch4R1T*.lean`.
-/
...
theorem not_structuralFromFin_of_srch4R1 {L L' : Law.NatMagmaLaw} (v : Magma.tup4R1)
    (hsrc : @satisfies _ (Fin 4) (Magma.srch4R1 v) L')
    (htgt : ∀ u : Magma.tup4R1, ¬ @satisfies _ (Fin 4) (Magma.srch4R1 u) L) :
    ¬ L.StructuralFromFin L' :=
  Law.MagmaLaw.not_structuralFromFin_of_tupOK S4R1.E S4R1.Einv S4R1.X S4R1.Xinv S4R1.rep S4R1.tr
    S4R1.z S4R1.st S4R1.hl S4R1.hr S4R1.hxl S4R1.hxr S4R1.htr S4R1.hz S4R1.hst v.1 v.2 hsrc htgt
