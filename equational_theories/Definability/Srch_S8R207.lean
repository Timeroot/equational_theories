import equational_theories.Definability.Srch_S8R207_data
...
is `decide` on `Fin 8`; the searching is in `Definability/Certs/Srch8R207T*.lean`.
-/
...
theorem not_structuralFromFin_of_srch8R207 {L L' : Law.NatMagmaLaw} (v : Magma.tup8R207)
    (hsrc : @satisfies _ (Fin 8) (Magma.srch8R207 v) L')
    (htgt : ∀ u : Magma.tup8R207, ¬ @satisfies _ (Fin 8) (Magma.srch8R207 u) L) :
    ¬ L.StructuralFromFin L' :=
  Law.MagmaLaw.not_structuralFromFin_of_tupOK S8R207.E S8R207.Einv S8R207.X S8R207.Xinv S8R207.rep S8R207.tr
    S8R207.z S8R207.st S8R207.hl S8R207.hr S8R207.hxl S8R207.hxr S8R207.htr S8R207.hz S8R207.hst v.1 v.2 hsrc htgt
