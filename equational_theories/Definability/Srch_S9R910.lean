import equational_theories.Definability.Srch_S9R910_data
...
is `decide` on `Fin 9`; the searching is in `Definability/Certs/Srch9R910T*.lean`.
-/
...
theorem not_structuralFromFin_of_srch9R910 {L L' : Law.NatMagmaLaw} (v : Magma.tup9R910)
    (hsrc : @satisfies _ (Fin 9) (Magma.srch9R910 v) L')
    (htgt : ∀ u : Magma.tup9R910, ¬ @satisfies _ (Fin 9) (Magma.srch9R910 u) L) :
    ¬ L.StructuralFromFin L' :=
  Law.MagmaLaw.not_structuralFromFin_of_tupOK S9R910.E S9R910.Einv S9R910.X S9R910.Xinv S9R910.rep S9R910.tr
    S9R910.z S9R910.st S9R910.hl S9R910.hr S9R910.hxl S9R910.hxr S9R910.htr S9R910.hz S9R910.hst v.1 v.2 hsrc htgt
