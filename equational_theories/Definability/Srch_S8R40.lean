import equational_theories.Definability.Srch_S8R40_data
...
is `decide` on `Fin 8`; the searching is in `Definability/Certs/Srch8R40T*.lean`.
-/
...
theorem not_structuralFromFin_of_srch8R40 {L L' : Law.NatMagmaLaw} (v : Magma.tup8R40)
    (hsrc : @satisfies _ (Fin 8) (Magma.srch8R40 v) L')
    (htgt : ∀ u : Magma.tup8R40, ¬ @satisfies _ (Fin 8) (Magma.srch8R40 u) L) :
    ¬ L.StructuralFromFin L' :=
  Law.MagmaLaw.not_structuralFromFin_of_tupOK S8R40.E S8R40.Einv S8R40.X S8R40.Xinv S8R40.rep S8R40.tr
    S8R40.z S8R40.st S8R40.hl S8R40.hr S8R40.hxl S8R40.hxr S8R40.htr S8R40.hz S8R40.hst v.1 v.2 hsrc htgt
