import equational_theories.Definability.Srch_S8R26_data
...
is `decide` on `Fin 8`; the searching is in `Definability/Certs/Srch8R26T*.lean`.
-/
...
theorem not_structuralFromFin_of_srch8R26 {L L' : Law.NatMagmaLaw} (v : Magma.tup8R26)
    (hsrc : @satisfies _ (Fin 8) (Magma.srch8R26 v) L')
    (htgt : ∀ u : Magma.tup8R26, ¬ @satisfies _ (Fin 8) (Magma.srch8R26 u) L) :
    ¬ L.StructuralFromFin L' :=
  Law.MagmaLaw.not_structuralFromFin_of_tupOK S8R26.E S8R26.Einv S8R26.X S8R26.Xinv S8R26.rep S8R26.tr
    S8R26.z S8R26.st S8R26.hl S8R26.hr S8R26.hxl S8R26.hxr S8R26.htr S8R26.hz S8R26.hst v.1 v.2 hsrc htgt
