...
/-- The orbits of the prn8h7a family, as the search takes them when refuting equation
66. This is a set, not an order: the kernel picks which one to branch on at each
node. -/
def ordprn8h7a_Law66 : List (Fin 10) := List.finRange 10
