import equational_theories.Definability.Srch_S9R401_data
...
is `decide` on `Fin 9`; the searching is in `Definability/Certs/Srch9R401T*.lean`.
-/
...
theorem not_structuralFromFin_of_srch9R401 {L L' : Law.NatMagmaLaw} (v : Magma.tup9R401)
    (hsrc : @satisfies _ (Fin 9) (Magma.srch9R401 v) L')
    (htgt : ∀ u : Magma.tup9R401, ¬ @satisfies _ (Fin 9) (Magma.srch9R401 u) L) :
    ¬ L.StructuralFromFin L' :=
  Law.MagmaLaw.not_structuralFromFin_of_tupOK S9R401.E S9R401.Einv S9R401.X S9R401.Xinv S9R401.rep S9R401.tr
    S9R401.z S9R401.st S9R401.hl S9R401.hr S9R401.hxl S9R401.hxr S9R401.htr S9R401.hz S9R401.hst v.1 v.2 hsrc htgt
