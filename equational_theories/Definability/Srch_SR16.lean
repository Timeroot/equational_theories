import equational_theories.Definability.Srch_SR16_data
...
is `decide` on `Fin 6`; the searching is in `Definability/Certs/SrchR16T*.lean`.
-/
...
theorem not_structuralFromFin_of_srchR16 {L L' : Law.NatMagmaLaw} (v : Magma.tupR16)
    (hsrc : @satisfies _ (Fin 6) (Magma.srchR16 v) L')
    (htgt : ∀ u : Magma.tupR16, ¬ @satisfies _ (Fin 6) (Magma.srchR16 u) L) :
    ¬ L.StructuralFromFin L' :=
  Law.MagmaLaw.not_structuralFromFin_of_tupOK SR16.E SR16.Einv SR16.X SR16.Xinv SR16.rep SR16.tr
    SR16.z SR16.st SR16.hl SR16.hr SR16.hxl SR16.hxr SR16.htr SR16.hz SR16.hst v.1 v.2 hsrc htgt
