import equational_theories.Definability.Srch_S7R325_data
...
is `decide` on `Fin 7`; the searching is in `Definability/Certs/Srch7R325T*.lean`.
-/
...
theorem not_structuralFromFin_of_srch7R325 {L L' : Law.NatMagmaLaw} (v : Magma.tup7R325)
    (hsrc : @satisfies _ (Fin 7) (Magma.srch7R325 v) L')
    (htgt : ∀ u : Magma.tup7R325, ¬ @satisfies _ (Fin 7) (Magma.srch7R325 u) L) :
    ¬ L.StructuralFromFin L' :=
  Law.MagmaLaw.not_structuralFromFin_of_tupOK S7R325.E S7R325.Einv S7R325.X S7R325.Xinv S7R325.rep S7R325.tr
    S7R325.z S7R325.st S7R325.hl S7R325.hr S7R325.hxl S7R325.hxr S7R325.htr S7R325.hz S7R325.hst v.1 v.2 hsrc htgt
