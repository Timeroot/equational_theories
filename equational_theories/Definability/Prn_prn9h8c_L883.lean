...
theorem noprn9h8c_Law883 : Magma.searchT prn9h8c.E Law883
    (Magma.envs 9 2) (ordprn9h8c_Law883.map fun i ↦
      ((i, (List.finRange 9).filter (Magma.orbitOK prn9h8c.E prn9h8c.z prn9h8c.st i ·)),
        Magma.cells prn9h8c.tr i))
