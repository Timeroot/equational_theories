import equational_theories.Definability.Srch_S10R806_data
...
is `decide` on `Fin 10`; the searching is in `Definability/Certs/Srch10R806T*.lean`.
-/
...
theorem not_structuralFromFin_of_srch10R806 {L L' : Law.NatMagmaLaw} (v : Magma.tup10R806)
    (hsrc : @satisfies _ (Fin 10) (Magma.srch10R806 v) L')
    (htgt : ∀ u : Magma.tup10R806, ¬ @satisfies _ (Fin 10) (Magma.srch10R806 u) L) :
    ¬ L.StructuralFromFin L' :=
  Law.MagmaLaw.not_structuralFromFin_of_tupOK S10R806.E S10R806.Einv S10R806.X S10R806.Xinv S10R806.rep S10R806.tr
    S10R806.z S10R806.st S10R806.hl S10R806.hr S10R806.hxl S10R806.hxr S10R806.htr S10R806.hz S10R806.hst v.1 v.2 hsrc htgt
