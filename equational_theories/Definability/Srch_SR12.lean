import equational_theories.Definability.Srch_SR12_data
...
is `decide` on `Fin 6`; the searching is in `Definability/Certs/SrchR12T*.lean`.
-/
...
theorem not_structuralFromFin_of_srchR12 {L L' : Law.NatMagmaLaw} (v : Magma.tupR12)
    (hsrc : @satisfies _ (Fin 6) (Magma.srchR12 v) L')
    (htgt : ∀ u : Magma.tupR12, ¬ @satisfies _ (Fin 6) (Magma.srchR12 u) L) :
    ¬ L.StructuralFromFin L' :=
  Law.MagmaLaw.not_structuralFromFin_of_tupOK SR12.E SR12.Einv SR12.X SR12.Xinv SR12.rep SR12.tr
    SR12.z SR12.st SR12.hl SR12.hr SR12.hxl SR12.hxr SR12.htr SR12.hz SR12.hst v.1 v.2 hsrc htgt
