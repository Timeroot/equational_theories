...
/-- No aut6h6b-invariant operation on `Fin 6` satisfies equation 3352. -/
theorem noaut6h6b_Law3352 : ∀ v : ∀ i : Fin 6,
    {x : Fin 6 // Magma.orbitOK aut6h6b.E aut6h6b.z aut6h6b.st i x},
    ¬ @satisfies _ (Fin 6)
      (Magma.mk (Magma.transport aut6h6b.E aut6h6b.tr fun i ↦ (v i).1)) Law3352 := by
