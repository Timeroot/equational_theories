import equational_theories.Definability.Srch_S8R68_data
...
is `decide` on `Fin 8`; the searching is in `Definability/Certs/Srch8R68T*.lean`.
-/
...
theorem not_structuralFromFin_of_srch8R68 {L L' : Law.NatMagmaLaw} (v : Magma.tup8R68)
    (hsrc : @satisfies _ (Fin 8) (Magma.srch8R68 v) L')
    (htgt : ∀ u : Magma.tup8R68, ¬ @satisfies _ (Fin 8) (Magma.srch8R68 u) L) :
    ¬ L.StructuralFromFin L' :=
  Law.MagmaLaw.not_structuralFromFin_of_tupOK S8R68.E S8R68.Einv S8R68.X S8R68.Xinv S8R68.rep S8R68.tr
    S8R68.z S8R68.st S8R68.hl S8R68.hr S8R68.hxl S8R68.hxr S8R68.htr S8R68.hz S8R68.hst v.1 v.2 hsrc htgt
