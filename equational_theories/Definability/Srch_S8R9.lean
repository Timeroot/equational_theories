import equational_theories.Definability.Srch_S8R9_data
...
is `decide` on `Fin 8`; the searching is in `Definability/Certs/Srch8R9T*.lean`.
-/
...
theorem not_structuralFromFin_of_srch8R9 {L L' : Law.NatMagmaLaw} (v : Magma.tup8R9)
    (hsrc : @satisfies _ (Fin 8) (Magma.srch8R9 v) L')
    (htgt : ∀ u : Magma.tup8R9, ¬ @satisfies _ (Fin 8) (Magma.srch8R9 u) L) :
    ¬ L.StructuralFromFin L' :=
  Law.MagmaLaw.not_structuralFromFin_of_tupOK S8R9.E S8R9.Einv S8R9.X S8R9.Xinv S8R9.rep S8R9.tr
    S8R9.z S8R9.st S8R9.hl S8R9.hr S8R9.hxl S8R9.hxr S8R9.htr S8R9.hz S8R9.hst v.1 v.2 hsrc htgt
