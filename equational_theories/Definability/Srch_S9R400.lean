import equational_theories.Definability.Srch_S9R400_data
...
is `decide` on `Fin 9`; the searching is in `Definability/Certs/Srch9R400T*.lean`.
-/
...
theorem not_structuralFromFin_of_srch9R400 {L L' : Law.NatMagmaLaw} (v : Magma.tup9R400)
    (hsrc : @satisfies _ (Fin 9) (Magma.srch9R400 v) L')
    (htgt : ∀ u : Magma.tup9R400, ¬ @satisfies _ (Fin 9) (Magma.srch9R400 u) L) :
    ¬ L.StructuralFromFin L' :=
  Law.MagmaLaw.not_structuralFromFin_of_tupOK S9R400.E S9R400.Einv S9R400.X S9R400.Xinv S9R400.rep S9R400.tr
    S9R400.z S9R400.st S9R400.hl S9R400.hr S9R400.hxl S9R400.hxr S9R400.htr S9R400.hz S9R400.hst v.1 v.2 hsrc htgt
