...
/-!
# Structural certificate sources: `Magma.srch10R803` (part 5 of 5)
...
/-- `2` equations satisfied by `Magma.srch10R803 vsrch10R8034`, and by no earlier exhibit. -/
theorem srch10R803_satisfies_4 :
    Satisfies (Magma.srch10R803 vsrch10R8034) [
      2372, 2571
    ] := by rw [esrch10R8034]; decide!
