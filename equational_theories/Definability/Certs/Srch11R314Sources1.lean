...
/-!
# Structural certificate sources: `Magma.srch11R314` (part 2 of 4)
...
/-- `1` equations satisfied by `Magma.srch11R314 vsrch11R3141`, and by no earlier exhibit. -/
theorem srch11R314_satisfies_1 :
    Satisfies (Magma.srch11R314 vsrch11R3141) [
      1922
    ] := by rw [esrch11R3141]; decide!
