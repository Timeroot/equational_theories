...
/-!
# Structural certificate targets: `Magma.rigid3` (part 49 of 49)
...
over finite carriers. `1` of them are listed here.
...
/-- None of the `19422` rigid magmas on `Fin 3` satisfies any of these `1` equations. -/
theorem rigid3_refutes_48 :
