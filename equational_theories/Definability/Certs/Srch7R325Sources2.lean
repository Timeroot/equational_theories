...
/-!
# Structural certificate sources: `Magma.srch7R325` (part 3 of 3)
...
/-- `1` equations satisfied by `Magma.srch7R325 vsrch7R3252`, and by no earlier exhibit. -/
theorem srch7R325_satisfies_2 :
    Satisfies (Magma.srch7R325 vsrch7R3252) [
      1888
    ] := by decide!
