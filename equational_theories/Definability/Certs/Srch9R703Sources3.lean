...
/-!
# Structural certificate sources: `Magma.srch9R703` (part 4 of 4)
...
/-- `1` equations satisfied by `Magma.srch9R703 vsrch9R7033`, and by no earlier exhibit. -/
theorem srch9R703_satisfies_3 :
    Satisfies (Magma.srch9R703 vsrch9R7033) [
      4073
    ] := by decide!
