...
/-!
# Structural certificate sources: `Magma.srchR14` (part 2 of 8)
...
/-- `6` equations satisfied by `Magma.srchR14 vsrchR141`, and by no earlier exhibit. -/
theorem srchR14_satisfies_1 :
    Satisfies (Magma.srchR14 vsrchR141) [
      1694, 1697, 1705, 2127, 2165, 2169
    ] := by decide!
