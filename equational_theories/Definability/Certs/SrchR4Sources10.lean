...
/-!
# Structural certificate sources: `Magma.srchR4` (part 11 of 12)
...
/-- `1` equations satisfied by `Magma.srchR4 vsrchR410`, and by no earlier exhibit. -/
theorem srchR4_satisfies_10 :
    Satisfies (Magma.srchR4 vsrchR410) [
      2883
    ] := by decide!
