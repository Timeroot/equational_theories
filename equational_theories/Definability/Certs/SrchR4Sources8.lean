...
/-!
# Structural certificate sources: `Magma.srchR4` (part 9 of 12)
...
/-- `1` equations satisfied by `Magma.srchR4 vsrchR48`, and by no earlier exhibit. -/
theorem srchR4_satisfies_8 :
    Satisfies (Magma.srchR4 vsrchR48) [
      4428
    ] := by decide!
