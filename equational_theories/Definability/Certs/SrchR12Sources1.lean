...
/-!
# Structural certificate sources: `Magma.srchR12` (part 2 of 2)
...
/-- `2` equations satisfied by `Magma.srchR12 vsrchR121`, and by no earlier exhibit. -/
theorem srchR12_satisfies_1 :
    Satisfies (Magma.srchR12 vsrchR121) [
      3587, 4533
    ] := by decide!
