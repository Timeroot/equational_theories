...
/-!
# Structural certificate sources: `Magma.srch16R308` (part 5 of 8)
...
/-- `1` equations satisfied by `Magma.srch16R308 vsrch16R3084`, and by no earlier exhibit. -/
theorem srch16R308_satisfies_4 :
    Satisfies (Magma.srch16R308 vsrch16R3084) [
      1242
    ] := by rw [esrch16R3084]; decide!
