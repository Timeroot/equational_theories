...
/-!
# Structural certificate sources: `Magma.srch11R401` (part 1 of 4)
...
/-- `3` equations satisfied by `Magma.srch11R401 vsrch11R4010`, and by no earlier exhibit. -/
theorem srch11R401_satisfies_0 :
    Satisfies (Magma.srch11R401 vsrch11R4010) [
      1726, 2741, 3147
    ] := by rw [esrch11R4010]; decide!
