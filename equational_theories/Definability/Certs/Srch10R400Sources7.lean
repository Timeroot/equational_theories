...
/-!
# Structural certificate sources: `Magma.srch10R400` (part 8 of 10)
...
/-- `2` equations satisfied by `Magma.srch10R400 vsrch10R4006`, and by no earlier exhibit. -/
theorem srch10R400_satisfies_6 :
    Satisfies (Magma.srch10R400 vsrch10R4006) [
      3587, 3993
    ] := by rw [esrch10R4006]; decide!
