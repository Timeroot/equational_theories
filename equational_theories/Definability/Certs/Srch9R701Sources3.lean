...
/-!
# Structural certificate sources: `Magma.srch9R701` (part 4 of 5)
...
/-- `1` equations satisfied by `Magma.srch9R701 vsrch9R7013`, and by no earlier exhibit. -/
theorem srch9R701_satisfies_3 :
    Satisfies (Magma.srch9R701 vsrch9R7013) [
      1641
    ] := by decide!
