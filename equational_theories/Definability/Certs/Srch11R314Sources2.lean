...
/-!
# Structural certificate sources: `Magma.srch11R314` (part 3 of 4)
...
/-- `1` equations satisfied by `Magma.srch11R314 vsrch11R3142`, and by no earlier exhibit. -/
theorem srch11R314_satisfies_2 :
    Satisfies (Magma.srch11R314 vsrch11R3142) [
      2700
    ] := by rw [esrch11R3142]; decide!
