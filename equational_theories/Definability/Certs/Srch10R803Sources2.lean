...
/-!
# Structural certificate sources: `Magma.srch10R803` (part 3 of 5)
...
/-- `3` equations satisfied by `Magma.srch10R803 vsrch10R8032`, and by no earlier exhibit. -/
theorem srch10R803_satisfies_2 :
    Satisfies (Magma.srch10R803 vsrch10R8032) [
      452, 655, 1061
    ] := by rw [esrch10R8032]; decide!
