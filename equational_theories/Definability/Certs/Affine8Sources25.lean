...
/-!
# Definability certificate sources: `Magma.affine8` (part 26 of 26)
...
/-- `60` of the `101` equations satisfied by `Magma.affine8 7` (part 1 of 2). -/
theorem affine8_satisfies_7_0 :
    Satisfies (Magma.affine8 7) [
...
/-- `41` of the `101` equations satisfied by `Magma.affine8 7` (part 2 of 2). -/
theorem affine8_satisfies_7_1 :
    Satisfies (Magma.affine8 7) [
