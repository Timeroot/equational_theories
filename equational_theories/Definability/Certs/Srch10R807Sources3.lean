...
/-!
# Structural certificate sources: `Magma.srch10R807` (part 4 of 4)
...
/-- `1` equations satisfied by `Magma.srch10R807 vsrch10R8073`, and by no earlier exhibit. -/
theorem srch10R807_satisfies_3 :
    Satisfies (Magma.srch10R807 vsrch10R8073) [
      2469
    ] := by rw [esrch10R8073]; decide!
