...
/-!
# Definability certificate sources: `Magma.affine8` (part 21 of 26)
...
/-- `60` of the `101` equations satisfied by `Magma.affine8 2` (part 1 of 2). -/
theorem affine8_satisfies_2_0 :
    Satisfies (Magma.affine8 2) [
...
/-- `41` of the `101` equations satisfied by `Magma.affine8 2` (part 2 of 2). -/
theorem affine8_satisfies_2_1 :
    Satisfies (Magma.affine8 2) [
