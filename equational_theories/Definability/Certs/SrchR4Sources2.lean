...
/-!
# Structural certificate sources: `Magma.srchR4` (part 3 of 12)
...
/-- `2` equations satisfied by `Magma.srchR4 vsrchR42`, and by no earlier exhibit. -/
theorem srchR4_satisfies_2 :
    Satisfies (Magma.srchR4 vsrchR42) [
      3671, 4475
    ] := by decide!
