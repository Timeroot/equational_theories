...
/-!
# Structural certificate sources: `Magma.srch11R401` (part 4 of 4)
...
/-- `1` equations satisfied by `Magma.srch11R401 vsrch11R4013`, and by no earlier exhibit. -/
theorem srch11R401_satisfies_3 :
    Satisfies (Magma.srch11R401 vsrch11R4013) [
      3345
    ] := by rw [esrch11R4013]; decide!
