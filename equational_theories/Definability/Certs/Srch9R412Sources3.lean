...
/-!
# Structural certificate sources: `Magma.srch9R412` (part 4 of 4)
...
/-- `1` equations satisfied by `Magma.srch9R412 vsrch9R4123`, and by no earlier exhibit. -/
theorem srch9R412_satisfies_3 :
    Satisfies (Magma.srch9R412 vsrch9R4123) [
      1443
    ] := by rw [esrch9R4123]; decide!
