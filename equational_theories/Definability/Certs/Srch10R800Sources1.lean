...
/-!
# Structural certificate sources: `Magma.srch10R800` (part 2 of 2)
...
/-- `2` equations satisfied by `Magma.srch10R800 vsrch10R8001`, and by no earlier exhibit. -/
theorem srch10R800_satisfies_1 :
    Satisfies (Magma.srch10R800 vsrch10R8001) [
      1446, 1868
    ] := by decide!
