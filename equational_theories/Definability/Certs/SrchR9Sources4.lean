...
/-!
# Structural certificate sources: `Magma.srchR9` (part 5 of 5)
...
/-- `2` equations satisfied by `Magma.srchR9 vsrchR94`, and by no earlier exhibit. -/
theorem srchR9_satisfies_4 :
    Satisfies (Magma.srchR9 vsrchR94) [
      3899, 3911
    ] := by decide!
