...
/-!
# Structural certificate sources: `Magma.srch10R400` (part 3 of 10)
...
/-- `3` equations satisfied by `Magma.srch10R400 vsrch10R4001`, and by no earlier exhibit. -/
theorem srch10R400_satisfies_1 :
    Satisfies (Magma.srch10R400 vsrch10R4001) [
      433, 854, 1043
    ] := by rw [esrch10R4001]; decide!
