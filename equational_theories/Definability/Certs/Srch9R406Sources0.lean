...
/-!
# Structural certificate sources: `Magma.srch9R406` (part 1 of 6)
...
/-- `3` equations satisfied by `Magma.srch9R406 vsrch9R4060`, and by no earlier exhibit. -/
theorem srch9R406_satisfies_0 :
    Satisfies (Magma.srch9R406 vsrch9R4060) [
      1525, 3880, 4083
    ] := by decide!
