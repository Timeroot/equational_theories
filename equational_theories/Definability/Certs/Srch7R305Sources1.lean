...
/-!
# Structural certificate sources: `Magma.srch7R305` (part 2 of 2)
...
/-- `1` equations satisfied by `Magma.srch7R305 vsrch7R3051`, and by no earlier exhibit. -/
theorem srch7R305_satisfies_1 :
    Satisfies (Magma.srch7R305 vsrch7R3051) [
      2420
    ] := by decide!
