...
/-!
# Structural certificate sources: `Magma.srch16R308` (part 8 of 8)
...
/-- `1` equations satisfied by `Magma.srch16R308 vsrch16R3087`, and by no earlier exhibit. -/
theorem srch16R308_satisfies_7 :
    Satisfies (Magma.srch16R308 vsrch16R3087) [
      2912
    ] := by rw [esrch16R3087]; decide!
