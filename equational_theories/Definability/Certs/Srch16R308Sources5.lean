...
/-!
# Structural certificate sources: `Magma.srch16R308` (part 6 of 8)
...
/-- `1` equations satisfied by `Magma.srch16R308 vsrch16R3085`, and by no earlier exhibit. -/
theorem srch16R308_satisfies_5 :
    Satisfies (Magma.srch16R308 vsrch16R3085) [
      3115
    ] := by rw [esrch16R3085]; decide!
