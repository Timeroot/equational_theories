...
/-!
# Structural certificate sources: `Magma.srch9R404` (part 1 of 2)
...
/-- `1` equations satisfied by `Magma.srch9R404 vsrch9R4040`, and by no earlier exhibit. -/
theorem srch9R404_satisfies_0 :
    Satisfies (Magma.srch9R404 vsrch9R4040) [
      3346
    ] := by decide!
