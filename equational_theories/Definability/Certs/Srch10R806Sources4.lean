...
/-!
# Structural certificate sources: `Magma.srch10R806` (part 5 of 6)
...
/-- `1` equations satisfied by `Magma.srch10R806 vsrch10R8064`, and by no earlier exhibit. -/
theorem srch10R806_satisfies_4 :
    Satisfies (Magma.srch10R806 vsrch10R8064) [
      2646
    ] := by rw [esrch10R8064]; decide!
