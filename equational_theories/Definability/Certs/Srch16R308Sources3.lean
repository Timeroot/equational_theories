...
/-!
# Structural certificate sources: `Magma.srch16R308` (part 4 of 8)
...
/-- `1` equations satisfied by `Magma.srch16R308 vsrch16R3083`, and by no earlier exhibit. -/
theorem srch16R308_satisfies_3 :
    Satisfies (Magma.srch16R308 vsrch16R3083) [
      2330
    ] := by rw [esrch16R3083]; decide!
