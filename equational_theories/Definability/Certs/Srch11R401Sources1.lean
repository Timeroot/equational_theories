...
/-!
# Structural certificate sources: `Magma.srch11R401` (part 2 of 4)
...
/-- `3` equations satisfied by `Magma.srch11R401 vsrch11R4011`, and by no earlier exhibit. -/
theorem srch11R401_satisfies_1 :
    Satisfies (Magma.srch11R401 vsrch11R4011) [
      508, 914, 1929
    ] := by rw [esrch11R4011]; decide!
