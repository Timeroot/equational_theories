...
/-!
# Structural certificate targets: `Magma.exactC45` (part 41 of 60)

Equations with no model among the `15214` magmas on `Fin 5` whose automorphism group is exactly the
order-`4` group of `Magma.permEC45`. `873` of them are worth listing, of which `9` appear here; each
...
`Magma.permEC45` satisfies any of these `9` equations. -/
theorem exactC45_refutes_40 :
    FamilyRefutes Magma.exactC45 [
      4246, 4247, 4249, 4250, 4251, 4252, 4254, 4255, 4256
    ] := by nativeDecideFin!
