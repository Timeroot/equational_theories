...
/-!
# Structural certificate sources: `Magma.srch10R801` (part 5 of 12)
...
/-- `2` equations satisfied by `Magma.srch10R801 vsrch10R8014`, and by no earlier exhibit. -/
theorem srch10R801_satisfies_4 :
    Satisfies (Magma.srch10R801 vsrch10R8014) [
      3929, 4474
    ] := by decide!
