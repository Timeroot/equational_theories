...
/-!
# Structural certificate sources: `Magma.srchR9` (part 3 of 5)
...
/-- `3` equations satisfied by `Magma.srchR9 vsrchR92`, and by no earlier exhibit. -/
theorem srchR9_satisfies_2 :
    Satisfies (Magma.srchR9 vsrchR92) [
      3681, 3695, 3707
    ] := by decide!
