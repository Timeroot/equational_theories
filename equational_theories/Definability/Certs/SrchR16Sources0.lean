...
/-!
# Structural certificate sources: `Magma.srchR16` (part 1 of 2)
...
/-- `2` equations satisfied by `Magma.srchR16 vsrchR160`, and by no earlier exhibit. -/
theorem srchR16_satisfies_0 :
    Satisfies (Magma.srchR16 vsrchR160) [
      2045, 2883
    ] := by decide!
