...
/-!
# Structural certificate sources: `Magma.srch9R406` (part 2 of 6)
...
/-- `2` equations satisfied by `Magma.srch9R406 vsrch9R4061`, and by no earlier exhibit. -/
theorem srch9R406_satisfies_1 :
    Satisfies (Magma.srch9R406 vsrch9R4061) [
      2044, 2875
    ] := by decide!
