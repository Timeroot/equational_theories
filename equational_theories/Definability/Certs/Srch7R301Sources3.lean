...
/-!
# Structural certificate sources: `Magma.srch7R301` (part 4 of 4)
...
/-- `1` equations satisfied by `Magma.srch7R301 vsrch7R3013`, and by no earlier exhibit. -/
theorem srch7R301_satisfies_3 :
    Satisfies (Magma.srch7R301 vsrch7R3013) [
      1516
    ] := by decide!
