...
/-!
# Structural certificate sources: `Magma.srchR7` (part 4 of 4)
...
/-- `2` equations satisfied by `Magma.srchR7 vsrchR73`, and by no earlier exhibit. -/
theorem srchR7_satisfies_3 :
    Satisfies (Magma.srchR7 vsrchR73) [
      3786, 4416
    ] := by decide!
