...
/-!
# Structural certificate sources: `Magma.srch10R404` (part 2 of 2)
...
/-- `1` equations satisfied by `Magma.srch10R404 vsrch10R4041`, and by no earlier exhibit. -/
theorem srch10R404_satisfies_1 :
    Satisfies (Magma.srch10R404 vsrch10R4041) [
      2716
    ] := by rw [esrch10R4041]; decide!
