...
/-!
# Structural certificate sources: `Magma.srch9R406` (part 4 of 6)
...
/-- `1` equations satisfied by `Magma.srch9R406 vsrch9R4063`, and by no earlier exhibit. -/
theorem srch9R406_satisfies_3 :
    Satisfies (Magma.srch9R406 vsrch9R4063) [
      4321
    ] := by decide!
