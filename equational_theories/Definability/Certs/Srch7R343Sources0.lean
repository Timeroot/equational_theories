...
/-!
# Structural certificate sources: `Magma.srch7R343` (part 1 of 3)
...
/-- `2` equations satisfied by `Magma.srch7R343 vsrch7R3430`, and by no earlier exhibit. -/
theorem srch7R343_satisfies_0 :
    Satisfies (Magma.srch7R343 vsrch7R3430) [
      335, 384
    ] := by decide!
