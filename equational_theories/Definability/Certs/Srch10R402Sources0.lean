...
/-!
# Structural certificate sources: `Magma.srch10R402` (part 1 of 2)
...
/-- `1` equations satisfied by `Magma.srch10R402 vsrch10R4020`, and by no earlier exhibit. -/
theorem srch10R402_satisfies_0 :
    Satisfies (Magma.srch10R402 vsrch10R4020) [
      2670
    ] := by rw [esrch10R4020]; decide!
