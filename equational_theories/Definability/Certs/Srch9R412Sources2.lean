...
/-!
# Structural certificate sources: `Magma.srch9R412` (part 3 of 4)
...
/-- `1` equations satisfied by `Magma.srch9R412 vsrch9R4122`, and by no earlier exhibit. -/
theorem srch9R412_satisfies_2 :
    Satisfies (Magma.srch9R412 vsrch9R4122) [
      4452
    ] := by rw [esrch9R4122]; decide!
