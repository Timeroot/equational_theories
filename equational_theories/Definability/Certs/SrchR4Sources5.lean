...
/-!
# Structural certificate sources: `Magma.srchR4` (part 6 of 12)
...
/-- `2` equations satisfied by `Magma.srchR4 vsrchR45`, and by no earlier exhibit. -/
theorem srchR4_satisfies_5 :
    Satisfies (Magma.srchR4 vsrchR45) [
      960, 1560
    ] := by decide!
