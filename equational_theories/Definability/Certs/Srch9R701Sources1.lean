...
/-!
# Structural certificate sources: `Magma.srch9R701` (part 2 of 5)
...
/-- `6` equations satisfied by `Magma.srch9R701 vsrch9R7011`, and by no earlier exhibit. -/
theorem srch9R701_satisfies_1 :
    Satisfies (Magma.srch9R701 vsrch9R7011) [
      508, 731, 914, 981, 1543, 1929
    ] := by decide!
