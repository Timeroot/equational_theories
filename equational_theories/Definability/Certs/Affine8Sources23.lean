...
/-!
# Definability certificate sources: `Magma.affine8` (part 24 of 26)
...
/-- `60` of the `101` equations satisfied by `Magma.affine8 5` (part 1 of 2). -/
theorem affine8_satisfies_5_0 :
    Satisfies (Magma.affine8 5) [
...
/-- `41` of the `101` equations satisfied by `Magma.affine8 5` (part 2 of 2). -/
theorem affine8_satisfies_5_1 :
    Satisfies (Magma.affine8 5) [
