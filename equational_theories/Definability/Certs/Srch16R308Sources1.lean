...
/-!
# Structural certificate sources: `Magma.srch16R308` (part 2 of 8)
...
/-- `4` equations satisfied by `Magma.srch16R308 vsrch16R3081`, and by no earlier exhibit. -/
theorem srch16R308_satisfies_1 :
    Satisfies (Magma.srch16R308 vsrch16R3081) [
      1112, 1315, 1353, 2115
    ] := by rw [esrch16R3081]; decide!
