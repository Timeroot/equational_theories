...
/-!
# Structural certificate sources: `Magma.srch10R808` (part 3 of 3)
...
/-- `3` equations satisfied by `Magma.srch10R808 vsrch10R8082`, and by no earlier exhibit. -/
theorem srch10R808_satisfies_2 :
    Satisfies (Magma.srch10R808 vsrch10R8082) [
      3306, 3353, 3962
    ] := by rw [esrch10R8082]; decide!
