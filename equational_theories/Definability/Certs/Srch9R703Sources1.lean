...
/-!
# Structural certificate sources: `Magma.srch9R703` (part 2 of 4)
...
/-- `1` equations satisfied by `Magma.srch9R703 vsrch9R7031`, and by no earlier exhibit. -/
theorem srch9R703_satisfies_1 :
    Satisfies (Magma.srch9R703 vsrch9R7031) [
      1489
    ] := by decide!
