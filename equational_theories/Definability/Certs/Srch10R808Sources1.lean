...
/-!
# Structural certificate sources: `Magma.srch10R808` (part 2 of 3)
...
/-- `3` equations satisfied by `Magma.srch10R808 vsrch10R8081`, and by no earlier exhibit. -/
theorem srch10R808_satisfies_1 :
    Satisfies (Magma.srch10R808 vsrch10R8081) [
      3518, 4127, 4131
    ] := by rw [esrch10R8081]; decide!
