...
/-!
# Structural certificate sources: `Magma.srch10R801` (part 11 of 12)
...
/-- `1` equations satisfied by `Magma.srch10R801 vsrch10R80110`, and by no earlier exhibit. -/
theorem srch10R801_satisfies_10 :
    Satisfies (Magma.srch10R801 vsrch10R80110) [
      1043
    ] := by decide!
