...
/-!
# Structural certificate sources: `Magma.srch10R806` (part 6 of 6)
...
/-- `1` equations satisfied by `Magma.srch10R806 vsrch10R8065`, and by no earlier exhibit. -/
theorem srch10R806_satisfies_5 :
    Satisfies (Magma.srch10R806 vsrch10R8065) [
      832
    ] := by rw [esrch10R8065]; decide!
