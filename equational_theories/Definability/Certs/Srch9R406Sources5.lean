...
/-!
# Structural certificate sources: `Magma.srch9R406` (part 6 of 6)
...
/-- `1` equations satisfied by `Magma.srch9R406 vsrch9R4065`, and by no earlier exhibit. -/
theorem srch9R406_satisfies_5 :
    Satisfies (Magma.srch9R406 vsrch9R4065) [
      642
    ] := by decide!
