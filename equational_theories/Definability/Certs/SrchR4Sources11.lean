...
/-!
# Structural certificate sources: `Magma.srchR4` (part 12 of 12)
...
/-- `1` equations satisfied by `Magma.srchR4 vsrchR411`, and by no earlier exhibit. -/
theorem srchR4_satisfies_11 :
    Satisfies (Magma.srchR4 vsrchR411) [
      690
    ] := by decide!
