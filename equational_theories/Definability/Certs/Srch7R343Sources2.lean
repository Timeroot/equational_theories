...
/-!
# Structural certificate sources: `Magma.srch7R343` (part 3 of 3)
...
/-- `1` equations satisfied by `Magma.srch7R343 vsrch7R3432`, and by no earlier exhibit. -/
theorem srch7R343_satisfies_2 :
    Satisfies (Magma.srch7R343 vsrch7R3432) [
      3617
    ] := by decide!
