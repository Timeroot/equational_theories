...
/-!
# Structural certificate sources: `Magma.srch10R807` (part 2 of 4)
...
/-- `1` equations satisfied by `Magma.srch10R807 vsrch10R8071`, and by no earlier exhibit. -/
theorem srch10R807_satisfies_1 :
    Satisfies (Magma.srch10R807 vsrch10R8071) [
      1488
    ] := by rw [esrch10R8071]; decide!
