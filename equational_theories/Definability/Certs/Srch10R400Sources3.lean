...
/-!
# Structural certificate sources: `Magma.srch10R400` (part 4 of 10)
...
/-- `3` equations satisfied by `Magma.srch10R400 vsrch10R4002`, and by no earlier exhibit. -/
theorem srch10R400_satisfies_2 :
    Satisfies (Magma.srch10R400 vsrch10R4002) [
      2536, 2712, 3180
    ] := by rw [esrch10R4002]; decide!
