...
/-!
# Structural certificate sources: `Magma.srch11R314` (part 1 of 4)
...
/-- `1` equations satisfied by `Magma.srch11R314 vsrch11R3140`, and by no earlier exhibit. -/
theorem srch11R314_satisfies_0 :
    Satisfies (Magma.srch11R314 vsrch11R3140) [
      907
    ] := by rw [esrch11R3140]; decide!
