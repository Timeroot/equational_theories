...
/-!
# Structural certificate sources: `Magma.srch10R403` (part 1 of 2)
...
/-- `1` equations satisfied by `Magma.srch10R403 vsrch10R4030`, and by no earlier exhibit. -/
theorem srch10R403_satisfies_0 :
    Satisfies (Magma.srch10R403 vsrch10R4030) [
      3066
    ] := by rw [esrch10R4030]; decide!
