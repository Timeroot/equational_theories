...
/-!
# Definability certificate sources: `Magma.affine8` (part 23 of 26)
...
/-- `60` of the `101` equations satisfied by `Magma.affine8 4` (part 1 of 2). -/
theorem affine8_satisfies_4_0 :
    Satisfies (Magma.affine8 4) [
...
/-- `41` of the `101` equations satisfied by `Magma.affine8 4` (part 2 of 2). -/
theorem affine8_satisfies_4_1 :
    Satisfies (Magma.affine8 4) [
