...
/-!
# Structural certificate sources: `Magma.srchR4` (part 8 of 12)
...
/-- `1` equations satisfied by `Magma.srchR4 vsrchR47`, and by no earlier exhibit. -/
theorem srchR4_satisfies_7 :
    Satisfies (Magma.srchR4 vsrchR47) [
      4521
    ] := by decide!
