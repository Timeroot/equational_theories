...
/-!
# Structural certificate sources: `Magma.srchR4` (part 5 of 12)
...
/-- `2` equations satisfied by `Magma.srchR4 vsrchR44`, and by no earlier exhibit. -/
theorem srchR4_satisfies_4 :
    Satisfies (Magma.srchR4 vsrchR44) [
      2055, 2656
    ] := by decide!
