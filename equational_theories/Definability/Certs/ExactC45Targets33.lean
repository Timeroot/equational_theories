...
/-!
# Structural certificate targets: `Magma.exactC45` (part 34 of 60)

Equations with no model among the `15214` magmas on `Fin 5` whose automorphism group is exactly the
order-`4` group of `Magma.permEC45`. `873` of them are worth listing, of which `6` appear here; each
...
`Magma.permEC45` satisfies any of these `6` equations. -/
theorem exactC45_refutes_33 :
    FamilyRefutes Magma.exactC45 [
      4054, 4056, 4057, 4058, 4059, 4061
    ] := by nativeDecideFin!
