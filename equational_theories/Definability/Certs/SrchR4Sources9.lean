...
/-!
# Structural certificate sources: `Magma.srchR4` (part 10 of 12)
...
/-- `1` equations satisfied by `Magma.srchR4 vsrchR49`, and by no earlier exhibit. -/
theorem srchR4_satisfies_9 :
    Satisfies (Magma.srchR4 vsrchR49) [
      2994
    ] := by decide!
