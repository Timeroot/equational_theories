...
/-!
# Structural certificate sources: `Magma.srch10R801` (part 10 of 12)
...
/-- `2` equations satisfied by `Magma.srch10R801 vsrch10R8019`, and by no earlier exhibit. -/
theorem srch10R801_satisfies_9 :
    Satisfies (Magma.srch10R801 vsrch10R8019) [
      1694, 2127
    ] := by decide!
