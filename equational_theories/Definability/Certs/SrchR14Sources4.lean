...
/-!
# Structural certificate sources: `Magma.srchR14` (part 5 of 8)
...
/-- `1` equations satisfied by `Magma.srchR14 vsrchR144`, and by no earlier exhibit. -/
theorem srchR14_satisfies_4 :
    Satisfies (Magma.srchR14 vsrchR144) [
      4511
    ] := by decide!
