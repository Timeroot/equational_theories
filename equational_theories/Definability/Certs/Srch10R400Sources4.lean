...
/-!
# Structural certificate sources: `Magma.srch10R400` (part 5 of 10)
...
/-- `2` equations satisfied by `Magma.srch10R400 vsrch10R4003`, and by no earlier exhibit. -/
theorem srch10R400_satisfies_3 :
    Satisfies (Magma.srch10R400 vsrch10R4003) [
      1037, 1636
    ] := by rw [esrch10R4003]; decide!
