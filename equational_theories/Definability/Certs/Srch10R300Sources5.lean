...
/-!
# Structural certificate sources: `Magma.srch10R300` (part 6 of 7)
...
/-- `2` equations satisfied by `Magma.srch10R300 vsrch10R3005`, and by no earlier exhibit. -/
theorem srch10R300_satisfies_5 :
    Satisfies (Magma.srch10R300 vsrch10R3005) [
      433, 854
    ] := by rw [esrch10R3005]; decide!
