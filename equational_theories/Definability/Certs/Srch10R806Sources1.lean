...
/-!
# Structural certificate sources: `Magma.srch10R806` (part 2 of 6)
...
/-- `3` equations satisfied by `Magma.srch10R806 vsrch10R8061`, and by no earlier exhibit. -/
theorem srch10R806_satisfies_1 :
    Satisfies (Magma.srch10R806 vsrch10R8061) [
      2443, 2469, 2472
    ] := by rw [esrch10R8061]; decide!
