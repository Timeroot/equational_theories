...
/-!
# Structural certificate sources: `Magma.srch10R801` (part 7 of 12)
...
/-- `2` equations satisfied by `Magma.srch10R801 vsrch10R8016`, and by no earlier exhibit. -/
theorem srch10R801_satisfies_6 :
    Satisfies (Magma.srch10R801 vsrch10R8016) [
      4440, 4521
    ] := by decide!
