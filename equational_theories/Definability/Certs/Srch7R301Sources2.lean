...
/-!
# Structural certificate sources: `Magma.srch7R301` (part 3 of 4)
...
/-- `1` equations satisfied by `Magma.srch7R301 vsrch7R3012`, and by no earlier exhibit. -/
theorem srch7R301_satisfies_2 :
    Satisfies (Magma.srch7R301 vsrch7R3012) [
      2091
    ] := by decide!
