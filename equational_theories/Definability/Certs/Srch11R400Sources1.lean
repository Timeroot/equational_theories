...
/-!
# Structural certificate sources: `Magma.srch11R400` (part 2 of 2)
...
/-- `1` equations satisfied by `Magma.srch11R400 vsrch11R4001`, and by no earlier exhibit. -/
theorem srch11R400_satisfies_1 :
    Satisfies (Magma.srch11R400 vsrch11R4001) [
      325
    ] := by rw [esrch11R4001]; decide!
