...
/-!
# Structural certificate targets: `Magma.exactC45` (part 35 of 60)

Equations with no model among the `15214` magmas on `Fin 5` whose automorphism group is exactly the
order-`4` group of `Magma.permEC45`. `873` of them are worth listing, of which `2` appear here; each
...
`Magma.permEC45` satisfies any of these `2` equations. -/
theorem exactC45_refutes_34 :
