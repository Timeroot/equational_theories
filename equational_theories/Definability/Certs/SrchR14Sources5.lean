...
/-!
# Structural certificate sources: `Magma.srchR14` (part 6 of 8)
...
/-- `1` equations satisfied by `Magma.srchR14 vsrchR145`, and by no earlier exhibit. -/
theorem srchR14_satisfies_5 :
    Satisfies (Magma.srchR14 vsrchR145) [
      4416
    ] := by decide!
