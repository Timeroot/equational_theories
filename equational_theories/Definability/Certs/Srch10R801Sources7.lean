...
/-!
# Structural certificate sources: `Magma.srch10R801` (part 8 of 12)
...
/-- `2` equations satisfied by `Magma.srch10R801 vsrch10R8017`, and by no earlier exhibit. -/
theorem srch10R801_satisfies_7 :
    Satisfies (Magma.srch10R801 vsrch10R8017) [
      3583, 4529
    ] := by decide!
