...
/-!
# Structural certificate sources: `Magma.srch10R801` (part 9 of 12)
...
/-- `2` equations satisfied by `Magma.srch10R801 vsrch10R8018`, and by no earlier exhibit. -/
theorem srch10R801_satisfies_8 :
    Satisfies (Magma.srch10R801 vsrch10R8018) [
      1445, 1858
    ] := by decide!
