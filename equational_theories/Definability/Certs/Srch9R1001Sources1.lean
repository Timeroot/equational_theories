...
/-!
# Structural certificate sources: `Magma.srch9R1001` (part 2 of 2)
...
/-- `1` equations satisfied by `Magma.srch9R1001 vsrch9R10011`, and by no earlier exhibit. -/
theorem srch9R1001_satisfies_1 :
    Satisfies (Magma.srch9R1001 vsrch9R10011) [
      4525
    ] := by rw [esrch9R10011]; decide!
