...
/-!
# Structural certificate sources: `Magma.srch9R409` (part 1 of 2)
...
/-- `1` equations satisfied by `Magma.srch9R409 vsrch9R4090`, and by no earlier exhibit. -/
theorem srch9R409_satisfies_0 :
    Satisfies (Magma.srch9R409 vsrch9R4090) [
      1641
    ] := by rw [esrch9R4090]; decide!
