...
/-!
# Structural certificate sources: `Magma.srch9R412` (part 2 of 4)
...
/-- `1` equations satisfied by `Magma.srch9R412 vsrch9R4121`, and by no earlier exhibit. -/
theorem srch9R412_satisfies_1 :
    Satisfies (Magma.srch9R412 vsrch9R4121) [
      4401
    ] := by rw [esrch9R4121]; decide!
