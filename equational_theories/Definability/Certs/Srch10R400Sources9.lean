...
/-!
# Structural certificate sources: `Magma.srch10R400` (part 10 of 10)
...
/-- `1` equations satisfied by `Magma.srch10R400 vsrch10R4008`, and by no earlier exhibit. -/
theorem srch10R400_satisfies_8 :
    Satisfies (Magma.srch10R400 vsrch10R4008) [
      4007
    ] := by rw [esrch10R4008]; decide!
