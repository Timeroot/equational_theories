...
/-!
# Structural certificate sources: `Magma.srchR4` (part 1 of 12)
...
/-- `7` equations satisfied by `Magma.srchR4 vsrchR40`, and by no earlier exhibit. -/
theorem srchR4_satisfies_0 :
    Satisfies (Magma.srchR4 vsrchR40) [
      3666, 3735, 3737, 3738, 4439, 4515, 4519
    ] := by decide!
