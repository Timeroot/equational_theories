...
/-!
# Structural certificate sources: `Magma.srch9R400` (part 3 of 3)
...
/-- `1` equations satisfied by `Magma.srch9R400 vsrch9R4002`, and by no earlier exhibit. -/
theorem srch9R400_satisfies_2 :
    Satisfies (Magma.srch9R400 vsrch9R4002) [
      4415
    ] := by decide!
