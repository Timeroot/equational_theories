...
/-!
# Structural certificate sources: `Magma.srch10R400` (part 6 of 10)
...
/-- `2` equations satisfied by `Magma.srch10R400 vsrch10R4004`, and by no earlier exhibit. -/
theorem srch10R400_satisfies_4 :
    Satisfies (Magma.srch10R400 vsrch10R4004) [
      1904, 2499
    ] := by rw [esrch10R4004]; decide!
