...
/-!
# Structural certificate sources: `Magma.srch10R806` (part 1 of 6)
...
/-- `3` equations satisfied by `Magma.srch10R806 vsrch10R8060`, and by no earlier exhibit. -/
theorem srch10R806_satisfies_0 :
    Satisfies (Magma.srch10R806 vsrch10R8060) [
      1035, 1048, 1063
    ] := by rw [esrch10R8060]; decide!
