...
/-!
# Structural certificate sources: `Magma.srch9R406` (part 3 of 6)
...
/-- `2` equations satisfied by `Magma.srch9R406 vsrch9R4062`, and by no earlier exhibit. -/
theorem srch9R406_satisfies_2 :
    Satisfies (Magma.srch9R406 vsrch9R4062) [
      3259, 3462
    ] := by decide!
