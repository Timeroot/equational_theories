...
/-!
# Structural certificate sources: `Magma.srch10R806` (part 4 of 6)
...
/-- `2` equations satisfied by `Magma.srch10R806 vsrch10R8063`, and by no earlier exhibit. -/
theorem srch10R806_satisfies_3 :
    Satisfies (Magma.srch10R806 vsrch10R8063) [
      615, 1021
    ] := by rw [esrch10R8063]; decide!
