...
/-!
# Structural certificate sources: `Magma.srch10R803` (part 4 of 5)
...
/-- `2` equations satisfied by `Magma.srch10R803 vsrch10R8033`, and by no earlier exhibit. -/
theorem srch10R803_satisfies_3 :
    Satisfies (Magma.srch10R803 vsrch10R8033) [
      1042, 1243
    ] := by rw [esrch10R8033]; decide!
