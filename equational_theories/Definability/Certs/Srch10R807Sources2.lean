...
/-!
# Structural certificate sources: `Magma.srch10R807` (part 3 of 4)
...
/-- `1` equations satisfied by `Magma.srch10R807 vsrch10R8072`, and by no earlier exhibit. -/
theorem srch10R807_satisfies_2 :
    Satisfies (Magma.srch10R807 vsrch10R8072) [
      1048
    ] := by rw [esrch10R8072]; decide!
