...
/-!
# Structural certificate sources: `Magma.srch9R703` (part 3 of 4)
...
/-- `1` equations satisfied by `Magma.srch9R703 vsrch9R7032`, and by no earlier exhibit. -/
theorem srch9R703_satisfies_2 :
    Satisfies (Magma.srch9R703 vsrch9R7032) [
      3261
    ] := by decide!
