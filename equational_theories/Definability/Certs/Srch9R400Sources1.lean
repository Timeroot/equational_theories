...
/-!
# Structural certificate sources: `Magma.srch9R400` (part 2 of 3)
...
/-- `2` equations satisfied by `Magma.srch9R400 vsrch9R4001`, and by no earlier exhibit. -/
theorem srch9R400_satisfies_1 :
    Satisfies (Magma.srch9R400 vsrch9R4001) [
      2712, 3180
    ] := by decide!
