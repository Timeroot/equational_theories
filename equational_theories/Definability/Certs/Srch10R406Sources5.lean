...
/-!
# Structural certificate sources: `Magma.srch10R406` (part 6 of 6)
...
/-- `2` equations satisfied by `Magma.srch10R406 vsrch10R4065`, and by no earlier exhibit. -/
theorem srch10R406_satisfies_5 :
    Satisfies (Magma.srch10R406 vsrch10R4065) [
      4175, 4209
    ] := by rw [esrch10R4065]; decide!
