...
/-!
# Structural certificate sources: `Magma.srchR4` (part 7 of 12)
...
/-- `1` equations satisfied by `Magma.srchR4 vsrchR46`, and by no earlier exhibit. -/
theorem srchR4_satisfies_6 :
    Satisfies (Magma.srchR4 vsrchR46) [
      646
    ] := by decide!
