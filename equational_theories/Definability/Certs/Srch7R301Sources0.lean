...
/-!
# Structural certificate sources: `Magma.srch7R301` (part 1 of 4)
...
/-- `1` equations satisfied by `Magma.srch7R301 vsrch7R3010`, and by no earlier exhibit. -/
theorem srch7R301_satisfies_0 :
    Satisfies (Magma.srch7R301 vsrch7R3010) [
      1279
    ] := by decide!
