...
/-!
# Structural certificate sources: `Magma.srch10R801` (part 6 of 12)
...
/-- `2` equations satisfied by `Magma.srch10R801 vsrch10R8015`, and by no earlier exhibit. -/
theorem srch10R801_satisfies_5 :
    Satisfies (Magma.srch10R801 vsrch10R8015) [
      4412, 4428
    ] := by decide!
