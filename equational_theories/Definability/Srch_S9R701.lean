import equational_theories.Definability.Srch_S9R701_data
...
is `decide` on `Fin 9`; the searching is in `Definability/Certs/Srch9R701T*.lean`.
-/
...
theorem not_structuralFromFin_of_srch9R701 {L L' : Law.NatMagmaLaw} (v : Magma.tup9R701)
    (hsrc : @satisfies _ (Fin 9) (Magma.srch9R701 v) L')
    (htgt : ∀ u : Magma.tup9R701, ¬ @satisfies _ (Fin 9) (Magma.srch9R701 u) L) :
    ¬ L.StructuralFromFin L' :=
  Law.MagmaLaw.not_structuralFromFin_of_tupOK S9R701.E S9R701.Einv S9R701.X S9R701.Xinv S9R701.rep S9R701.tr
    S9R701.z S9R701.st S9R701.hl S9R701.hr S9R701.hxl S9R701.hxr S9R701.htr S9R701.hz S9R701.hst v.1 v.2 hsrc htgt
