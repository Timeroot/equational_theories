import equational_theories.Definability.Srch_S7R12_data
...
is `decide` on `Fin 7`; the searching is in `Definability/Certs/Srch7R12T*.lean`.
-/
...
theorem not_structuralFromFin_of_srch7R12 {L L' : Law.NatMagmaLaw} (v : Magma.tup7R12)
    (hsrc : @satisfies _ (Fin 7) (Magma.srch7R12 v) L')
    (htgt : ∀ u : Magma.tup7R12, ¬ @satisfies _ (Fin 7) (Magma.srch7R12 u) L) :
    ¬ L.StructuralFromFin L' :=
  Law.MagmaLaw.not_structuralFromFin_of_tupOK S7R12.E S7R12.Einv S7R12.X S7R12.Xinv S7R12.rep S7R12.tr
    S7R12.z S7R12.st S7R12.hl S7R12.hr S7R12.hxl S7R12.hxr S7R12.htr S7R12.hz S7R12.hst v.1 v.2 hsrc htgt
