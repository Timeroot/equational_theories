import equational_theories.Definability.Srch_S8R162_data
...
is `decide` on `Fin 8`; the searching is in `Definability/Certs/Srch8R162T*.lean`.
-/
...
theorem not_structuralFromFin_of_srch8R162 {L L' : Law.NatMagmaLaw} (v : Magma.tup8R162)
    (hsrc : @satisfies _ (Fin 8) (Magma.srch8R162 v) L')
    (htgt : ∀ u : Magma.tup8R162, ¬ @satisfies _ (Fin 8) (Magma.srch8R162 u) L) :
    ¬ L.StructuralFromFin L' :=
  Law.MagmaLaw.not_structuralFromFin_of_tupOK S8R162.E S8R162.Einv S8R162.X S8R162.Xinv S8R162.rep S8R162.tr
    S8R162.z S8R162.st S8R162.hl S8R162.hr S8R162.hxl S8R162.hxr S8R162.htr S8R162.hz S8R162.hst v.1 v.2 hsrc htgt
