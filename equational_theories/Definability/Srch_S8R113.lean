import equational_theories.Definability.Srch_S8R113_data
...
is `decide` on `Fin 8`; the searching is in `Definability/Certs/Srch8R113T*.lean`.
-/
...
theorem not_structuralFromFin_of_srch8R113 {L L' : Law.NatMagmaLaw} (v : Magma.tup8R113)
    (hsrc : @satisfies _ (Fin 8) (Magma.srch8R113 v) L')
    (htgt : ∀ u : Magma.tup8R113, ¬ @satisfies _ (Fin 8) (Magma.srch8R113 u) L) :
    ¬ L.StructuralFromFin L' :=
  Law.MagmaLaw.not_structuralFromFin_of_tupOK S8R113.E S8R113.Einv S8R113.X S8R113.Xinv S8R113.rep S8R113.tr
    S8R113.z S8R113.st S8R113.hl S8R113.hr S8R113.hxl S8R113.hxr S8R113.htr S8R113.hz S8R113.hst v.1 v.2 hsrc htgt
