...
/-- No aut7h20a-invariant operation on `Fin 7` satisfies equation 707. -/
theorem noaut7h20a_Law707 : ∀ v : ∀ i : Fin 10,
    {x : Fin 7 // Magma.orbitOK aut7h20a.E aut7h20a.z aut7h20a.st i x},
    ¬ @satisfies _ (Fin 7)
      (Magma.mk (Magma.transport aut7h20a.E aut7h20a.tr fun i ↦ (v i).1)) Law707 := by
