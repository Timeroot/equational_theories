import equational_theories.Definability.Srch_S8R66_data
...
is `decide` on `Fin 8`; the searching is in `Definability/Certs/Srch8R66T*.lean`.
-/
...
theorem not_structuralFromFin_of_srch8R66 {L L' : Law.NatMagmaLaw} (v : Magma.tup8R66)
    (hsrc : @satisfies _ (Fin 8) (Magma.srch8R66 v) L')
    (htgt : ∀ u : Magma.tup8R66, ¬ @satisfies _ (Fin 8) (Magma.srch8R66 u) L) :
    ¬ L.StructuralFromFin L' :=
  Law.MagmaLaw.not_structuralFromFin_of_tupOK S8R66.E S8R66.Einv S8R66.X S8R66.Xinv S8R66.rep S8R66.tr
    S8R66.z S8R66.st S8R66.hl S8R66.hr S8R66.hxl S8R66.hxr S8R66.htr S8R66.hz S8R66.hst v.1 v.2 hsrc htgt
