import equational_theories.Definability.Srch_S16R313_data
...
is `decide` on `Fin 16`; the searching is in `Definability/Certs/Srch16R313T*.lean`.
-/
...
theorem not_structuralFromFin_of_srch16R313 {L L' : Law.NatMagmaLaw} (v : Magma.tup16R313)
    (hsrc : @satisfies _ (Fin 16) (Magma.srch16R313 v) L')
    (htgt : ∀ u : Magma.tup16R313, ¬ @satisfies _ (Fin 16) (Magma.srch16R313 u) L) :
    ¬ L.StructuralFromFin L' :=
  Law.MagmaLaw.not_structuralFromFin_of_tupOK S16R313.E S16R313.Einv S16R313.X S16R313.Xinv S16R313.rep S16R313.tr
    S16R313.z S16R313.st S16R313.hl S16R313.hr S16R313.hxl S16R313.hxr S16R313.htr S16R313.hz S16R313.hst v.1 v.2 hsrc htgt
