...
run_elab do
  let names : List Lean.Name := [
    ``GuardAut2_ppyxx_pyx_pxy_x_pxy_x_pxy_Equation1,
    ``GuardAut2_ppyxy_ppyyy_x_y_pxy_x_pxy_Equation1,
    ``GuardAut2_ppyxy_pyx_pyx_y_pyx_y_pyx_Equation1,
    ``GuardAut2_ppyxy_x_x_y_pxy_pxx_pxy_Equation1,
    ``GuardAut2_ppyypyy_x_pxy_y_pxy_y_pxy_Equation1,
    ``GuardAut2_ppyyy_y_pxy_x_pxy_x_pxy_Equation1]
