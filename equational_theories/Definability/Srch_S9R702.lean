import equational_theories.Definability.Srch_S9R702_data
...
is `decide` on `Fin 9`; the searching is in `Definability/Certs/Srch9R702T*.lean`.
-/
...
theorem not_structuralFromFin_of_srch9R702 {L L' : Law.NatMagmaLaw} (v : Magma.tup9R702)
    (hsrc : @satisfies _ (Fin 9) (Magma.srch9R702 v) L')
    (htgt : ∀ u : Magma.tup9R702, ¬ @satisfies _ (Fin 9) (Magma.srch9R702 u) L) :
    ¬ L.StructuralFromFin L' :=
  Law.MagmaLaw.not_structuralFromFin_of_tupOK S9R702.E S9R702.Einv S9R702.X S9R702.Xinv S9R702.rep S9R702.tr
    S9R702.z S9R702.st S9R702.hl S9R702.hr S9R702.hxl S9R702.hxr S9R702.htr S9R702.hz S9R702.hst v.1 v.2 hsrc htgt
