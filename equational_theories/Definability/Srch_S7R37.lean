import equational_theories.Definability.Srch_S7R37_data
...
is `decide` on `Fin 7`; the searching is in `Definability/Certs/Srch7R37T*.lean`.
-/
...
theorem not_structuralFromFin_of_srch7R37 {L L' : Law.NatMagmaLaw} (v : Magma.tup7R37)
    (hsrc : @satisfies _ (Fin 7) (Magma.srch7R37 v) L')
    (htgt : ∀ u : Magma.tup7R37, ¬ @satisfies _ (Fin 7) (Magma.srch7R37 u) L) :
    ¬ L.StructuralFromFin L' :=
  Law.MagmaLaw.not_structuralFromFin_of_tupOK S7R37.E S7R37.Einv S7R37.X S7R37.Xinv S7R37.rep S7R37.tr
    S7R37.z S7R37.st S7R37.hl S7R37.hr S7R37.hxl S7R37.hxr S7R37.htr S7R37.hz S7R37.hst v.1 v.2 hsrc htgt
