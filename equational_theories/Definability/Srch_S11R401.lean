import equational_theories.Definability.Srch_S11R401_data
...
is `decide` on `Fin 11`; the searching is in `Definability/Certs/Srch11R401T*.lean`.
-/
...
theorem not_structuralFromFin_of_srch11R401 {L L' : Law.NatMagmaLaw} (v : Magma.tup11R401)
    (hsrc : @satisfies _ (Fin 11) (Magma.srch11R401 v) L')
    (htgt : ∀ u : Magma.tup11R401, ¬ @satisfies _ (Fin 11) (Magma.srch11R401 u) L) :
    ¬ L.StructuralFromFin L' :=
  Law.MagmaLaw.not_structuralFromFin_of_tupOK S11R401.E S11R401.Einv S11R401.X S11R401.Xinv S11R401.rep S11R401.tr
    S11R401.z S11R401.st S11R401.hl S11R401.hr S11R401.hxl S11R401.hxr S11R401.htr S11R401.hz S11R401.hst v.1 v.2 hsrc htgt
