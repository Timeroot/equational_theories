import equational_theories.Definability.Srch_SR30_data
...
is `decide` on `Fin 6`; the searching is in `Definability/Certs/SrchR30T*.lean`.
-/
...
theorem not_structuralFromFin_of_srchR30 {L L' : Law.NatMagmaLaw} (v : Magma.tupR30)
    (hsrc : @satisfies _ (Fin 6) (Magma.srchR30 v) L')
    (htgt : ∀ u : Magma.tupR30, ¬ @satisfies _ (Fin 6) (Magma.srchR30 u) L) :
    ¬ L.StructuralFromFin L' :=
  Law.MagmaLaw.not_structuralFromFin_of_tupOK SR30.E SR30.Einv SR30.X SR30.Xinv SR30.rep SR30.tr
    SR30.z SR30.st SR30.hl SR30.hr SR30.hxl SR30.hxr SR30.htr SR30.hz SR30.hst v.1 v.2 hsrc htgt
