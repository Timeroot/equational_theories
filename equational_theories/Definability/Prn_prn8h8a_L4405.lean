...
def envprn8h8a_Law4405 : List (Array Nat) := [#[0, 0], #[0, 1], #[0, 2], #[0, 4], #[0, 5], #[0, 6], #[4, 0], #[4, 1], #[4, 2], #[4, 4], #[4, 5], #[4, 6]]
...
node. -/
def ordprn8h8a_Law4405 : List (Fin 12) := List.finRange 12

/-- No prn8h8a-invariant operation on `Fin 8` satisfies equation 4405: the pruned
search over the invariant family closes without ever reaching a model. -/
theorem noprn8h8a_Law4405 :
    DefSearch.go 8 (Magma.toTm Law4405.lhs) (Magma.toTm Law4405.rhs)
      ordprn8h8a_Law4405.length
      (Magma.levels prn8h8a.E prn8h8a.z prn8h8a.st prn8h8a.tr ordprn8h8a_Law4405)
      (Array.replicate (8 * 8) 8) envprn8h8a_Law4405 = true := by
  native_decide
