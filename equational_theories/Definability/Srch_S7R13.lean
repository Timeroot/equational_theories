import equational_theories.Definability.Srch_S7R13_data
...
is `decide` on `Fin 7`; the searching is in `Definability/Certs/Srch7R13T*.lean`.
-/
...
theorem not_structuralFromFin_of_srch7R13 {L L' : Law.NatMagmaLaw} (v : Magma.tup7R13)
    (hsrc : @satisfies _ (Fin 7) (Magma.srch7R13 v) L')
    (htgt : ∀ u : Magma.tup7R13, ¬ @satisfies _ (Fin 7) (Magma.srch7R13 u) L) :
    ¬ L.StructuralFromFin L' :=
  Law.MagmaLaw.not_structuralFromFin_of_tupOK S7R13.E S7R13.Einv S7R13.X S7R13.Xinv S7R13.rep S7R13.tr
    S7R13.z S7R13.st S7R13.hl S7R13.hr S7R13.hxl S7R13.hxr S7R13.htr S7R13.hz S7R13.hst v.1 v.2 hsrc htgt
