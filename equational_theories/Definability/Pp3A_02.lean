...
theorem GuardAut2_x_y_pxx_pyy_pxx_pyy_pyx_Equation1473 :
    AutBox.GuardAut2 (Lf 0) (Lf 1) ((Lf 0) ⋆ (Lf 0)) ((Lf 1) ⋆ (Lf 1)) ((Lf 0) ⋆ (Lf 0)) ((Lf 1) ⋆ (Lf 1)) ((Lf 1) ⋆ (Lf 0)) Law1473 := by
  classical
  ...
  have eq1450 : ∀ X0 : G, (τ X0) = (M.op (τ (M.op X0 X0)) (τ (M.op (M.op X0 X0) (M.op X0 X0)))) := by
    ...
    | grind (splits := 40) (ematch := 20)
  clear eq176 eq298
  have eq3125 : ∀ X0 X1 X2 X3 : G, (σ (M.op X2 X2)) = (M.op (σ (M.op (M.op X2 X2) (M.op X2 X2))) (M.op X3 (M.op X0 (M.op X1 (σ X2))))) := by
    intro X0 X1 X2 X3
    first
    ...
    | grind (splits := 40) (ematch := 20)
  clear eq133
  have eq3155 : ∀ X2 : G, (σ (M.op X2 X2)) = (M.op (σ (M.op (M.op X2 X2) (M.op X2 X2))) (σ X2)) := by
    intro X2
    first
    | (have i₁ := eq3125 x x X2 x
       have i₂ := eq463 (σ X2) (σ (M.op (M.op X2 X2) (M.op X2 X2))) x x x
       grind)
    | exact superpose eq463 eq3125
    | exact resolve eq3125 eq463
    | grind
    | grind (splits := 40)
    | grind (splits := 40) (ematch := 20)
  clear eq463 eq3125
  have eq8380 : ∀ X0 X1 : G, (σ X0) = (M.op (σ (M.op X0 X0)) (M.op X1 (σ (M.op X0 X0)))) := by
    intro X0 X1
    first
    | (have i₁ := eq68 X0 X1 (σ (M.op (M.op X0 X0) (M.op X0 X0)))
       have i₂ := eq3155 X0
       grind)
    | exact superpose eq3155 eq68
    | exact resolve eq68 eq3155
    | grind
    | grind (splits := 40)
    | grind (splits := 40) (ematch := 20)
  clear eq68
  have eq11242 : (σ (M.op x x)) ≠ (M.op (σ x) (σ x)) ∨ (σ x) = (σ y) ∨ (M.op y y) = (M.op x x) ∨ (σ (M.op y y)) = (σ (M.op x x)) := by
    first
    | (have i₁ := eq16
       have i₂ := eq1075
       grind)
    ...
    | grind (splits := 40) (ematch := 20)
  clear eq1075
  have eq11243 : (M.op y y) = (M.op x x) ∨ (σ x) = (σ y) ∨ (σ (M.op y y)) = (σ (M.op x x)) := by
    first
    | (have r₁ := eq11242
       have r₂ := eq22 x
       grind)
    | exact resolve eq11242 eq22
    | grind
    | grind (splits := 40)
    | grind (splits := 40) (ematch := 20)
  clear eq11242
  have eq33827 : ∀ X0 X1 : G, (σ (σ X0)) = (M.op (σ (σ (M.op X0 X0))) (M.op X1 (σ (M.op (σ X0) (σ X0))))) := by
    intro X0 X1
    first
    | (have i₁ := eq1304 X0 X1 (σ (M.op (M.op (σ X0) (σ X0)) (M.op (σ X0) (σ X0))))
       have i₂ := eq3155 (σ X0)
       grind)
    | exact superpose eq3155 eq1304
    | exact resolve eq1304 eq3155
    | grind
    | grind (splits := 40)
    | grind (splits := 40) (ematch := 20)
  clear eq1304 eq3155
  have eq33967 : ∀ X0 X1 : G, (σ (σ X0)) = (M.op (σ (σ (M.op X0 X0))) (M.op X1 (σ (σ (M.op X0 X0))))) := by
    intro X0 X1
    first
    | (have i₁ := eq33827 X0 X1
       have i₂ := eq22 X0
       grind)
    | exact superpose eq22 eq33827
    | exact resolve eq33827 eq22
    | grind
    | grind (splits := 40)
    | grind (splits := 40) (ematch := 20)
  clear eq33827
  have eq232799 : ∀ X0 X1 : G, (σ (σ (M.op (τ X0) (τ (M.op X0 X0))))) = (M.op (σ (σ (τ X0))) (M.op X1 (σ (σ (τ X0))))) := by
    intro X0 X1
    first
    | (have i₁ := eq33967 (M.op (τ X0) (τ (M.op X0 X0))) X1
       have i₂ := eq177 X0 (τ (M.op X0 X0)) (τ X0)
       grind)
    | exact superpose eq177 eq33967
    | exact resolve eq33967 eq177
    | grind
    | grind (splits := 40)
    | grind (splits := 40) (ematch := 20)
  clear eq177 eq33967
  have eq233207 : ∀ X0 X1 : G, (M.op (σ X0) (M.op X1 (σ X0))) = (σ (σ (M.op (τ X0) (τ (M.op X0 X0))))) := by
    intro X0 X1
    first
    | (have i₁ := eq232799 X0 X1
       have i₂ := eq11 X0
       grind)
    | exact superpose eq11 eq232799
    | exact resolve eq232799 eq11
    | grind
    | grind (splits := 40)
    | grind (splits := 40) (ematch := 20)
  clear eq232799
  have eq265877 : ∀ X0 X1 : G, (σ (M.op (τ X0) (τ (M.op X0 X0)))) = (τ (M.op (σ X0) (M.op X1 (σ X0)))) := by
    intro X0 X1
    first
    | (have i₁ := eq10 (σ (M.op (τ X0) (τ (M.op X0 X0))))
       have i₂ := eq233207 X0 X1
       grind)
    | exact superpose eq233207 eq10
    | exact resolve eq10 eq233207
    | grind
    | grind (splits := 40)
    | grind (splits := 40) (ematch := 20)
  clear eq233207
  have eq704294 : ∀ X0 : G, (σ y) = (M.op (σ (M.op x x)) (M.op X0 (σ (M.op x x)))) ∨ (σ x) = (σ y) ∨ (σ (M.op y y)) = (σ (M.op x x)) := by
    intro X0
    first
    | (have i₁ := eq8380 y x
       have i₂ := eq11243
       grind)
    | exact superpose eq11243 eq8380
    | exact resolve eq8380 eq11243
    | grind
    | grind (splits := 40)
    | grind (splits := 40) (ematch := 20)
  clear eq11243
  have eq704518 : (σ x) = (σ y) ∨ (σ x) = (σ y) ∨ (σ (M.op y y)) = (σ (M.op x x)) := by
    first
    | (have i₁ := eq704294 x
       have i₂ := eq8380 x x
       grind)
    | exact superpose eq8380 eq704294
    | exact resolve eq704294 eq8380
    | grind
    | grind (splits := 40)
    | grind (splits := 40) (ematch := 20)
  clear eq704294
  have eq704519 : (σ x) = (σ y) ∨ (σ (M.op y y)) = (σ (M.op x x)) := by grind
  clear eq704518
  have eq704535 : (σ (M.op y y)) = (M.op (σ x) (σ x)) ∨ (σ (M.op y y)) = (σ (M.op x x)) := by
    first
    | (have i₁ := eq22 y
       have i₂ := eq704519
       grind)
    | exact superpose eq704519 eq22
    | exact resolve eq22 eq704519
    | grind
    | grind (splits := 40)
    | grind (splits := 40) (ematch := 20)
  clear eq704519
  have eq705251 : (σ (M.op y y)) = (σ (M.op x x)) ∨ (σ (M.op y y)) = (σ (M.op x x)) := by
    first
    | (have i₁ := eq704535
       have i₂ := eq22 x
       grind)
    | exact superpose eq22 eq704535
    | exact resolve eq704535 eq22
    | grind
    | grind (splits := 40)
    | grind (splits := 40) (ematch := 20)
  clear eq704535
  have eq705252 : (σ (M.op y y)) = (σ (M.op x x)) := by grind
  clear eq705251
  have eq706051 : ∀ X0 : G, (σ (M.op (τ (M.op y y)) (τ (M.op (M.op y y) (M.op y y))))) = (τ (M.op (σ (M.op x x)) (M.op X0 (σ (M.op x x))))) := by
    intro X0
    first
    | (have i₁ := eq265877 (M.op y y) x
       have i₂ := eq705252
       grind)
    | exact superpose eq705252 eq265877
    | exact resolve eq265877 eq705252
    | grind
    | grind (splits := 40)
    | grind (splits := 40) (ematch := 20)
  clear eq265877 eq705252
  have eq706080 : (τ (σ x)) = (σ (M.op (τ (M.op y y)) (τ (M.op (M.op y y) (M.op y y))))) := by
    first
    | (have i₁ := eq706051 x
       have i₂ := eq8380 x x
       grind)
    | exact superpose eq8380 eq706051
    | exact resolve eq706051 eq8380
    | grind
    | grind (splits := 40)
    | grind (splits := 40) (ematch := 20)
  clear eq8380 eq706051
  have eq706224 : (σ (τ y)) = (τ (σ x)) := by
    first
    | (have i₁ := eq706080
       have i₂ := eq1450 y
       grind)
    | exact superpose eq1450 eq706080
    | exact resolve eq706080 eq1450
    | grind
    | grind (splits := 40)
    | grind (splits := 40) (ematch := 20)
  clear eq1450 eq706080
  have eq706272 : x = (σ (τ y)) := by
    first
    | (have i₁ := eq706224
       have i₂ := eq10 x
       grind)
    | exact superpose eq10 eq706224
    | exact resolve eq706224 eq10
    | grind
    | grind (splits := 40)
    | grind (splits := 40) (ematch := 20)
  clear eq706224
  have eq706294 : x = y := by
    first
    | (have i₁ := eq706272
       have i₂ := eq11 y
       grind)
    | exact superpose eq11 eq706272
    | exact resolve eq706272 eq11
    | grind
    | grind (splits := 40)
    | grind (splits := 40) (ematch := 20)
  clear eq706272
  have eq706296 : (σ (M.op x x)) ≠ (M.op (σ x) (σ x)) := by
    first
    | (have i₁ := eq16
       have i₂ := eq706294
       grind)
    | exact superpose eq706294 eq16
    | exact resolve eq16 eq706294
    | grind
    | grind (splits := 40)
    | grind (splits := 40) (ematch := 20)
  clear eq706294
  have eq706297 : False := by grind
  exact eq706297
...
The obligation names no target, so any law the companion satisfies is one more cell for free. -/
theorem GuardAut2_pyx_y_pxx_pyx_pyx_pxx_pyx_Equation1483 :
    AutBox.GuardAut2 ((Lf 1) ⋆ (Lf 0)) (Lf 1) ((Lf 0) ⋆ (Lf 0)) ((Lf 1) ⋆ (Lf 0)) ((Lf 1) ⋆ (Lf 0)) ((Lf 0) ⋆ (Lf 0)) ((Lf 1) ⋆ (Lf 0)) Law1483 := by
  classical
  ...
  have eq144 : ∀ X0 X1 : G, (M.op X1 X0) ≠ (M.op X0 X0) ∨ (M.op X1 X0) = (k X0 X1) := by
    ...
    | grind (splits := 40) (ematch := 20)
  clear eq57
  have eq148 : ∀ X0 X1 : G, (M.op X1 X0) = (k X0 X1) := by
    intro X0 X1
    first
    | (have j0 := eq144 X0 X1
       have j1 := eq59 X1 X0
    ...
    | (have r₁ := eq144 X0 X0
       have r₂ := eq59 X0 X0
       grind)
    | exact resolve eq144 eq59
    | grind
    | grind (splits := 40)
    | grind (splits := 40) (ematch := 20)
  clear eq59 eq144
  have eq315 : ∀ X0 X1 : G, (M.op (σ X0) (σ X1)) = (σ (k X1 X0)) := by
    intro X0 X1
    first
    | (have i₁ := eq15 X1 X0
       have i₂ := eq148 (σ X1) (σ X0)
       grind)
    ...
    | grind (splits := 40)
    | grind (splits := 40) (ematch := 20)
  have eq322 : ∀ X0 X1 : G, (M.op (σ X0) (σ X1)) = (σ (M.op X0 X1)) := by
    intro X0 X1
    first
    | (have i₁ := eq315 X0 X1
       have i₂ := eq148 X1 X0
       grind)
    | exact superpose eq148 eq315
    | exact resolve eq315 eq148
    | grind
    | grind (splits := 40)
    | grind (splits := 40) (ematch := 20)
  clear eq148 eq315
  have eq324 : False := by grind
  exact eq324
...
The obligation names no target, so any law the companion satisfies is one more cell for free. -/
theorem GuardAut2_pyx_y_pyx_pyy_pyx_pyy_pyx_Equation1483 :
    AutBox.GuardAut2 ((Lf 1) ⋆ (Lf 0)) (Lf 1) ((Lf 1) ⋆ (Lf 0)) ((Lf 1) ⋆ (Lf 1)) ((Lf 1) ⋆ (Lf 0)) ((Lf 1) ⋆ (Lf 1)) ((Lf 1) ⋆ (Lf 0)) Law1483 := by
  classical
  ...
  have eq48 : ∀ X0 X1 : G, (M.op X0 X1) = (k X0 X0) ∨ (M.op X0 X1) = (k X1 X0) := by
    ...
    | grind (splits := 40) (ematch := 20)
  clear eq42
  have eq52 : ∀ X0 X1 : G, (M.op X0 X0) = X0 ∨ (M.op X0 X0) = (k X1 X0) ∨ (M.op X0 X1) = (k X1 X0) := by
    intro X0 X1
    first
    | (have j0 := eq43 X0 X1
       have j1 := eq12 X1 X0
  ...
  have eq55 : ∀ X0 X1 : G, (M.op X0 X0) = (k X1 X0) ∨ (M.op X0 X1) = (k X1 X0) := by
    ...
    | (have r₁ := eq52 X0 X1
       have r₂ := eq44 X0 X1
       grind)
    | exact resolve eq52 eq44
    | grind
    | grind (splits := 40)
    | grind (splits := 40) (ematch := 20)
  clear eq44 eq52
  have eq177 : ∀ X0 X1 : G, (M.op X1 X0) ≠ (M.op X1 X1) ∨ (M.op X1 X0) = (k X0 X1) := by
    intro X0 X1
    first
    | (have j0 := eq55 X1 X0
       grind)
    ...
    | grind (splits := 40) (ematch := 20)
  clear eq55
  have eq182 : ∀ X0 X1 : G, (M.op X1 X0) = (k X0 X1) := by
    intro X0 X1
    first
    | (have j0 := eq177 X0 X1
       have j1 := eq54 X1 X0
  ...
  have eq238 : ∀ X0 X1 : G, (M.op (σ X0) (σ X1)) = (σ (M.op X0 X1)) := by
    ...
    | (have i₁ := eq233 X0 X1
       have i₂ := eq182 X1 X0
       grind)
    | exact superpose eq182 eq233
    | exact resolve eq233 eq182
    | grind
    | grind (splits := 40)
    | grind (splits := 40) (ematch := 20)
  clear eq182 eq233
...
The obligation names no target, so any law the companion satisfies is one more cell for free. -/
theorem GuardAut2_pyx_y_pxx_pxy_pxy_pxx_pxy_Equation1485 :
    AutBox.GuardAut2 ((Lf 1) ⋆ (Lf 0)) (Lf 1) ((Lf 0) ⋆ (Lf 0)) ((Lf 0) ⋆ (Lf 1)) ((Lf 0) ⋆ (Lf 1)) ((Lf 0) ⋆ (Lf 0)) ((Lf 0) ⋆ (Lf 1)) Law1485 := by
  classical
  ...
  have eq47 : ∀ X0 X1 : G, (M.op X0 X1) ≠ X0 ∨ (M.op X0 X1) = (k X0 X0) ∨ (k X0 X1) = (M.op X0 X1) := by
    ...
    | grind (splits := 40) (ematch := 20)
  clear eq35
  have eq48 : ∀ X0 X1 : G, (M.op X0 X1) = X0 ∨ (M.op X0 X1) = (k X0 X0) ∨ (k X0 X1) = (M.op X0 X1) := by
    intro X0 X1
    first
    | (have j0 := eq40 X0 X1
       have j1 := eq12 X0 X1
  ...
  have eq53 : ∀ X0 X1 : G, (k X0 X1) = (M.op X0 X0) ∨ (k X0 X1) = (M.op X0 X1) := by
    ...
    | grind (splits := 40) (ematch := 20)
  clear eq42
  have eq55 : ∀ X0 X1 : G, (M.op X0 X1) = (M.op X0 X0) ∨ (M.op X0 X1) ≠ X0 ∨ (k X0 X1) = (M.op X0 X1) := by
    intro X0 X1
    first
    | (have i₁ := eq47 X0 X1
       have i₂ := eq25 X0
    ...
    | grind (splits := 40) (ematch := 20)
  clear eq47
  have eq56 : ∀ X0 X1 : G, (M.op X0 X1) = (M.op X0 X0) ∨ (M.op X0 X1) = X0 ∨ (k X0 X1) = (M.op X0 X1) := by
    intro X0 X1
    first
    | (have i₁ := eq48 X0 X1
       have i₂ := eq25 X0
    ...
    | grind (splits := 40) (ematch := 20)
  clear eq25 eq48
  have eq58 : ∀ X0 X1 : G, (M.op X0 X1) = (M.op X0 X0) ∨ (k X0 X1) = (M.op X0 X1) := by
    intro X0 X1
    first
    | (have j0 := eq56 X0 X1
       have j1 := eq55 X0 X1
    ...
    | grind (splits := 40) (ematch := 20)
  clear eq55 eq56
  have eq148 : ∀ X0 X1 : G, (M.op X0 X1) ≠ (M.op X0 X0) ∨ (k X0 X1) = (M.op X0 X1) := by
    intro X0 X1
    first
    | (have j0 := eq53 X0 X1
       grind)
    ...
    | grind (splits := 40) (ematch := 20)
  clear eq53
  have eq152 : ∀ X0 X1 : G, (k X0 X1) = (M.op X0 X1) := by
    intro X0 X1
    first
    | (have j0 := eq148 X0 X1
       have j1 := eq58 X0 X1
    ...
    | grind (splits := 40) (ematch := 20)
  clear eq58 eq148
  have eq318 : ∀ X0 X1 : G, (σ (k X0 X1)) = (M.op (σ X0) (σ X1)) := by
    intro X0 X1
    first
    | (have i₁ := eq15 X0 X1
...
The obligation names no target, so any law the companion satisfies is one more cell for free. -/
theorem GuardAut2_pyy_x_pyx_pyy_pyx_pyy_pyx_Equation1485 :
    AutBox.GuardAut2 ((Lf 1) ⋆ (Lf 1)) (Lf 0) ((Lf 1) ⋆ (Lf 0)) ((Lf 1) ⋆ (Lf 1)) ((Lf 1) ⋆ (Lf 0)) ((Lf 1) ⋆ (Lf 1)) ((Lf 1) ⋆ (Lf 0)) Law1485 := by
  classical
  ...
  have eq19 : ∀ X0 X1 : G, (σ (k X1 (τ X0))) = (k (σ X1) X0) := by
    ...
    | grind (splits := 40)
    | grind (splits := 40) (ematch := 20)
  have eq85 : ∀ X0 X1 : G, (M.op (σ X0) (σ X0)) = (M.op (σ X0) (σ X1)) ∨ (σ (k X1 X0)) = (M.op (σ X0) (σ X1)) ∨ (σ X1) = (M.op (σ X0) (σ X0)) := by
    intro X0 X1
    first
    | (have i₁ := eq15 X1 X0
    ...
    | grind (splits := 40)
    | grind (splits := 40) (ematch := 20)
  have eq287 : ∀ X0 X1 : G, (M.op (σ X0) (σ X0)) ≠ (M.op (σ X0) (σ X0)) ∨ (k (σ X1) (σ X0)) = (M.op (σ X0) (σ X0)) ∨ (σ X1) = (M.op (σ X0) (σ X0)) ∨ (σ (k X1 X0)) = (M.op (σ X0) (σ X1)) ∨ (σ X1) = (M.op (σ X0) (σ X0)) := by
    intro X0 X1
    first
    ...
    | grind (splits := 40)
    | grind (splits := 40) (ematch := 20)
  have eq299 : ∀ X0 X1 : G, (σ (k X1 X0)) ≠ (M.op (σ X0) (σ X0)) ∨ (σ (k X1 X0)) = (M.op (σ X0) (σ X1)) ∨ (σ X1) = (M.op (σ X0) (σ X0)) := by
    intro X0 X1
    first
    | (have j0 := eq85 X0 X1
       grind)
    ...
    | grind (splits := 40) (ematch := 20)
  clear eq85
  have eq300 : ∀ X0 X1 : G, (M.op (σ X0) (σ X0)) ≠ (M.op (σ X0) (σ X0)) ∨ (k (σ X1) (σ X0)) = (M.op (σ X0) (σ X0)) ∨ (σ X1) = (M.op (σ X0) (σ X0)) ∨ (σ (k X1 X0)) = (M.op (σ X0) (σ X1)) := by
    intro X0 X1
    first
    | (have j0 := eq287 X0 X1
       grind)
    ...
    | grind (splits := 40) (ematch := 20)
  clear eq287
  have eq301 : ∀ X0 X1 : G, (k (σ X1) (σ X0)) = (M.op (σ X0) (σ X0)) ∨ (σ X1) = (M.op (σ X0) (σ X0)) ∨ (σ (k X1 X0)) = (M.op (σ X0) (σ X1)) := by
    intro X0 X1
    first
    | (have j0 := eq300 X0 X1
       grind)
    ...
    | grind (splits := 40) (ematch := 20)
  clear eq300
  have eq303 : ∀ X0 X1 : G, (σ (k X1 X0)) = (M.op (σ X0) (σ X0)) ∨ (σ X1) = (M.op (σ X0) (σ X0)) ∨ (σ (k X1 X0)) = (M.op (σ X0) (σ X1)) := by
    intro X0 X1
    first
    | (have i₁ := eq301 X0 X1
       have i₂ := eq15 X1 X0
    ...
    | grind (splits := 40) (ematch := 20)
  clear eq301
  have eq307 : ∀ X0 X1 : G, (σ (k X1 X0)) = (M.op (σ X0) (σ X1)) ∨ (σ X1) = (M.op (σ X0) (σ X0)) := by
    intro X0 X1
    first
    | (have j0 := eq303 X0 X1
       have j1 := eq299 X0 X1
    ...
    | (have r₁ := eq303 X0 X1
       have r₂ := eq299 X0 X1
       grind)
    | (have r₁ := eq303 X0 (k X1 X0)
       have r₂ := eq299 X0 X1
       grind)
    | (have r₁ := eq303 X0 X0
       have r₂ := eq299 X0 X0
       grind)
    | exact resolve eq303 eq299
    | grind
    | grind (splits := 40)
    | grind (splits := 40) (ematch := 20)
  clear eq299 eq303
  have eq958 : ∀ X0 X1 : G, (σ (k X1 (τ X0))) = (M.op X0 (σ X1)) ∨ (σ X1) = (M.op X0 X0) := by
    intro X0 X1
    first
    ...
    | grind (splits := 40)
    | grind (splits := 40) (ematch := 20)
  have eq972 : (σ (M.op x y)) ≠ (σ (k y x)) ∨ (σ y) = (M.op (σ x) (σ x)) := by
    first
    | (have i₁ := eq16
       have i₂ := eq307 x y
       grind)
    ...
    | grind (splits := 40) (ematch := 20)
  clear eq307
  have eq1004 : ∀ X0 X1 : G, (k (σ X1) X0) = (M.op X0 (σ X1)) ∨ (σ X1) = (M.op X0 X0) := by
    intro X0 X1
    first
    | (have i₁ := eq958 X0 X1
       have i₂ := eq19 X0 X1
       grind)
    | exact superpose eq19 eq958
    | (have j0 := eq958 X0 X1
       grind)
    | exact resolve eq958 eq19
    | grind
    | grind (splits := 40)
    | grind (splits := 40) (ematch := 20)
  clear eq19 eq958
  have eq1005 : ∀ X0 X1 : G, (M.op X1 X0) = (k X0 X1) ∨ (M.op X1 X1) = X0 := by
    intro X0 X1
    first
    | (have i₁ := eq1004 X0 (τ X0)
       have i₂ := eq11 X0
       grind)
    ...
    | grind (splits := 40) (ematch := 20)
  clear eq1004
  have eq1064 : ∀ X0 X1 : G, (k X1 (σ X0)) = (σ (M.op X0 (τ X1))) ∨ (M.op X0 X0) = (τ X1) := by
    intro X0 X1
    first
    | (have i₁ := eq18 X1 X0
       have i₂ := eq1005 (τ X1) X0
       grind)
    | exact superpose eq1005 eq18
    | (have j1 := eq1005 (τ X1) X0
       grind)
    | exact resolve eq18 eq1005
    | grind
    | grind (splits := 40)
    | grind (splits := 40) (ematch := 20)
  clear eq18 eq1005
  have eq1889 : ∀ X0 X1 : G, (k (σ X0) (σ X1)) = (σ (M.op X1 X0)) ∨ (M.op X1 X1) = X0 := by
    intro X0 X1
    first
    | (have i₁ := eq1064 X0 (σ X0)
       have i₂ := eq10 X0
       grind)
    ...
    | grind (splits := 40) (ematch := 20)
  clear eq1064
  have eq1939 : ∀ X0 X1 : G, (σ (k X0 X1)) = (σ (M.op X1 X0)) ∨ (M.op X1 X1) = X0 := by
    intro X0 X1
    first
    | (have i₁ := eq1889 X0 X1
       have i₂ := eq15 X0 X1
       grind)
    | exact superpose eq15 eq1889
    | (have j0 := eq1889 X0 X1
       grind)
    | exact resolve eq1889 eq15
    | grind
    | grind (splits := 40)
    | grind (splits := 40) (ematch := 20)
  clear eq1889
  have eq2601 : (σ (M.op x y)) ≠ (σ (M.op x y)) ∨ (σ y) = (M.op (σ x) (σ x)) ∨ y = (M.op x x) := by
    first
    | (have i₁ := eq972
       have i₂ := eq1939 y x
       grind)
    | exact superpose eq1939 eq972
    | (have j1 := eq1939 (σ y) (σ x)
       grind)
    | (have r₁ := eq972
       have r₂ := eq1939 y x
       grind)
    | exact resolve eq972 eq1939
    | grind
    | grind (splits := 40)
    | grind (splits := 40) (ematch := 20)
  have eq2602 : y = (M.op x x) ∨ (σ y) = (M.op (σ x) (σ x)) := by grind
  clear eq2601
  have eq2606 : (M.op x y) = (k y x) ∨ (σ y) = (M.op (σ x) (σ x)) := by grind
  clear eq2602
  have eq2848 : (σ (M.op x y)) ≠ (σ (M.op x y)) ∨ (σ y) = (M.op (σ x) (σ x)) ∨ (σ y) = (M.op (σ x) (σ x)) := by
    first
    | (have i₁ := eq972
       have i₂ := eq2606
       grind)
    | exact superpose eq2606 eq972
    | exact resolve eq972 eq2606
    | grind
    | grind (splits := 40)
    | grind (splits := 40) (ematch := 20)
  clear eq972 eq2606
  have eq2849 : (σ (M.op x y)) ≠ (σ (M.op x y)) ∨ (σ y) = (M.op (σ x) (σ x)) := by grind
  clear eq2848
  have eq2850 : (σ y) = (M.op (σ x) (σ x)) := by grind
  clear eq2849
  have eq2859 : (M.op (σ x) (σ y)) = (k (σ y) (σ x)) := by grind
  clear eq2850
  have eq2906 : (M.op (σ x) (σ y)) = (σ (k y x)) := by
    first
    | (have i₁ := eq2859
       have i₂ := eq15 y x
       grind)
    ...
    | grind (splits := 40) (ematch := 20)
  clear eq2859
  have eq2960 : (σ (M.op x y)) ≠ (σ (k y x)) := by
    first
    | (have i₁ := eq16
       have i₂ := eq2906
       grind)
    | exact superpose eq2906 eq16
    | exact resolve eq16 eq2906
    | grind
    | grind (splits := 40)
    | grind (splits := 40) (ematch := 20)
  clear eq2906
  have eq3009 : (σ (M.op x y)) ≠ (σ (M.op x y)) ∨ y = (M.op x x) := by
    first
    | (have i₁ := eq2960
       have i₂ := eq1939 y x
       grind)
    | exact superpose eq1939 eq2960
    | (have j1 := eq1939 y x
       grind)
    | (have r₁ := eq2960
       have r₂ := eq1939 y x
       grind)
    | exact resolve eq2960 eq1939
    | grind
    | grind (splits := 40)
    | grind (splits := 40) (ematch := 20)
  clear eq1939
  have eq3010 : y = (M.op x x) := by grind
  clear eq3009
  have eq3262 : (M.op x y) = (k y x) := by grind
  clear eq3010
  have eq3311 : (σ (M.op x y)) ≠ (σ (M.op x y)) := by
    first
    | (have i₁ := eq2960
       have i₂ := eq3262
       grind)
    | exact superpose eq3262 eq2960
    | exact resolve eq2960 eq3262
    | grind
    | grind (splits := 40)
    | grind (splits := 40) (ematch := 20)
  clear eq2960 eq3262
  have eq3314 : False := by grind
  exact eq3314
...
The obligation names no target, so any law the companion satisfies is one more cell for free. -/
theorem GuardAut2_pyy_x_x_y_pyx_pxx_pyx_Equation1485 :
    AutBox.GuardAut2 ((Lf 1) ⋆ (Lf 1)) (Lf 0) (Lf 0) (Lf 1) ((Lf 1) ⋆ (Lf 0)) ((Lf 0) ⋆ (Lf 0)) ((Lf 1) ⋆ (Lf 0)) Law1485 := by
  classical
  ...
  have eq50 : ∀ X0 : G, (M.op X0 X0) = (k X0 X0) := by
    ...
    | grind (splits := 40) (ematch := 20)
  clear eq49
  have eq63 : ∀ X0 X1 : G, (σ (k X0 X1)) = (M.op (σ X1) (σ X0)) ∨ (σ X0) = (σ X1) ∨ (σ X0) = (M.op (σ X1) (σ X1)) := by
    intro X0 X1
    first
    | (have i₁ := eq14 (σ X0) (σ X1)
       have i₂ := eq15 X0 X1
  ...
  have eq109 : ∀ X0 : G, (M.op (τ X0) (τ X0)) = (τ (M.op X0 X0)) := by
    ...
    | grind (splits := 40) (ematch := 20)
  clear eq97
  have eq201 : ∀ X0 X1 : G, (σ (k X0 X1)) = (M.op (σ X1) (σ X0)) ∨ (σ X0) = (σ (M.op X1 X1)) ∨ (σ X0) = (σ X1) := by
    intro X0 X1
    first
    | (have i₁ := eq63 X0 X1
       have i₂ := eq101 X1
    ...
    | grind (splits := 40) (ematch := 20)
  clear eq63
  have eq230 : (σ (M.op x y)) ≠ (σ (k y x)) ∨ (σ y) = (σ (M.op x x)) ∨ (σ x) = (σ y) := by
    first
    | (have i₁ := eq16
       have i₂ := eq201 y x
       grind)
    ...
    | grind (splits := 40) (ematch := 20)
  clear eq201
  have eq498 : ∀ X0 : G, (k (σ (τ (M.op X0 X0))) X0) = (σ (M.op (τ X0) (τ (M.op X0 X0)))) := by
    intro X0
    first
    | (have i₁ := eq36 X0
       have i₂ := eq109 X0
    ...
    | grind (splits := 40) (ematch := 20)
  clear eq36 eq109
  have eq499 : ∀ X0 : G, (k (M.op X0 X0) X0) = (σ (M.op (τ X0) (τ (M.op X0 X0)))) := by
    intro X0
    first
    | (have i₁ := eq498 X0
    ...
    | grind (splits := 40) (ematch := 20)
  clear eq498
  have eq500 : ∀ X0 : G, (M.op X0 (M.op X0 X0)) = (σ (M.op (τ X0) (τ (M.op X0 X0)))) := by
    intro X0
    grind
  clear eq499
  have eq539 : ∀ X0 : G, (M.op (σ X0) (M.op (σ X0) (σ X0))) = (σ (M.op X0 (τ (M.op (σ X0) (σ X0))))) := by
    intro X0
    first
    | (have i₁ := eq500 (σ X0)
       have i₂ := eq10 X0
    ...
    | grind (splits := 40) (ematch := 20)
  clear eq500
  have eq569 : ∀ X0 : G, (M.op (σ X0) (M.op (σ X0) (σ X0))) = (σ (M.op X0 (M.op X0 X0))) := by
    intro X0
    first
    | (have i₁ := eq539 X0
       have i₂ := eq98 X0
       grind)
    | exact superpose eq98 eq539
    | exact resolve eq539 eq98
    | grind
    | grind (splits := 40)
    | grind (splits := 40) (ematch := 20)
  clear eq98 eq539
  have eq573 : ∀ X0 : G, (M.op (σ X0) (σ (M.op X0 X0))) = (σ (M.op X0 (M.op X0 X0))) := by
    intro X0
    first
    | (have i₁ := eq569 X0
       have i₂ := eq101 X0
       grind)
    | exact superpose eq101 eq569
    | exact resolve eq569 eq101
    | grind
    | grind (splits := 40)
    | grind (splits := 40) (ematch := 20)
  clear eq569
  have eq844 : (σ (M.op x y)) ≠ (σ (M.op x y)) ∨ (σ y) = (σ (M.op x x)) ∨ (σ x) = (σ y) ∨ x = y ∨ y = (M.op x x) := by
    first
    | (have i₁ := eq230
       have i₂ := eq14 y x
       grind)
    ...
    | grind (splits := 40) (ematch := 20)
  clear eq230
  have eq845 : x = y ∨ (σ x) = (σ y) ∨ (σ y) = (σ (M.op x x)) ∨ y = (M.op x x) := by grind
  clear eq844
  have eq11403 : (σ (M.op x x)) ≠ (M.op (σ x) (σ x)) ∨ (σ x) = (σ y) ∨ (σ y) = (σ (M.op x x)) ∨ y = (M.op x x) := by
    first
    | (have i₁ := eq16
       have i₂ := eq845
       grind)
    ...
    | grind (splits := 40) (ematch := 20)
  clear eq845
  have eq11404 : (σ x) = (σ y) ∨ (σ y) = (σ (M.op x x)) ∨ y = (M.op x x) := by
    first
    | (have r₁ := eq11403
       have r₂ := eq101 x
       grind)
    | exact resolve eq11403 eq101
    | grind
    | grind (splits := 40)
    | grind (splits := 40) (ematch := 20)
  clear eq11403
  have eq17959 : y = (τ (σ x)) ∨ (σ y) = (σ (M.op x x)) ∨ y = (M.op x x) := by
    first
    | (have i₁ := eq10 y
       have i₂ := eq11404
       grind)
    | exact superpose eq11404 eq10
    | exact resolve eq10 eq11404
    | grind
    | grind (splits := 40)
    | grind (splits := 40) (ematch := 20)
  clear eq11404
  have eq18040 : x = y ∨ (σ y) = (σ (M.op x x)) ∨ y = (M.op x x) := by
    first
    | (have i₁ := eq17959
       have i₂ := eq10 x
       grind)
    | exact superpose eq10 eq17959
    | exact resolve eq17959 eq10
    | grind
    | grind (splits := 40)
    | grind (splits := 40) (ematch := 20)
  clear eq17959
  have eq18311 : (σ (M.op x x)) ≠ (M.op (σ x) (σ x)) ∨ (σ y) = (σ (M.op x x)) ∨ y = (M.op x x) := by
    first
    | (have i₁ := eq16
       have i₂ := eq18040
       grind)
    | exact superpose eq18040 eq16
    | exact resolve eq16 eq18040
    | grind
    | grind (splits := 40)
    | grind (splits := 40) (ematch := 20)
  clear eq18040
  have eq18312 : (σ y) = (σ (M.op x x)) ∨ y = (M.op x x) := by
    first
    | (have r₁ := eq18311
       have r₂ := eq101 x
       grind)
    | exact resolve eq18311 eq101
    | grind
    | grind (splits := 40)
    | grind (splits := 40) (ematch := 20)
  clear eq101 eq18311
  have eq18601 : (M.op x x) = (τ (σ y)) ∨ y = (M.op x x) := by
    first
    | (have i₁ := eq10 (M.op x x)
       have i₂ := eq18312
       grind)
    | exact superpose eq18312 eq10
    | exact resolve eq10 eq18312
    | grind
    | grind (splits := 40)
    | grind (splits := 40) (ematch := 20)
  clear eq18312
  have eq18684 : y = (M.op x x) ∨ y = (M.op x x) := by
    first
    | (have i₁ := eq18601
       have i₂ := eq10 y
       grind)
    ...
    | grind (splits := 40) (ematch := 20)
  clear eq18601
  have eq18685 : y = (M.op x x) := by grind
  clear eq18684
  have eq18708 : (σ (M.op x y)) = (M.op (σ x) (σ y)) := by
    first
    | (have i₁ := eq573 x
       have i₂ := eq18685
       grind)
    | exact superpose eq18685 eq573
    | exact resolve eq573 eq18685
    | grind
    | grind (splits := 40)
    | grind (splits := 40) (ematch := 20)
  clear eq573 eq18685
  have eq18798 : False := by grind
  exact eq18798
...
The obligation names no target, so any law the companion satisfies is one more cell for free. -/
theorem GuardAut2_pyx_x_pxx_pyx_pyx_pxx_pyx_Equation1486 :
    AutBox.GuardAut2 ((Lf 1) ⋆ (Lf 0)) (Lf 0) ((Lf 0) ⋆ (Lf 0)) ((Lf 1) ⋆ (Lf 0)) ((Lf 1) ⋆ (Lf 0)) ((Lf 0) ⋆ (Lf 0)) ((Lf 1) ⋆ (Lf 0)) Law1486 := by
  classical
  ...
  have eq26 : ∀ X0 : G, (M.op X0 X0) = (k X0 X0) := by
    ...
    | grind (splits := 40) (ematch := 20)
  clear eq25
  have eq32 : ∀ X0 X1 : G, (M.op X0 X0) ≠ (M.op X0 X0) ∨ (M.op X0 X0) = X0 ∨ (k X0 X1) = (M.op X0 X0) ∨ (M.op X1 X0) = (k X0 X1) ∨ (M.op X1 X0) = X0 := by
    intro X0 X1
    first
    | (have i₁ := eq13 X0 X1
       have i₂ := eq14 X0 X1
    ...
    | grind (splits := 40)
    | grind (splits := 40) (ematch := 20)
  have eq37 : ∀ X0 X1 : G, (M.op X0 X1) ≠ (M.op X0 X1) ∨ (M.op X0 X1) = X1 ∨ (M.op X0 X1) = (k X1 X1) ∨ (M.op X0 X1) = (k X1 X0) ∨ (M.op X0 X1) = X1 := by
    intro X0 X1
    first
    | (have i₁ := eq13 X0 X1
       have i₂ := eq14 X0 X1
  ...
  have eq44 : ∀ X0 X1 : G, (M.op X1 X1) ≠ X1 ∨ (M.op X0 X1) = (k X1 X0) ∨ (M.op X0 X1) = X1 := by
    ...
    | grind (splits := 40)
    | grind (splits := 40) (ematch := 20)
  have eq45 : ∀ X0 X1 : G, (M.op X0 X1) ≠ (M.op X0 X1) ∨ (M.op X0 X1) = X1 ∨ (M.op X0 X1) = (k X1 X1) ∨ (M.op X0 X1) = (k X1 X0) := by
    intro X0 X1
    first
    | (have j0 := eq37 X0 X1
       grind)
  ...
  have eq46 : ∀ X0 X1 : G, (M.op X0 X1) = X1 ∨ (M.op X0 X1) = (k X1 X1) ∨ (M.op X0 X1) = (k X1 X0) := by
    ...
    | grind (splits := 40) (ematch := 20)
  clear eq45
  have eq47 : ∀ X0 X1 : G, (M.op X0 X0) = X0 ∨ (k X0 X1) = (M.op X0 X0) ∨ (M.op X1 X0) = (k X0 X1) ∨ (M.op X1 X0) = X0 := by
    intro X0 X1
    first
    | (have j0 := eq32 X0 X1
       grind)
  ...
  have eq48 : ∀ X0 X1 : G, (M.op X1 X1) ≠ X1 ∨ (M.op X0 X1) = (k X1 X0) := by
    ...
    | grind (splits := 40) (ematch := 20)
  clear eq44
  have eq53 : ∀ X0 X1 : G, (M.op X0 X1) = (k X1 X1) ∨ (M.op X0 X1) = (k X1 X0) := by
    intro X0 X1
    first
    | (have j0 := eq46 X0 X1
       have j1 := eq12 X1 X0
    ...
    | grind (splits := 40) (ematch := 20)
  clear eq46
  have eq57 : ∀ X0 X1 : G, (M.op X0 X0) = X0 ∨ (k X0 X1) = (M.op X0 X0) ∨ (M.op X1 X0) = (k X0 X1) := by
    intro X0 X1
    first
    | (have j0 := eq47 X0 X1
       have j1 := eq12 X0 X1
  ...
  have eq61 : ∀ X0 X1 : G, (M.op X0 X1) = (M.op X1 X1) ∨ (M.op X0 X1) = (k X1 X0) := by
    ...
    | grind (splits := 40) (ematch := 20)
  clear eq26 eq53
  have eq63 : ∀ X0 X1 : G, (k X0 X1) = (M.op X0 X0) ∨ (M.op X1 X0) = (k X0 X1) := by
    intro X0 X1
    first
    | (have j0 := eq57 X0 X1
       have j1 := eq48 X1 X0
  ...
  have eq144 : ∀ X0 X1 : G, (M.op X1 X0) ≠ (M.op X0 X0) ∨ (M.op X1 X0) = (k X0 X1) := by
    ...
    | grind (splits := 40) (ematch := 20)
  clear eq63
  have eq149 : ∀ X0 X1 : G, (M.op X1 X0) = (k X0 X1) := by
    intro X0 X1
    first
    | (have j0 := eq144 X0 X1
       have j1 := eq61 X1 X0
    ...
    | grind (splits := 40) (ematch := 20)
  clear eq61 eq144
  have eq240 : ∀ X0 X1 : G, (M.op (σ X0) (σ X1)) = (σ (k X1 X0)) := by
    intro X0 X1
    first
    | (have i₁ := eq15 X1 X0
       have i₂ := eq149 (σ X1) (σ X0)
       grind)
...
The obligation names no target, so any law the companion satisfies is one more cell for free. -/
theorem GuardAut2_pyx_x_pxy_pyy_pxy_pyy_pxy_Equation1486 :
    AutBox.GuardAut2 ((Lf 1) ⋆ (Lf 0)) (Lf 0) ((Lf 0) ⋆ (Lf 1)) ((Lf 1) ⋆ (Lf 1)) ((Lf 0) ⋆ (Lf 1)) ((Lf 1) ⋆ (Lf 1)) ((Lf 0) ⋆ (Lf 1)) Law1486 := by
  classical
  ...
  have eq32 : ∀ X0 X1 : G, (M.op X0 X0) ≠ (M.op X0 X0) ∨ (M.op X0 X1) = X1 ∨ (M.op X0 X0) = (k X1 X0) ∨ (M.op X1 X0) = (k X1 X0) ∨ (M.op X0 X1) = X1 := by
    ...
    | grind (splits := 40)
    | grind (splits := 40) (ematch := 20)
  have eq37 : ∀ X0 X1 : G, (M.op X0 X1) ≠ (M.op X0 X1) ∨ (M.op X0 X1) = X1 ∨ (M.op X0 X1) = (k X1 X1) ∨ (k X0 X1) = (M.op X0 X1) ∨ (M.op X1 X0) = X0 := by
    intro X0 X1
    first
    | (have i₁ := eq13 X0 X1
       have i₂ := eq14 X0 X1
