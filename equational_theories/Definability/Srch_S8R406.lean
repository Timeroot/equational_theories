import equational_theories.Definability.Srch_S8R406_data
...
is `decide` on `Fin 8`; the searching is in `Definability/Certs/Srch8R406T*.lean`.
-/
...
theorem not_structuralFromFin_of_srch8R406 {L L' : Law.NatMagmaLaw} (v : Magma.tup8R406)
    (hsrc : @satisfies _ (Fin 8) (Magma.srch8R406 v) L')
    (htgt : ∀ u : Magma.tup8R406, ¬ @satisfies _ (Fin 8) (Magma.srch8R406 u) L) :
    ¬ L.StructuralFromFin L' :=
  Law.MagmaLaw.not_structuralFromFin_of_tupOK S8R406.E S8R406.Einv S8R406.X S8R406.Xinv S8R406.rep S8R406.tr
    S8R406.z S8R406.st S8R406.hl S8R406.hr S8R406.hxl S8R406.hxr S8R406.htr S8R406.hz S8R406.hst v.1 v.2 hsrc htgt
