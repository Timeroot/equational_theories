import equational_theories.Definability.Srch_S8R36_data
...
is `decide` on `Fin 8`; the searching is in `Definability/Certs/Srch8R36T*.lean`.
-/
...
theorem not_structuralFromFin_of_srch8R36 {L L' : Law.NatMagmaLaw} (v : Magma.tup8R36)
    (hsrc : @satisfies _ (Fin 8) (Magma.srch8R36 v) L')
    (htgt : ∀ u : Magma.tup8R36, ¬ @satisfies _ (Fin 8) (Magma.srch8R36 u) L) :
    ¬ L.StructuralFromFin L' :=
  Law.MagmaLaw.not_structuralFromFin_of_tupOK S8R36.E S8R36.Einv S8R36.X S8R36.Xinv S8R36.rep S8R36.tr
    S8R36.z S8R36.st S8R36.hl S8R36.hr S8R36.hxl S8R36.hxr S8R36.htr S8R36.hz S8R36.hst v.1 v.2 hsrc htgt
