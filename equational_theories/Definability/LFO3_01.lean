...
run_elab do
  let names : List Lean.Name := [
    ``GuardAut2_ppxxx_pyx_pxx_y_pyx_pxx_pyx_Equation1,
    ``GuardAut2_ppxxx_pyy_x_y_pxy_pxx_pxy_Equation1,
    ``GuardAut2_ppxxy_pxy_pxx_x_pyx_pyy_pyx_Equation1,
    ``GuardAut2_ppxxy_pypyy_pxy_y_pxy_y_pxy_Equation1,
    ``GuardAut2_ppxypxx_pyx_x_y_pyx_pxx_pyx_Equation1,
    ``GuardAut2_ppxypxx_y_x_y_pxy_pxx_pxy_Equation1]
