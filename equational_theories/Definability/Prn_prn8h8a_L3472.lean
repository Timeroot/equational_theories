...
search for equation 3472 exactly as hard as all `8^2` of them. -/
def envprn8h8a_Law3472 : List (Array Nat) := [#[0, 0], #[0, 1], #[0, 2], #[0, 4], #[0, 5], #[0, 6], #[4, 0], #[4, 1], #[4, 2], #[4, 4], #[4, 5], #[4, 6]]

/-- The orbits of the prn8h8a family, as the search takes them when refuting equation
3472. This is a set, not an order: the kernel picks which one to branch on at each
node. -/
def ordprn8h8a_Law3472 : List (Fin 12) := List.finRange 12
...
theorem noprn8h8a_Law3472 :
    DefSearch.go 8 (Magma.toTm Law3472.lhs) (Magma.toTm Law3472.rhs)
      ordprn8h8a_Law3472.length
      (Magma.levels prn8h8a.E prn8h8a.z prn8h8a.st prn8h8a.tr ordprn8h8a_Law3472)
      (Array.replicate (8 * 8) 8) envprn8h8a_Law3472 = true := by
  native_decide
