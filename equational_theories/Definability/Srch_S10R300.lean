import equational_theories.Definability.Srch_S10R300_data
...
is `decide` on `Fin 10`; the searching is in `Definability/Certs/Srch10R300T*.lean`.
-/
...
theorem not_structuralFromFin_of_srch10R300 {L L' : Law.NatMagmaLaw} (v : Magma.tup10R300)
    (hsrc : @satisfies _ (Fin 10) (Magma.srch10R300 v) L')
    (htgt : ∀ u : Magma.tup10R300, ¬ @satisfies _ (Fin 10) (Magma.srch10R300 u) L) :
    ¬ L.StructuralFromFin L' :=
  Law.MagmaLaw.not_structuralFromFin_of_tupOK S10R300.E S10R300.Einv S10R300.X S10R300.Xinv S10R300.rep S10R300.tr
    S10R300.z S10R300.st S10R300.hl S10R300.hr S10R300.hxl S10R300.hxr S10R300.htr S10R300.hz S10R300.hst v.1 v.2 hsrc htgt
