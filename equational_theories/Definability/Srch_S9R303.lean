import equational_theories.Definability.Srch_S9R303_data
...
is `decide` on `Fin 9`; the searching is in `Definability/Certs/Srch9R303T*.lean`.
-/
...
theorem not_structuralFromFin_of_srch9R303 {L L' : Law.NatMagmaLaw} (v : Magma.tup9R303)
    (hsrc : @satisfies _ (Fin 9) (Magma.srch9R303 v) L')
    (htgt : ∀ u : Magma.tup9R303, ¬ @satisfies _ (Fin 9) (Magma.srch9R303 u) L) :
    ¬ L.StructuralFromFin L' :=
  Law.MagmaLaw.not_structuralFromFin_of_tupOK S9R303.E S9R303.Einv S9R303.X S9R303.Xinv S9R303.rep S9R303.tr
    S9R303.z S9R303.st S9R303.hl S9R303.hr S9R303.hxl S9R303.hxr S9R303.htr S9R303.hz S9R303.hst v.1 v.2 hsrc htgt
