import equational_theories.Definability.Srch_S8R75_data
...
is `decide` on `Fin 8`; the searching is in `Definability/Certs/Srch8R75T*.lean`.
-/
...
theorem not_structuralFromFin_of_srch8R75 {L L' : Law.NatMagmaLaw} (v : Magma.tup8R75)
    (hsrc : @satisfies _ (Fin 8) (Magma.srch8R75 v) L')
    (htgt : ∀ u : Magma.tup8R75, ¬ @satisfies _ (Fin 8) (Magma.srch8R75 u) L) :
    ¬ L.StructuralFromFin L' :=
  Law.MagmaLaw.not_structuralFromFin_of_tupOK S8R75.E S8R75.Einv S8R75.X S8R75.Xinv S8R75.rep S8R75.tr
    S8R75.z S8R75.st S8R75.hl S8R75.hr S8R75.hxl S8R75.hxr S8R75.htr S8R75.hz S8R75.hst v.1 v.2 hsrc htgt
