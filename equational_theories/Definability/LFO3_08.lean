...
run_elab do
  let names : List Lean.Name := [
    ``GuardAut2_pypxy_y_pyx_x_pyx_x_pyx_Equation1,
    ``GuardAut2_pypyx_pyx_pxy_y_pxy_y_pxy_Equation1,
    ``GuardAut2_pypyx_pyy_pyx_y_pyx_y_pyx_Equation1,
    ``GuardAut2_pypyx_x_pxy_y_pxy_y_pxy_Equation1,
    ``GuardAut2_pypyx_x_pyx_x_pyx_pxy_pyx_Equation1,
    ``GuardAut2_pypyx_y_x_y_pxy_pxx_pxy_Equation1]
