import equational_theories.Definability.Srch_S9R322_data
...
is `decide` on `Fin 9`; the searching is in `Definability/Certs/Srch9R322T*.lean`.
-/
...
theorem not_structuralFromFin_of_srch9R322 {L L' : Law.NatMagmaLaw} (v : Magma.tup9R322)
    (hsrc : @satisfies _ (Fin 9) (Magma.srch9R322 v) L')
    (htgt : ∀ u : Magma.tup9R322, ¬ @satisfies _ (Fin 9) (Magma.srch9R322 u) L) :
    ¬ L.StructuralFromFin L' :=
  Law.MagmaLaw.not_structuralFromFin_of_tupOK S9R322.E S9R322.Einv S9R322.X S9R322.Xinv S9R322.rep S9R322.tr
    S9R322.z S9R322.st S9R322.hl S9R322.hr S9R322.hxl S9R322.hxr S9R322.htr S9R322.hz S9R322.hst v.1 v.2 hsrc htgt
