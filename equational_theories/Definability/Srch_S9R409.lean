import equational_theories.Definability.Srch_S9R409_data
...
is `decide` on `Fin 9`; the searching is in `Definability/Certs/Srch9R409T*.lean`.
-/
...
theorem not_structuralFromFin_of_srch9R409 {L L' : Law.NatMagmaLaw} (v : Magma.tup9R409)
    (hsrc : @satisfies _ (Fin 9) (Magma.srch9R409 v) L')
    (htgt : ∀ u : Magma.tup9R409, ¬ @satisfies _ (Fin 9) (Magma.srch9R409 u) L) :
    ¬ L.StructuralFromFin L' :=
  Law.MagmaLaw.not_structuralFromFin_of_tupOK S9R409.E S9R409.Einv S9R409.X S9R409.Xinv S9R409.rep S9R409.tr
    S9R409.z S9R409.st S9R409.hl S9R409.hr S9R409.hxl S9R409.hxr S9R409.htr S9R409.hz S9R409.hst v.1 v.2 hsrc htgt
