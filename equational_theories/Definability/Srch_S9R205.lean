import equational_theories.Definability.Srch_S9R205_data
...
is `decide` on `Fin 9`; the searching is in `Definability/Certs/Srch9R205T*.lean`.
-/
...
theorem not_structuralFromFin_of_srch9R205 {L L' : Law.NatMagmaLaw} (v : Magma.tup9R205)
    (hsrc : @satisfies _ (Fin 9) (Magma.srch9R205 v) L')
    (htgt : ∀ u : Magma.tup9R205, ¬ @satisfies _ (Fin 9) (Magma.srch9R205 u) L) :
    ¬ L.StructuralFromFin L' :=
  Law.MagmaLaw.not_structuralFromFin_of_tupOK S9R205.E S9R205.Einv S9R205.X S9R205.Xinv S9R205.rep S9R205.tr
    S9R205.z S9R205.st S9R205.hl S9R205.hr S9R205.hxl S9R205.hxr S9R205.htr S9R205.hz S9R205.hst v.1 v.2 hsrc htgt
