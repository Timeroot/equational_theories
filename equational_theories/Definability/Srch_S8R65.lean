import equational_theories.Definability.Srch_S8R65_data
...
is `decide` on `Fin 8`; the searching is in `Definability/Certs/Srch8R65T*.lean`.
-/
...
theorem not_structuralFromFin_of_srch8R65 {L L' : Law.NatMagmaLaw} (v : Magma.tup8R65)
    (hsrc : @satisfies _ (Fin 8) (Magma.srch8R65 v) L')
    (htgt : ∀ u : Magma.tup8R65, ¬ @satisfies _ (Fin 8) (Magma.srch8R65 u) L) :
    ¬ L.StructuralFromFin L' :=
  Law.MagmaLaw.not_structuralFromFin_of_tupOK S8R65.E S8R65.Einv S8R65.X S8R65.Xinv S8R65.rep S8R65.tr
    S8R65.z S8R65.st S8R65.hl S8R65.hr S8R65.hxl S8R65.hxr S8R65.htr S8R65.hz S8R65.hst v.1 v.2 hsrc htgt
