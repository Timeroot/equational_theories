...
/-- A model of equation 4415 on `Fin 8` invariant under prn8h8b. -/
def prn8h8bMd4415 : Array (Array Nat) := #[#[1, 1, 5, 0, 5, 1, 7, 1], #[1, 2, 2, 6, 2, 6, 2, 4], #[7, 2, 3, 3, 5, 3, 7, 3], #[0, 4, 3, 0, 0, 6, 0, 4], #[5, 2, 5, 0, 5, 5, 2, 4], #[1, 6, 3, 6, 5, 6, 6, 3], #[7, 2, 7, 0, 0, 6, 7, 7], #[1, 4, 3, 4, 4, 1, 7, 4]]

@[reducible]
def prn8h8bM4415 : Magma (Fin 8) := Magma.mk fun x y ↦ ⟨(prn8h8bMd4415[x.1]!)[y.1]! % 8, Nat.mod_lt _ (by decide)⟩
