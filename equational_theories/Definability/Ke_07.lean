...
theorem GuardAut2_pxy_x_pxy_y_y_x_pxy_Equation3471 :
    AutBox.GuardAut2 ((Lf 0) ⋆ (Lf 1)) (Lf 0) ((Lf 0) ⋆ (Lf 1)) (Lf 1) (Lf 1) (Lf 0) ((Lf 0) ⋆ (Lf 1)) Law3471 := by
  classical
  ...
  · rcases eq_or_ne (M.op (σ x) (σ y)) ((σ x)) with h1a | h1a
    ...
    · rcases eq_or_ne (M.op (σ x) (σ y)) ((σ y)) with h1b | h1b
      · have b1e15 : ∀ X0 X1 : G, (M.op X0 X1) ≠ X0 ∨ (k X0 X1) = X1 := by
        ...
        clear b1e26
        have b1e47 : (σ y) ≠ (σ y) ∨ (σ x) = (σ y) ∨ (σ x) = (k (σ x) (σ y)) := by
          first
          ...
          | grind (splits := 40)
          | grind (splits := 40) (ematch := 20)
        have b1e51 : (σ x) = (σ y) ∨ (σ x) = (k (σ x) (σ y)) := by grind
        clear b1e47
      ...
      · have b2e15 : ∀ X0 X1 : G, (M.op X0 X1) ≠ X0 ∨ (k X0 X1) = X1 := by
        ...
        clear b2e24
        have b2e58 : ∀ X0 X1 : G, (σ (k X0 X1)) = (M.op (σ X0) (σ X1)) ∨ (σ X1) = (M.op (σ X0) (σ X1)) ∨ (σ X0) = (M.op (σ X0) (σ X1)) := by
          intro X0 X1
          first
          | (have i₁ := b2e18 X0 X1
          ...
          | grind (splits := 40)
          | grind (splits := 40) (ematch := 20)
        have b2e128 : ∀ X0 X1 : G, (σ (k X0 X1)) ≠ (σ X1) ∨ (σ X1) = (M.op (σ X0) (σ X1)) ∨ (σ X0) = (M.op (σ X0) (σ X1)) := by
          intro X0 X1
          first
          | (have j0 := b2e58 X0 X1
             grind)
          ...
          | grind (splits := 40) (ematch := 20)
        clear b2e58
        have b2e765 : (σ y) ≠ (σ y) ∨ (σ y) = (M.op (σ x) (σ y)) ∨ (σ x) = (M.op (σ x) (σ y)) := by
          first
          | (have i₁ := b2e128 x y
             have i₂ := b2e25
             grind)
          ...
          | grind (splits := 40) (ematch := 20)
        clear b2e25 b2e128
        have b2e769 : (σ y) = (M.op (σ x) (σ y)) ∨ (σ x) = (M.op (σ x) (σ y)) := by grind
        clear b2e765
        have b2e775 : (σ x) = (M.op (σ x) (σ y)) := by
          first
          | (have r₁ := b2e769
             have r₂ := b2e22
             grind)
          | exact resolve b2e769 b2e22
          | grind
          | grind (splits := 40)
          | grind (splits := 40) (ematch := 20)
        clear b2e769
        have b2e780 : False := by grind
        exact b2e780
      ...
      · rcases eq_or_ne (M.op (σ x) (σ y)) ((σ y)) with h1b | h1b
        ...
        · have b5e17 : ∀ X0 X1 : G, (M.op X0 X1) ≠ X1 ∨ (M.op X0 X1) = X0 ∨ (k X0 X1) = X0 := by
          ...
          have b5e54 : ∀ X0 X1 : G, (σ (k X0 X1)) = (M.op (σ X0) (σ X1)) ∨ (σ X1) = (M.op (σ X0) (σ X1)) ∨ (σ X0) = (M.op (σ X0) (σ X1)) := by
            ...
            | grind (splits := 40)
            | grind (splits := 40) (ematch := 20)
          have b5e122 : ∀ X0 X1 : G, (σ X0) ≠ (σ (k X0 X1)) ∨ (σ X1) = (M.op (σ X0) (σ X1)) ∨ (σ X0) = (M.op (σ X0) (σ X1)) := by
            intro X0 X1
            first
            | (have j0 := b5e54 X0 X1
               grind)
            ...
            | grind (splits := 40) (ematch := 20)
          clear b5e54
          have b5e768 : (σ x) ≠ (σ x) ∨ (σ y) = (M.op (σ x) (σ y)) ∨ (σ x) = (M.op (σ x) (σ y)) := by
            first
            | (have i₁ := b5e122 x y
               have i₂ := b5e51
               grind)
            | exact superpose b5e51 b5e122
            | (have j0 := b5e122 x y
               grind)
            | exact resolve b5e122 b5e51
            | grind
            | grind (splits := 40)
            | grind (splits := 40) (ematch := 20)
          clear b5e51 b5e122
          have b5e773 : (σ y) = (M.op (σ x) (σ y)) ∨ (σ x) = (M.op (σ x) (σ y)) := by grind
          clear b5e768
          have b5e781 : (σ x) = (M.op (σ x) (σ y)) := by
            first
            | (have r₁ := b5e773
               have r₂ := b5e24
               grind)
            | exact resolve b5e773 b5e24
            | grind
            | grind (splits := 40)
            | grind (splits := 40) (ematch := 20)
          clear b5e773
          have b5e786 : False := by grind
          exact b5e786
    · rcases eq_or_ne (M.op (σ x) (σ y)) ((σ x)) with h1a | h1a
      ...
      · rcases eq_or_ne (M.op (σ x) (σ y)) ((σ y)) with h1b | h1b
        ...
        · have b8e18 : ∀ X0 X1 : G, (M.op X0 X1) = (k X0 X1) ∨ (M.op X0 X1) = X1 ∨ (M.op X0 X1) = X0 := by
          ...
          have b8e47 : ∀ X0 X1 : G, (σ (k X0 X1)) = (M.op (σ X0) (σ X1)) ∨ (σ X1) = (M.op (σ X0) (σ X1)) ∨ (σ X0) = (M.op (σ X0) (σ X1)) := by
            ...
            | grind (splits := 40)
            | grind (splits := 40) (ematch := 20)
          have b8e103 : (σ (M.op x y)) ≠ (σ (k x y)) ∨ (σ y) = (M.op (σ x) (σ y)) ∨ (σ x) = (M.op (σ x) (σ y)) := by
            first
            | (have i₁ := b8e20
               have i₂ := b8e47 x y
               grind)
            ...
            | grind (splits := 40) (ematch := 20)
          clear b8e47
          have b8e118 : (σ (M.op x y)) ≠ (σ (k x y)) ∨ (σ x) = (M.op (σ x) (σ y)) := by
            first
            | (have r₁ := b8e103
               have r₂ := b8e24
               grind)
            | exact resolve b8e103 b8e24
            | grind
            | grind (splits := 40)
            | grind (splits := 40) (ematch := 20)
          clear b8e103
          have b8e121 : (σ (M.op x y)) ≠ (σ (k x y)) := by
            first
            | (have r₁ := b8e118
               have r₂ := b8e23
               grind)
            ...
            | grind (splits := 40) (ematch := 20)
          clear b8e118
          have b8e122 : (σ (M.op x y)) ≠ (σ (M.op x y)) ∨ y = (M.op x y) ∨ x = (M.op x y) := by
            first
            | (have i₁ := b8e121
               have i₂ := b8e18 x y
               grind)
            | exact superpose b8e18 b8e121
            | (have j1 := b8e18 x y
               grind)
            | exact resolve b8e121 b8e18
            | grind
            | grind (splits := 40)
            | grind (splits := 40) (ematch := 20)
          clear b8e121
          have b8e123 : y = (M.op x y) ∨ x = (M.op x y) := by grind
          clear b8e122
          have b8e124 : x = (M.op x y) := by
            first
            | (have r₁ := b8e123
               have r₂ := b8e22
               grind)
            | exact resolve b8e123 b8e22
            | grind
            | grind (splits := 40)
            | grind (splits := 40) (ematch := 20)
          clear b8e123
          have b8e125 : False := by grind
          exact b8e125
...
The obligation names no target, so any law the companion satisfies is one more cell for free. -/
theorem GuardAut2_pxy_y_pxy_x_x_y_pxy_Equation3477 :
    AutBox.GuardAut2 ((Lf 0) ⋆ (Lf 1)) (Lf 1) ((Lf 0) ⋆ (Lf 1)) (Lf 0) (Lf 0) (Lf 1) ((Lf 0) ⋆ (Lf 1)) Law3477 := by
  classical
    ...
    · rcases eq_or_ne (M.op (σ x) (σ y)) ((σ x)) with h1b | h1b
      ...
      · have b2e15 : ∀ X0 X1 : G, (M.op X0 X1) ≠ X1 ∨ (k X0 X1) = X0 := by
        ...
        have b2e53 : ∀ X0 X1 : G, (σ (k X0 X1)) = (M.op (σ X0) (σ X1)) ∨ (σ X0) = (M.op (σ X0) (σ X1)) ∨ (σ X1) = (M.op (σ X0) (σ X1)) := by
          ...
          | grind (splits := 40)
          | grind (splits := 40) (ematch := 20)
        have b2e181 : ∀ X0 X1 : G, (σ X0) ≠ (σ (k X0 X1)) ∨ (σ X0) = (M.op (σ X0) (σ X1)) ∨ (σ X1) = (M.op (σ X0) (σ X1)) := by
          intro X0 X1
          first
          | (have j0 := b2e53 X0 X1
             grind)
          ...
          | grind (splits := 40) (ematch := 20)
        clear b2e53
        have b2e3207 : (σ x) ≠ (σ x) ∨ (σ x) = (M.op (σ x) (σ y)) ∨ (σ y) = (M.op (σ x) (σ y)) := by
          first
          | (have i₁ := b2e181 x y
             have i₂ := b2e25
             grind)
          | exact superpose b2e25 b2e181
          | (have j0 := b2e181 x y
             grind)
          | exact resolve b2e181 b2e25
          | grind
          | grind (splits := 40)
          | grind (splits := 40) (ematch := 20)
        clear b2e25 b2e181
        have b2e3212 : (σ x) = (M.op (σ x) (σ y)) ∨ (σ y) = (M.op (σ x) (σ y)) := by grind
        clear b2e3207
        have b2e3233 : (σ y) = (M.op (σ x) (σ y)) := by
          first
          | (have r₁ := b2e3212
             have r₂ := b2e22
             grind)
          | exact resolve b2e3212 b2e22
          | grind
          | grind (splits := 40)
          | grind (splits := 40) (ematch := 20)
        clear b2e3212
        have b2e3245 : False := by grind
        exact b2e3245
      ...
      · rcases eq_or_ne (M.op (σ x) (σ y)) ((σ x)) with h1b | h1b
        ...
        · have b5e17 : ∀ X0 X1 : G, (M.op X0 X1) ≠ X0 ∨ (M.op X0 X1) = X1 ∨ (k X0 X1) = X1 := by
          ...
          have b5e50 : ∀ X0 X1 : G, (σ (k X0 X1)) = (M.op (σ X0) (σ X1)) ∨ (σ X0) = (M.op (σ X0) (σ X1)) ∨ (σ X1) = (M.op (σ X0) (σ X1)) := by
            ...
            | grind (splits := 40)
            | grind (splits := 40) (ematch := 20)
          have b5e185 : ∀ X0 X1 : G, (σ (k X0 X1)) ≠ (σ X1) ∨ (σ X0) = (M.op (σ X0) (σ X1)) ∨ (σ X1) = (M.op (σ X0) (σ X1)) := by
            intro X0 X1
            first
            | (have j0 := b5e50 X0 X1
               grind)
            ...
            | grind (splits := 40) (ematch := 20)
          clear b5e50
          have b5e2772 : (σ y) ≠ (σ y) ∨ (σ x) = (M.op (σ x) (σ y)) ∨ (σ y) = (M.op (σ x) (σ y)) := by
            first
            | (have i₁ := b5e185 x y
               have i₂ := b5e47
               grind)
            | exact superpose b5e47 b5e185
            | (have j0 := b5e185 x y
               grind)
            | exact resolve b5e185 b5e47
            | grind
            | grind (splits := 40)
            | grind (splits := 40) (ematch := 20)
          clear b5e47 b5e185
          have b5e2777 : (σ x) = (M.op (σ x) (σ y)) ∨ (σ y) = (M.op (σ x) (σ y)) := by grind
          clear b5e2772
          have b5e2780 : (σ y) = (M.op (σ x) (σ y)) := by
            first
            | (have r₁ := b5e2777
               have r₂ := b5e24
               grind)
            | exact resolve b5e2777 b5e24
            | grind
            | grind (splits := 40)
            | grind (splits := 40) (ematch := 20)
          clear b5e2777
          have b5e2790 : False := by grind
          exact b5e2790
    · rcases eq_or_ne (M.op (σ x) (σ y)) ((σ y)) with h1a | h1a
      · have b6e13 : ∀ X0 : G, (τ (σ X0)) = X0 := by
          intro X0
        ...
        have b6e32 : x = (k x y) := by
          ...
          | grind (splits := 40) (ematch := 20)
        clear b6e31
        have b6e51 : x = (M.op x y) ∨ x = (M.op x y) ∨ y = (M.op x y) := by
          first
          | (have i₁ := b6e32
             have i₂ := b6e17 x y
             grind)
          ...
          | grind (splits := 40) (ematch := 20)
        clear b6e32
        have b6e53 : x = (M.op x y) ∨ y = (M.op x y) := by grind
        clear b6e51
        have b6e56 : y = (M.op x y) := by
          first
          | (have r₁ := b6e53
             have r₂ := b6e21
             grind)
      ...
      · rcases eq_or_ne (M.op (σ x) (σ y)) ((σ x)) with h1b | h1b
        ...
        · have b8e18 : ∀ X0 X1 : G, (M.op X0 X1) = (k X0 X1) ∨ (M.op X0 X1) = X0 ∨ (M.op X0 X1) = X1 := by
          ...
          have b8e148 : (σ (M.op x y)) ≠ (σ (k x y)) ∨ (σ x) = (M.op (σ x) (σ y)) ∨ (σ y) = (M.op (σ x) (σ y)) := by
            ...
            | grind (splits := 40) (ematch := 20)
          clear b8e43
          have b8e170 : (σ (M.op x y)) ≠ (σ (k x y)) ∨ (σ y) = (M.op (σ x) (σ y)) := by
            first
            | (have r₁ := b8e148
               have r₂ := b8e24
               grind)
          ...
          have b8e173 : (σ (M.op x y)) ≠ (σ (k x y)) := by
            ...
            | grind (splits := 40) (ematch := 20)
          clear b8e170
          have b8e174 : (σ (M.op x y)) ≠ (σ (M.op x y)) ∨ x = (M.op x y) ∨ y = (M.op x y) := by
            first
            | (have i₁ := b8e173
               have i₂ := b8e18 x y
               grind)
            ...
            | grind (splits := 40) (ematch := 20)
          clear b8e173
          have b8e175 : x = (M.op x y) ∨ y = (M.op x y) := by grind
          clear b8e174
          have b8e176 : y = (M.op x y) := by
            first
            | (have r₁ := b8e175
               have r₂ := b8e22
               grind)
...
The obligation names no target, so any law the companion satisfies is one more cell for free. -/
theorem GuardAut2_pyy_y_pxx_x_x_pxy_pyx_Equation3477 :
    AutBox.GuardAut2 ((Lf 1) ⋆ (Lf 1)) (Lf 1) ((Lf 0) ⋆ (Lf 0)) (Lf 0) (Lf 0) ((Lf 0) ⋆ (Lf 1)) ((Lf 1) ⋆ (Lf 0)) Law3477 := by
  classical
  ...
  · rcases eq_or_ne (M.op (σ y) (σ y)) ((σ y)) with h1a | h1a
    · have b0e11 : ∀ X0 X1 X2 : G, (M.op X0 X0) = (M.op X1 (M.op (M.op X0 X2) X0)) := by
        intro X0 X1 X2
        grind
      have b0e18 : (σ (M.op x y)) ≠ (M.op (σ x) (σ y)) := by grind
      ...
      have b0e53 : (σ (M.op x y)) ≠ (σ y) := by
        ...
        | grind (splits := 40) (ematch := 20)
      clear b0e35
      have b0e56 : (σ y) ≠ (σ y) := by
        first
        | (have i₁ := b0e53
           have i₂ := b0e36 x
           grind)
        | exact superpose b0e36 b0e53
        | exact resolve b0e53 b0e36
        | grind
        | grind (splits := 40)
        | grind (splits := 40) (ematch := 20)
      clear b0e36 b0e53
    ...
    · rcases eq_or_ne (M.op (σ x) (σ x)) ((σ x)) with h1b | h1b
      · have b1e14 : ∀ X0 : G, (σ (τ X0)) = X0 := by
        ...
        have b1e27 : ∀ X0 X1 : G, (σ (k (τ X0) X1)) = (k X0 (σ X1)) := by
          ...
          | grind (splits := 40)
          | grind (splits := 40) (ematch := 20)
        have b1e72 : ∀ X0 : G, (σ y) ≠ (σ y) ∨ (M.op X0 X0) = X0 ∨ (k (σ y) X0) = (M.op X0 (σ y)) := by
          intro X0
          first
          | (have i₁ := b1e21
             have i₂ := b1e17 (σ y) X0
        ...
        have b1e78 : ∀ X0 : G, (M.op X0 X0) = X0 ∨ (k (σ y) X0) = (M.op X0 (σ y)) := by
          ...
          | grind (splits := 40) (ematch := 20)
        clear b1e72
        have b1e125 : ∀ X0 : G, (σ (τ X0)) = (k X0 (σ y)) := by
          intro X0
          first
          | (have i₁ := b1e27 X0 y
             have i₂ := b1e26 (τ X0)
          ...
          | grind (splits := 40) (ematch := 20)
        clear b1e26 b1e27
        have b1e133 : ∀ X0 : G, (k X0 (σ y)) = X0 := by
          intro X0
          first
          | (have i₁ := b1e125 X0
             have i₂ := b1e14 X0
             grind)
          | exact superpose b1e14 b1e125
          | exact resolve b1e125 b1e14
          | grind
          | grind (splits := 40)
          | grind (splits := 40) (ematch := 20)
        clear b1e125
        have b1e298 : (σ y) = (M.op (σ y) (σ y)) ∨ (σ y) = (M.op (σ y) (σ y)) := by
          first
          | (have i₁ := b1e133 (σ y)
             have i₂ := b1e78 (σ y)
             grind)
          | exact superpose b1e78 b1e133
          | (have j1 := b1e78 (σ y)
             grind)
          | exact resolve b1e133 b1e78
          | grind
          | grind (splits := 40)
          | grind (splits := 40) (ematch := 20)
        clear b1e78 b1e133
        have b1e303 : (σ y) = (M.op (σ y) (σ y)) := by grind
        clear b1e298
        have b1e307 : False := by grind
        exact b1e307
      · have b2e14 : ∀ X0 : G, (σ (τ X0)) = X0 := by
        ...
        have b2e25 : ∀ X0 X1 : G, (σ (k (τ X0) X1)) = (k X0 (σ X1)) := by
          ...
          | grind (splits := 40)
          | grind (splits := 40) (ematch := 20)
        have b2e70 : ∀ X0 : G, (σ y) ≠ (σ y) ∨ (M.op X0 X0) = X0 ∨ (k (σ y) X0) = (M.op X0 (σ y)) := by
          intro X0
          first
          | (have i₁ := b2e21
             have i₂ := b2e17 (σ y) X0
        ...
        have b2e75 : ∀ X0 : G, (M.op X0 X0) = X0 ∨ (k (σ y) X0) = (M.op X0 (σ y)) := by
          ...
          | grind (splits := 40) (ematch := 20)
        clear b2e70
        have b2e95 : ∀ X0 : G, (σ (τ X0)) = (k X0 (σ y)) := by
          intro X0
          first
          | (have i₁ := b2e25 X0 y
             have i₂ := b2e24 (τ X0)
          ...
          | grind (splits := 40) (ematch := 20)
        clear b2e24 b2e25
        have b2e102 : ∀ X0 : G, (k X0 (σ y)) = X0 := by
          intro X0
          first
          | (have i₁ := b2e95 X0
             have i₂ := b2e14 X0
             grind)
          | exact superpose b2e14 b2e95
          | exact resolve b2e95 b2e14
          | grind
          | grind (splits := 40)
          | grind (splits := 40) (ematch := 20)
        clear b2e95
        have b2e237 : (σ y) = (M.op (σ y) (σ y)) ∨ (σ y) = (M.op (σ y) (σ y)) := by
          first
          | (have i₁ := b2e102 (σ y)
             have i₂ := b2e75 (σ y)
             grind)
          | exact superpose b2e75 b2e102
          | (have j1 := b2e75 (σ y)
             grind)
          | exact resolve b2e102 b2e75
          | grind
          | grind (splits := 40)
          | grind (splits := 40) (ematch := 20)
        clear b2e75 b2e102
        have b2e240 : (σ y) = (M.op (σ y) (σ y)) := by grind
        clear b2e237
        have b2e244 : False := by grind
        exact b2e244
    ...
    · rcases eq_or_ne (M.op (σ y) (σ y)) ((σ y)) with h1a | h1a
      · have b3e13 : ∀ X0 : G, (τ (σ X0)) = X0 := by
        ...
        have b3e34 : ∀ X0 : G, (k X0 y) = X0 := by
          ...
          | grind (splits := 40) (ematch := 20)
        clear b3e33
        have b3e63 : ∀ X0 X1 X2 : G, X0 ≠ X0 ∨ (M.op X1 X1) = X1 ∨ (k X0 X1) = (M.op X0 X1) ∨ (M.op X2 X2) = X2 ∨ (M.op X0 X2) = (k X2 X0) := by
          intro X0 X1 X2
          first
          | (have i₁ := b3e16 X0 X1
             have i₂ := b3e17 X2 X0
          ...
          | grind (splits := 40)
          | grind (splits := 40) (ematch := 20)
        have b3e79 : ∀ X0 X1 X2 : G, (M.op X1 X1) = X1 ∨ (k X0 X1) = (M.op X0 X1) ∨ (M.op X2 X2) = X2 ∨ (M.op X0 X2) = (k X2 X0) := by
          intro X0 X1 X2
          first
          | (have j0 := b3e63 X0 X1 X2
             grind)
          | grind
          | grind (splits := 40)
          | grind (splits := 40) (ematch := 20)
        clear b3e63
        have b3e667 : ∀ X0 : G, (M.op X0 X0) ≠ (M.op X0 X0) ∨ (M.op X0 X0) = X0 ∨ (M.op X0 X0) = (k X0 X0) ∨ (M.op X0 X0) = X0 := by
          intro X0
          first
          | (have j0 := b3e79 X0 X0 X0
             grind)
          | grind
          | grind (splits := 40)
          | grind (splits := 40) (ematch := 20)
        clear b3e79
        have b3e668 : ∀ X0 : G, (M.op X0 X0) ≠ (M.op X0 X0) ∨ (M.op X0 X0) = X0 ∨ (M.op X0 X0) = (k X0 X0) := by
          intro X0
          first
          | (have j0 := b3e667 X0
             grind)
          ...
          | grind (splits := 40) (ematch := 20)
        clear b3e667
        have b3e669 : ∀ X0 : G, (M.op X0 X0) = (k X0 X0) ∨ (M.op X0 X0) = X0 := by
          intro X0
          first
          | (have j0 := b3e668 X0
             grind)
          ...
          | grind (splits := 40) (ematch := 20)
        clear b3e668
        have b3e1662 : y = (M.op y y) ∨ y = (M.op y y) := by
          first
          | (have i₁ := b3e34 y
             have i₂ := b3e669 y
             grind)
          | exact superpose b3e669 b3e34
          | (have j1 := b3e669 y
             grind)
          | exact resolve b3e34 b3e669
          | grind
          | grind (splits := 40)
          | grind (splits := 40) (ematch := 20)
        clear b3e34 b3e669
        have b3e1669 : y = (M.op y y) := by grind
        clear b3e1662
        have b3e1704 : False := by grind
        exact b3e1704
      · rcases eq_or_ne (M.op (σ x) (σ x)) ((σ x)) with h1b | h1b
        · have b4e13 : ∀ X0 X1 X2 : G, (M.op X0 X0) = (M.op X1 (M.op (M.op X0 X2) X0)) := by
            intro X0 X1 X2
            grind
          ...
          clear hm ht hu hv hd nh hM hi1 hi2 h0a h0b h1a h1b
          have b4e33 : ∀ X0 : G, x = (M.op X0 (M.op x x)) := by
            intro X0
            first
            | (have i₁ := b4e13 x x x
               have i₂ := b4e22
            ...
            | grind (splits := 40)
            | grind (splits := 40) (ematch := 20)
          have b4e40 : ∀ X0 : G, x = (M.op X0 x) := by
            intro X0
            first
            | (have i₁ := b4e33 X0
               have i₂ := b4e22
            ...
            | grind (splits := 40) (ematch := 20)
          clear b4e33
          have b4e47 : ∀ X0 : G, (σ x) ≠ (σ x) ∨ (M.op X0 X0) = X0 ∨ (k (σ x) X0) = (M.op (σ x) X0) := by
            intro X0
            first
            | (have i₁ := b4e17 (σ x) X0
               have i₂ := b4e24
          ...
          have b4e49 : ∀ X0 : G, x ≠ x ∨ (M.op X0 X0) = X0 ∨ (M.op x X0) = (k x X0) := by
            ...
            | grind (splits := 40) (ematch := 20)
          clear b4e40
          have b4e50 : ∀ X0 : G, (M.op X0 X0) = X0 ∨ (M.op x X0) = (k x X0) := by
            intro X0
            first
            | (have j0 := b4e49 X0
               grind)
            ...
            | grind (splits := 40) (ematch := 20)
          clear b4e49
          have b4e51 : ∀ X0 : G, (M.op X0 X0) = X0 ∨ (k (σ x) X0) = (M.op (σ x) X0) := by
            intro X0
            first
            | (have j0 := b4e47 X0
               grind)
            ...
            | grind (splits := 40) (ematch := 20)
          clear b4e47
          have b4e229 : ∀ X0 : G, (σ (k x X0)) = (M.op (σ x) (σ X0)) ∨ (σ X0) = (M.op (σ X0) (σ X0)) := by
            intro X0
            first
            | (have i₁ := b4e19 x X0
               have i₂ := b4e51 (σ X0)
            ...
            | grind (splits := 40) (ematch := 20)
          clear b4e51
          have b4e8825 : (σ y) ≠ (σ y) ∨ (M.op (σ x) (σ y)) = (σ (k x y)) := by
            first
            | (have i₁ := b4e23
               have i₂ := b4e229 y
               grind)
            | exact superpose b4e229 b4e23
            | (have j1 := b4e229 y
               grind)
            | (have r₁ := b4e23
               have r₂ := b4e229 y
               grind)
            | exact resolve b4e23 b4e229
            | grind
            | grind (splits := 40)
            | grind (splits := 40) (ematch := 20)
          clear b4e229
          have b4e8864 : (M.op (σ x) (σ y)) = (σ (k x y)) := by grind
          clear b4e8825
          have b4e8898 : (σ (M.op x y)) ≠ (σ (k x y)) := by
            first
            | (have i₁ := b4e20
               have i₂ := b4e8864
               grind)
            | exact superpose b4e8864 b4e20
            | exact resolve b4e20 b4e8864
            | grind
            | grind (splits := 40)
            | grind (splits := 40) (ematch := 20)
          clear b4e8864
          have b4e9392 : (σ (M.op x y)) ≠ (σ (M.op x y)) ∨ y = (M.op y y) := by
            first
            | (have i₁ := b4e8898
               have i₂ := b4e50 y
               grind)
            | exact superpose b4e50 b4e8898
            | (have j1 := b4e50 y
               grind)
            | exact resolve b4e8898 b4e50
            | grind
            | grind (splits := 40)
            | grind (splits := 40) (ematch := 20)
          clear b4e50 b4e8898
          have b4e9407 : y = (M.op y y) := by grind
          clear b4e9392
          have b4e9410 : False := by grind
          exact b4e9410
        · have b5e15 : ∀ X0 : G, (σ (τ X0)) = X0 := by
          ...
          have b5e34 : ∀ X0 : G, (k X0 (σ x)) = X0 := by
            ...
            | grind (splits := 40) (ematch := 20)
          clear b5e30
          have b5e71 : ∀ X0 : G, (σ x) ≠ (σ x) ∨ (M.op X0 X0) = X0 ∨ (k (σ x) X0) = (M.op X0 (σ x)) := by
            intro X0
            first
            | (have i₁ := b5e24
               have i₂ := b5e18 (σ x) X0
            ...
            | grind (splits := 40)
            | grind (splits := 40) (ematch := 20)
          have b5e76 : ∀ X0 : G, (M.op X0 X0) = X0 ∨ (k (σ x) X0) = (M.op X0 (σ x)) := by
            intro X0
            first
            | (have j0 := b5e71 X0
               grind)
            ...
            | grind (splits := 40) (ematch := 20)
          clear b5e71
          have b5e219 : (σ x) = (M.op (σ x) (σ x)) ∨ (σ x) = (M.op (σ x) (σ x)) := by
            first
            | (have i₁ := b5e34 (σ x)
               have i₂ := b5e76 (σ x)
               grind)
            | exact superpose b5e76 b5e34
            | (have j1 := b5e76 (σ x)
               grind)
            | exact resolve b5e34 b5e76
            | grind
            | grind (splits := 40)
            | grind (splits := 40) (ematch := 20)
          clear b5e34 b5e76
          have b5e222 : (σ x) = (M.op (σ x) (σ x)) := by grind
          clear b5e219
          have b5e226 : False := by grind
          exact b5e226
    · rcases eq_or_ne (M.op (σ y) (σ y)) ((σ y)) with h1a | h1a
      · have b6e13 : ∀ X0 : G, (τ (σ X0)) = X0 := by
          intro X0
        ...
        have b6e32 : ∀ X0 : G, (k X0 y) = X0 := by
          ...
          | grind (splits := 40) (ematch := 20)
        clear b6e31
        have b6e57 : ∀ X0 X1 X2 : G, X0 ≠ X0 ∨ (M.op X1 X1) = X1 ∨ (k X0 X1) = (M.op X0 X1) ∨ (M.op X2 X2) = X2 ∨ (M.op X0 X2) = (k X2 X0) := by
          intro X0 X1 X2
          first
          | (have i₁ := b6e16 X0 X1
             have i₂ := b6e17 X2 X0
          ...
          | grind (splits := 40)
          | grind (splits := 40) (ematch := 20)
        have b6e72 : ∀ X0 X1 X2 : G, (M.op X1 X1) = X1 ∨ (k X0 X1) = (M.op X0 X1) ∨ (M.op X2 X2) = X2 ∨ (M.op X0 X2) = (k X2 X0) := by
          intro X0 X1 X2
          first
          ...
          | grind (splits := 40) (ematch := 20)
        clear b6e57
        have b6e660 : ∀ X0 : G, (M.op X0 X0) ≠ (M.op X0 X0) ∨ (M.op X0 X0) = X0 ∨ (M.op X0 X0) = (k X0 X0) ∨ (M.op X0 X0) = X0 := by
          intro X0
          first
          | (have j0 := b6e72 X0 X0 X0
             grind)
          | grind
          | grind (splits := 40)
          | grind (splits := 40) (ematch := 20)
        clear b6e72
        have b6e661 : ∀ X0 : G, (M.op X0 X0) ≠ (M.op X0 X0) ∨ (M.op X0 X0) = X0 ∨ (M.op X0 X0) = (k X0 X0) := by
          intro X0
          first
          | (have j0 := b6e660 X0
             grind)
          ...
          | grind (splits := 40) (ematch := 20)
        clear b6e660
        have b6e662 : ∀ X0 : G, (M.op X0 X0) = (k X0 X0) ∨ (M.op X0 X0) = X0 := by
          intro X0
          first
          | (have j0 := b6e661 X0
             grind)
          ...
          | grind (splits := 40) (ematch := 20)
        clear b6e661
        have b6e1435 : y = (M.op y y) ∨ y = (M.op y y) := by
          first
          | (have i₁ := b6e32 y
             have i₂ := b6e662 y
             grind)
          | exact superpose b6e662 b6e32
          | (have j1 := b6e662 y
             grind)
          | exact resolve b6e32 b6e662
          | grind
          | grind (splits := 40)
          | grind (splits := 40) (ematch := 20)
        clear b6e32 b6e662
        have b6e1437 : y = (M.op y y) := by grind
        clear b6e1435
        have b6e1463 : False := by grind
        exact b6e1463
      · rcases eq_or_ne (M.op (σ x) (σ x)) ((σ x)) with h1b | h1b
        · have b7e14 : ∀ X0 : G, (τ (σ X0)) = X0 := by
            intro X0
          ...
          have b7e34 : ∀ X0 : G, (k X0 x) = X0 := by
            ...
            | grind (splits := 40) (ematch := 20)
          clear b7e33
          have b7e58 : ∀ X0 X1 X2 : G, X0 ≠ X0 ∨ (M.op X1 X1) = X1 ∨ (k X0 X1) = (M.op X0 X1) ∨ (M.op X2 X2) = X2 ∨ (M.op X0 X2) = (k X2 X0) := by
            intro X0 X1 X2
            first
            | (have i₁ := b7e17 X0 X1
               have i₂ := b7e18 X2 X0
            ...
            | grind (splits := 40)
            | grind (splits := 40) (ematch := 20)
          have b7e77 : ∀ X0 X1 X2 : G, (M.op X1 X1) = X1 ∨ (k X0 X1) = (M.op X0 X1) ∨ (M.op X2 X2) = X2 ∨ (M.op X0 X2) = (k X2 X0) := by
            intro X0 X1 X2
            first
            ...
            | grind (splits := 40) (ematch := 20)
          clear b7e58
          have b7e721 : ∀ X0 : G, (M.op X0 X0) ≠ (M.op X0 X0) ∨ (M.op X0 X0) = X0 ∨ (M.op X0 X0) = (k X0 X0) ∨ (M.op X0 X0) = X0 := by
            intro X0
            first
            | (have j0 := b7e77 X0 X0 X0
               grind)
            | grind
            | grind (splits := 40)
            | grind (splits := 40) (ematch := 20)
          clear b7e77
          have b7e722 : ∀ X0 : G, (M.op X0 X0) ≠ (M.op X0 X0) ∨ (M.op X0 X0) = X0 ∨ (M.op X0 X0) = (k X0 X0) := by
            intro X0
            first
            | (have j0 := b7e721 X0
               grind)
            ...
            | grind (splits := 40) (ematch := 20)
          clear b7e721
          have b7e723 : ∀ X0 : G, (M.op X0 X0) = (k X0 X0) ∨ (M.op X0 X0) = X0 := by
            intro X0
            first
            | (have j0 := b7e722 X0
               grind)
            ...
            | grind (splits := 40) (ematch := 20)
          clear b7e722
          have b7e1544 : x = (M.op x x) ∨ x = (M.op x x) := by
            first
            | (have i₁ := b7e34 x
               have i₂ := b7e723 x
               grind)
            | exact superpose b7e723 b7e34
            | (have j1 := b7e723 x
               grind)
            | exact resolve b7e34 b7e723
            | grind
            | grind (splits := 40)
            | grind (splits := 40) (ematch := 20)
          clear b7e34 b7e723
          have b7e1546 : x = (M.op x x) := by grind
          clear b7e1544
          have b7e1570 : False := by grind
          exact b7e1570
        · have b8e13 : ∀ X0 X1 X2 : G, (M.op X0 X0) = (M.op X1 (M.op (M.op X0 X2) X0)) := by
            intro X0 X1 X2
            grind
          ...
          clear hm ht hu hv hd nh hM hi1 hi2 h0a h0b h1a h1b
          have b8e28 : ∀ X0 X1 X2 : G, (M.op (M.op (M.op X0 X1) X0) (M.op (M.op X0 X1) X0)) = (M.op X2 (M.op X0 X0)) := by
            intro X0 X1 X2
            first
            | (have i₁ := b8e13 (M.op (M.op X0 X1) X0) X2 x
               have i₂ := b8e13 X0 (M.op (M.op (M.op X0 X1) X0) x) X1
               grind)
            ...
            | grind (splits := 40)
            | grind (splits := 40) (ematch := 20)
          have b8e30 : ∀ X0 X2 : G, (M.op X0 X0) = (M.op X2 (M.op X0 X0)) := by
            intro X0 X2
            first
            | (have i₁ := b8e28 X0 x X2
               have i₂ := b8e13 X0 (M.op (M.op X0 x) X0) x
               grind)
            | (have i₁ := b8e28 X0 x X2
               have i₂ := b8e13 (M.op (M.op X0 x) X0) x X2
               grind)
            ...
            | grind (splits := 40) (ematch := 20)
          clear b8e28
          have b8e57 : ∀ X0 X1 X2 : G, (M.op X1 X0) = X0 ∨ (M.op X2 X2) = X2 ∨ (k X0 X2) = (M.op X2 X0) := by
            intro X0 X1 X2
            first
            | (have i₁ := b8e30 X0 X2
               have i₂ := b8e18 X0 X1
               grind)
            | exact superpose b8e18 b8e30
            | (have j1 := b8e18 X2 X2
               grind)
            | exact resolve b8e30 b8e18
            | grind
            | grind (splits := 40)
            | grind (splits := 40) (ematch := 20)
          clear b8e30
          have b8e61 : ∀ X0 : G, (σ y) ≠ (σ y) ∨ (M.op X0 X0) = X0 ∨ (k (σ y) X0) = (M.op X0 (σ y)) := by
            ...
            | grind (splits := 40)
            | grind (splits := 40) (ematch := 20)
          have b8e66 : ∀ X0 : G, (M.op X0 X0) = X0 ∨ (k (σ y) X0) = (M.op X0 (σ y)) := by
            intro X0
            first
            | (have j0 := b8e61 X0
               grind)
            ...
            | grind (splits := 40) (ematch := 20)
          clear b8e61
          have b8e215 : ∀ X0 : G, (σ (k y X0)) = (M.op (σ X0) (σ y)) ∨ (σ X0) = (M.op (σ X0) (σ X0)) := by
            intro X0
            first
            | (have i₁ := b8e19 y X0
               have i₂ := b8e66 (σ X0)
            ...
            | grind (splits := 40) (ematch := 20)
          clear b8e66
          have b8e10971 : (σ (M.op x y)) ≠ (σ (k y x)) ∨ (σ x) = (M.op (σ x) (σ x)) := by
            first
            | (have i₁ := b8e20
               have i₂ := b8e215 x
               grind)
            | exact superpose b8e215 b8e20
            | (have j1 := b8e215 x
               grind)
            | exact resolve b8e20 b8e215
            | grind
            | grind (splits := 40)
            | grind (splits := 40) (ematch := 20)
          clear b8e215
          have b8e11141 : (σ (M.op x y)) ≠ (σ (k y x)) := by
            first
            | (have r₁ := b8e10971
               have r₂ := b8e24
               grind)
            | exact resolve b8e10971 b8e24
            | grind
            | grind (splits := 40)
            | grind (splits := 40) (ematch := 20)
          clear b8e10971
          have b8e12494 : ∀ X0 : G, (σ (M.op x y)) ≠ (σ (M.op x y)) ∨ y = (M.op X0 y) ∨ x = (M.op x x) := by
            intro X0
            first
            | (have i₁ := b8e11141
               have i₂ := b8e57 y X0 x
               grind)
            | exact superpose b8e57 b8e11141
            | (have j1 := b8e57 y X0 x
               grind)
            | exact resolve b8e11141 b8e57
            | grind
            | grind (splits := 40)
            | grind (splits := 40) (ematch := 20)
          clear b8e57 b8e11141
          have b8e12513 : ∀ X0 : G, y = (M.op X0 y) ∨ x = (M.op x x) := by
            intro X0
            first
            | (have j0 := b8e12494 X0
               grind)
            ...
            | grind (splits := 40) (ematch := 20)
          clear b8e12494
          have b8e12520 : ∀ X0 : G, y = (M.op X0 y) := by
            intro X0
            first
            | (have j0 := b8e12513 X0
               grind)
            | (have r₁ := b8e12513 X0
               have r₂ := b8e22
               grind)
            | exact resolve b8e12513 b8e22
            | grind
            | grind (splits := 40)
            | grind (splits := 40) (ematch := 20)
          clear b8e12513
          have b8e13157 : y ≠ y := by
            first
            | (have i₁ := b8e21
               have i₂ := b8e12520 y
               grind)
            | exact superpose b8e12520 b8e21
            | (have r₁ := b8e21
               have r₂ := b8e12520 y
               grind)
            | exact resolve b8e21 b8e12520
            | grind
            | grind (splits := 40)
            | grind (splits := 40) (ematch := 20)
          clear b8e12520
          have b8e13158 : False := by grind
          exact b8e13158
