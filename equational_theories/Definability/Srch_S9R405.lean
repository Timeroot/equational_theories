import equational_theories.Definability.Srch_S9R405_data
...
is `decide` on `Fin 9`; the searching is in `Definability/Certs/Srch9R405T*.lean`.
-/
...
theorem not_structuralFromFin_of_srch9R405 {L L' : Law.NatMagmaLaw} (v : Magma.tup9R405)
    (hsrc : @satisfies _ (Fin 9) (Magma.srch9R405 v) L')
    (htgt : ∀ u : Magma.tup9R405, ¬ @satisfies _ (Fin 9) (Magma.srch9R405 u) L) :
    ¬ L.StructuralFromFin L' :=
  Law.MagmaLaw.not_structuralFromFin_of_tupOK S9R405.E S9R405.Einv S9R405.X S9R405.Xinv S9R405.rep S9R405.tr
    S9R405.z S9R405.st S9R405.hl S9R405.hr S9R405.hxl S9R405.hxr S9R405.htr S9R405.hz S9R405.hst v.1 v.2 hsrc htgt
