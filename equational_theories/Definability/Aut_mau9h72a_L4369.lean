...
/-- No mau9h72a-invariant operation on `Fin 9` satisfies equation 4369. -/
theorem nomau9h72a_Law4369 : ∀ v : ∀ i : Fin 2,
    {x : Fin 9 // Magma.orbitOK mau9h72a.E mau9h72a.z mau9h72a.st i x},
    ¬ @satisfies _ (Fin 9)
      (Magma.mk (Magma.transport mau9h72a.E mau9h72a.tr fun i ↦ (v i).1)) Law4369 := by
