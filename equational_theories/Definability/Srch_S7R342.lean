import equational_theories.Definability.Srch_S7R342_data
...
is `decide` on `Fin 7`; the searching is in `Definability/Certs/Srch7R342T*.lean`.
-/
...
theorem not_structuralFromFin_of_srch7R342 {L L' : Law.NatMagmaLaw} (v : Magma.tup7R342)
    (hsrc : @satisfies _ (Fin 7) (Magma.srch7R342 v) L')
    (htgt : ∀ u : Magma.tup7R342, ¬ @satisfies _ (Fin 7) (Magma.srch7R342 u) L) :
    ¬ L.StructuralFromFin L' :=
  Law.MagmaLaw.not_structuralFromFin_of_tupOK S7R342.E S7R342.Einv S7R342.X S7R342.Xinv S7R342.rep S7R342.tr
    S7R342.z S7R342.st S7R342.hl S7R342.hr S7R342.hxl S7R342.hxr S7R342.htr S7R342.hz S7R342.hst v.1 v.2 hsrc htgt
