import equational_theories.Definability.Srch_S9R414_data
...
is `decide` on `Fin 9`; the searching is in `Definability/Certs/Srch9R414T*.lean`.
-/
...
theorem not_structuralFromFin_of_srch9R414 {L L' : Law.NatMagmaLaw} (v : Magma.tup9R414)
    (hsrc : @satisfies _ (Fin 9) (Magma.srch9R414 v) L')
    (htgt : ∀ u : Magma.tup9R414, ¬ @satisfies _ (Fin 9) (Magma.srch9R414 u) L) :
    ¬ L.StructuralFromFin L' :=
  Law.MagmaLaw.not_structuralFromFin_of_tupOK S9R414.E S9R414.Einv S9R414.X S9R414.Xinv S9R414.rep S9R414.tr
    S9R414.z S9R414.st S9R414.hl S9R414.hr S9R414.hxl S9R414.hxr S9R414.htr S9R414.hz S9R414.hst v.1 v.2 hsrc htgt
