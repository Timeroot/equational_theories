import equational_theories.Definability.Srch_S8R130_data
...
is `decide` on `Fin 8`; the searching is in `Definability/Certs/Srch8R130T*.lean`.
-/
...
theorem not_structuralFromFin_of_srch8R130 {L L' : Law.NatMagmaLaw} (v : Magma.tup8R130)
    (hsrc : @satisfies _ (Fin 8) (Magma.srch8R130 v) L')
    (htgt : ∀ u : Magma.tup8R130, ¬ @satisfies _ (Fin 8) (Magma.srch8R130 u) L) :
    ¬ L.StructuralFromFin L' :=
  Law.MagmaLaw.not_structuralFromFin_of_tupOK S8R130.E S8R130.Einv S8R130.X S8R130.Xinv S8R130.rep S8R130.tr
    S8R130.z S8R130.st S8R130.hl S8R130.hr S8R130.hxl S8R130.hxr S8R130.htr S8R130.hz S8R130.hst v.1 v.2 hsrc htgt
