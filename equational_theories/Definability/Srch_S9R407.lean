import equational_theories.Definability.Srch_S9R407_data
...
is `decide` on `Fin 9`; the searching is in `Definability/Certs/Srch9R407T*.lean`.
-/
...
theorem not_structuralFromFin_of_srch9R407 {L L' : Law.NatMagmaLaw} (v : Magma.tup9R407)
    (hsrc : @satisfies _ (Fin 9) (Magma.srch9R407 v) L')
    (htgt : ∀ u : Magma.tup9R407, ¬ @satisfies _ (Fin 9) (Magma.srch9R407 u) L) :
    ¬ L.StructuralFromFin L' :=
  Law.MagmaLaw.not_structuralFromFin_of_tupOK S9R407.E S9R407.Einv S9R407.X S9R407.Xinv S9R407.rep S9R407.tr
    S9R407.z S9R407.st S9R407.hl S9R407.hr S9R407.hxl S9R407.hxr S9R407.htr S9R407.hz S9R407.hst v.1 v.2 hsrc htgt
