import equational_theories.Definability.Srch_S8R57_data
...
is `decide` on `Fin 8`; the searching is in `Definability/Certs/Srch8R57T*.lean`.
-/
...
theorem not_structuralFromFin_of_srch8R57 {L L' : Law.NatMagmaLaw} (v : Magma.tup8R57)
    (hsrc : @satisfies _ (Fin 8) (Magma.srch8R57 v) L')
    (htgt : ∀ u : Magma.tup8R57, ¬ @satisfies _ (Fin 8) (Magma.srch8R57 u) L) :
    ¬ L.StructuralFromFin L' :=
  Law.MagmaLaw.not_structuralFromFin_of_tupOK S8R57.E S8R57.Einv S8R57.X S8R57.Xinv S8R57.rep S8R57.tr
    S8R57.z S8R57.st S8R57.hl S8R57.hr S8R57.hxl S8R57.hxr S8R57.htr S8R57.hz S8R57.hst v.1 v.2 hsrc htgt
