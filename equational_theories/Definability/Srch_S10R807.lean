import equational_theories.Definability.Srch_S10R807_data
...
is `decide` on `Fin 10`; the searching is in `Definability/Certs/Srch10R807T*.lean`.
-/
...
theorem not_structuralFromFin_of_srch10R807 {L L' : Law.NatMagmaLaw} (v : Magma.tup10R807)
    (hsrc : @satisfies _ (Fin 10) (Magma.srch10R807 v) L')
    (htgt : ∀ u : Magma.tup10R807, ¬ @satisfies _ (Fin 10) (Magma.srch10R807 u) L) :
    ¬ L.StructuralFromFin L' :=
  Law.MagmaLaw.not_structuralFromFin_of_tupOK S10R807.E S10R807.Einv S10R807.X S10R807.Xinv S10R807.rep S10R807.tr
    S10R807.z S10R807.st S10R807.hl S10R807.hr S10R807.hxl S10R807.hxr S10R807.htr S10R807.hz S10R807.hst v.1 v.2 hsrc htgt
