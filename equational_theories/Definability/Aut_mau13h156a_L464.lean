...
/-- No mau13h156a-invariant operation on `Fin 13` satisfies equation 464. -/
theorem nomau13h156a_Law464 : ∀ v : ∀ i : Fin 2,
    {x : Fin 13 // Magma.orbitOK mau13h156a.E mau13h156a.z mau13h156a.st i x},
    ¬ @satisfies _ (Fin 13)
      (Magma.mk (Magma.transport mau13h156a.E mau13h156a.tr fun i ↦ (v i).1)) Law464 := by
