import equational_theories.Definability.Srch_S8R164_data
...
is `decide` on `Fin 8`; the searching is in `Definability/Certs/Srch8R164T*.lean`.
-/
...
theorem not_structuralFromFin_of_srch8R164 {L L' : Law.NatMagmaLaw} (v : Magma.tup8R164)
    (hsrc : @satisfies _ (Fin 8) (Magma.srch8R164 v) L')
    (htgt : ∀ u : Magma.tup8R164, ¬ @satisfies _ (Fin 8) (Magma.srch8R164 u) L) :
    ¬ L.StructuralFromFin L' :=
  Law.MagmaLaw.not_structuralFromFin_of_tupOK S8R164.E S8R164.Einv S8R164.X S8R164.Xinv S8R164.rep S8R164.tr
    S8R164.z S8R164.st S8R164.hl S8R164.hr S8R164.hxl S8R164.hxr S8R164.htr S8R164.hz S8R164.hst v.1 v.2 hsrc htgt
