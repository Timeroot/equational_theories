import equational_theories.Definability.Srch_S9R402_data
...
is `decide` on `Fin 9`; the searching is in `Definability/Certs/Srch9R402T*.lean`.
-/
...
theorem not_structuralFromFin_of_srch9R402 {L L' : Law.NatMagmaLaw} (v : Magma.tup9R402)
    (hsrc : @satisfies _ (Fin 9) (Magma.srch9R402 v) L')
    (htgt : ∀ u : Magma.tup9R402, ¬ @satisfies _ (Fin 9) (Magma.srch9R402 u) L) :
    ¬ L.StructuralFromFin L' :=
  Law.MagmaLaw.not_structuralFromFin_of_tupOK S9R402.E S9R402.Einv S9R402.X S9R402.Xinv S9R402.rep S9R402.tr
    S9R402.z S9R402.st S9R402.hl S9R402.hr S9R402.hxl S9R402.hxr S9R402.htr S9R402.hz S9R402.hst v.1 v.2 hsrc htgt
