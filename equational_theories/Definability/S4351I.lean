...
/-- `x = x ◇ (x ◇ (x ◇ (y ◇ y)))` -/
theorem Equation414_StructuralFrom_Equation3290 : Law414.StructuralFrom Law3290 := by
  intro G M hM
  have h : Equation3290 G := Law3290.models_iff.mp hM
  obtain ⟨K⟩ : Nonempty (DKer M) := ⟨dkernel M (d3290 h)⟩
...
/-- `x = x ◇ (y ◇ (y ◇ (x ◇ x)))` -/
theorem Equation436_StructuralFrom_Equation3290 : Law436.StructuralFrom Law3290 := by
  intro G M hM
  have h : Equation3290 G := Law3290.models_iff.mp hM
  obtain ⟨K⟩ : Nonempty (DKer M) := ⟨dkernel M (d3290 h)⟩
  refine structural_q7045822 M K ?_
