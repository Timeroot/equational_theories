import equational_theories.Definability.Srch_S8R79_data
...
is `decide` on `Fin 8`; the searching is in `Definability/Certs/Srch8R79T*.lean`.
-/
...
theorem not_structuralFromFin_of_srch8R79 {L L' : Law.NatMagmaLaw} (v : Magma.tup8R79)
    (hsrc : @satisfies _ (Fin 8) (Magma.srch8R79 v) L')
    (htgt : ∀ u : Magma.tup8R79, ¬ @satisfies _ (Fin 8) (Magma.srch8R79 u) L) :
    ¬ L.StructuralFromFin L' :=
  Law.MagmaLaw.not_structuralFromFin_of_tupOK S8R79.E S8R79.Einv S8R79.X S8R79.Xinv S8R79.rep S8R79.tr
    S8R79.z S8R79.st S8R79.hl S8R79.hr S8R79.hxl S8R79.hxr S8R79.htr S8R79.hz S8R79.hst v.1 v.2 hsrc htgt
