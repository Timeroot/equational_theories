import equational_theories.Definability.Srch_S8R46_data
...
is `decide` on `Fin 8`; the searching is in `Definability/Certs/Srch8R46T*.lean`.
-/
...
theorem not_structuralFromFin_of_srch8R46 {L L' : Law.NatMagmaLaw} (v : Magma.tup8R46)
    (hsrc : @satisfies _ (Fin 8) (Magma.srch8R46 v) L')
    (htgt : ∀ u : Magma.tup8R46, ¬ @satisfies _ (Fin 8) (Magma.srch8R46 u) L) :
    ¬ L.StructuralFromFin L' :=
  Law.MagmaLaw.not_structuralFromFin_of_tupOK S8R46.E S8R46.Einv S8R46.X S8R46.Xinv S8R46.rep S8R46.tr
    S8R46.z S8R46.st S8R46.hl S8R46.hr S8R46.hxl S8R46.hxr S8R46.htr S8R46.hz S8R46.hst v.1 v.2 hsrc htgt
