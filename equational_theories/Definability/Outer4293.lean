...
/-!
# Source 4293: cells landed by an idempotent iterate applied outside the defining term
...
/-- Equation 332 `x ◇ y = y ◇ (x ◇ x)` is term-definable from equation 4293 over finite magmas, via the term
`x □ y := (x ◇ (x ◇ y))` with `u a = (a ◇ (a ◇ a))`
taken at x at u^[2N+1], y at u^[2N+1]. -/
private theorem aux4293_332 [Magma G] (h : Equation4293 G) (e v : G → G) (w : G → G → G)
    (hee : ∀ a : G, e (e a) = e a) (hve : ∀ a : G, v (e a) = e (v a))
    (huv : ∀ a : G, ((v a) ◇ ((v a) ◇ (v a))) = e a)
    (hvu : ∀ a : G, v (a ◇ (a ◇ a)) = e a)
    (hw : ∀ a b : G, w a b = ((e (v a)) ◇ ((e (v a)) ◇ (e (v b)))))
    (x y : G) :
    (w x y) =
      (w y (w x x)) := by
  by_contra nh
  have eq11 (X0 X1 : G) : (X0 ◇ (X0 ◇ X1)) = (X1 ◇ (X1 ◇ X0)) := mod_symm (h ..)
  ...
  have eq16 (X0 X1 : G) : (w X0 X1) = ((e (v X0)) ◇ ((e (v X0)) ◇ (e (v X1)))) := mod_symm (hw ..)
  ...
  have eq29 (X0 X1 : G) : (w X1 (e X0)) = ((e (v X1)) ◇ ((e (v X1)) ◇ (e (e (v X0))))) := by first | exact superpose eq13 eq16 | exact mod_symm (superpose eq13 eq16) | exact superpose eq16 eq13 | exact mod_symm (superpose eq16 eq13)
  have eq35 (X0 X1 : G) : (w X0 X1) = ((e (v X1)) ◇ ((e (v X1)) ◇ (e (v X0)))) := by first | exact superpose eq16 eq11 | exact mod_symm (superpose eq16 eq11) | exact superpose eq11 eq16 | exact mod_symm (superpose eq11 eq16)
  have eq38 (X0 X1 : G) : (w X1 (e X0)) = ((e (v X1)) ◇ ((e (v X1)) ◇ (e (v X0)))) := by first | exact superpose eq12 eq29 | exact mod_symm (superpose eq12 eq29) | exact superpose eq29 eq12 | exact mod_symm (superpose eq29 eq12)
...
/-- Equation 3342 `x ◇ y = y ◇ (x ◇ (x ◇ x))` is term-definable from equation 4293 over finite magmas, via the term
`x □ y := (x ◇ (x ◇ y))` with `u a = (a ◇ (a ◇ a))`
taken at x at u^[2N+1], y at u^[2N+1]. -/
private theorem aux4293_3342 [Magma G] (h : Equation4293 G) (e v : G → G) (w : G → G → G)
    (hee : ∀ a : G, e (e a) = e a) (hve : ∀ a : G, v (e a) = e (v a))
    (huv : ∀ a : G, ((v a) ◇ ((v a) ◇ (v a))) = e a)
    (hvu : ∀ a : G, v (a ◇ (a ◇ a)) = e a)
    (hw : ∀ a b : G, w a b = ((e (v a)) ◇ ((e (v a)) ◇ (e (v b)))))
...
/-- Equation 3545 `x ◇ y = y ◇ ((x ◇ x) ◇ x)` is term-definable from equation 4293 over finite magmas, via the term
`x □ y := (x ◇ (x ◇ y))` with `u a = (a ◇ (a ◇ a))`
taken at x at u^[2N+1], y at u^[2N+1]. -/
private theorem aux4293_3545 [Magma G] (h : Equation4293 G) (e v : G → G) (w : G → G → G)
    (hee : ∀ a : G, e (e a) = e a) (hve : ∀ a : G, v (e a) = e (v a))
    (huv : ∀ a : G, ((v a) ◇ ((v a) ◇ (v a))) = e a)
    (hvu : ∀ a : G, v (a ◇ (a ◇ a)) = e a)
    (hw : ∀ a b : G, w a b = ((e (v a)) ◇ ((e (v a)) ◇ (e (v b)))))
  ...
  have eq27 (X0 X1 : G) : (w (e X0) X1) = ((e (e (v X0))) ◇ ((e (e (v X0))) ◇ (e (v X1)))) := by first | exact superpose eq13 eq16 | exact mod_symm (superpose eq13 eq16) | exact superpose eq16 eq13 | exact mod_symm (superpose eq16 eq13)
  have eq29 (X0 X1 : G) : (w X1 (e X0)) = ((e (v X1)) ◇ ((e (v X1)) ◇ (e (e (v X0))))) := by first | exact superpose eq13 eq16 | exact mod_symm (superpose eq13 eq16) | exact superpose eq16 eq13 | exact mod_symm (superpose eq16 eq13)
  have eq35 (X0 X1 : G) : (w X0 X1) = ((e (v X1)) ◇ ((e (v X1)) ◇ (e (v X0)))) := by first | exact superpose eq16 eq11 | exact mod_symm (superpose eq16 eq11) | exact superpose eq11 eq16 | exact mod_symm (superpose eq11 eq16)
  have eq38 (X0 X1 : G) : (w X1 (e X0)) = ((e (v X1)) ◇ ((e (v X1)) ◇ (e (v X0)))) := by first | exact superpose eq12 eq29 | exact mod_symm (superpose eq12 eq29) | exact superpose eq29 eq12 | exact mod_symm (superpose eq29 eq12)
  have eq40 (X0 X1 : G) : ((e (v X0)) ◇ ((e (v X0)) ◇ (e (v X1)))) = (w (e X0) X1) := by first | exact superpose eq12 eq27 | exact mod_symm (superpose eq12 eq27) | exact superpose eq27 eq12 | exact mod_symm (superpose eq27 eq12)
  have eq42 (X0 X1 : G) : (w X1 (e X0)) = (w X1 X0) := by first | exact superpose eq16 eq38 | exact mod_symm (superpose eq16 eq38) | exact superpose eq38 eq16 | exact mod_symm (superpose eq38 eq16)
...
/-- Equation 4343 `x ◇ (y ◇ y) = y ◇ (x ◇ x)` is term-definable from equation 4293 over finite magmas, via the term
`x □ y := (x ◇ (x ◇ y))` with `u a = (a ◇ (a ◇ a))`
taken at x at u^[2N+1], y at u^[2N+1]. -/
private theorem aux4293_4343 [Magma G] (h : Equation4293 G) (e v : G → G) (w : G → G → G)
    (hee : ∀ a : G, e (e a) = e a) (hve : ∀ a : G, v (e a) = e (v a))
    (huv : ∀ a : G, ((v a) ◇ ((v a) ◇ (v a))) = e a)
    (hvu : ∀ a : G, v (a ◇ (a ◇ a)) = e a)
    (hw : ∀ a b : G, w a b = ((e (v a)) ◇ ((e (v a)) ◇ (e (v b)))))
  ...
  have eq14 (X0 : G) : (e X0) = ((v X0) ◇ ((v X0) ◇ (v X0))) := mod_symm (huv ..)
  have eq16 (X0 X1 : G) : (w X0 X1) = ((e (v X0)) ◇ ((e (v X0)) ◇ (e (v X1)))) := mod_symm (hw ..)
  have eq17 : (w x (w y y)) ≠ (w y (w x x)) := mod_symm nh
  have eq21 (X0 : G) : (e (e X0)) = ((e (v X0)) ◇ ((e (v X0)) ◇ (e (v X0)))) := by first | exact superpose eq13 eq14 | exact mod_symm (superpose eq13 eq14) | exact superpose eq14 eq13 | exact mod_symm (superpose eq14 eq13)
  have eq24 (X0 : G) : (e (e X0)) = (w X0 X0) := by first | exact superpose eq16 eq21 | exact mod_symm (superpose eq16 eq21) | exact superpose eq21 eq16 | exact mod_symm (superpose eq21 eq16)
  have eq25 (X0 : G) : (e X0) = (w X0 X0) := by first | exact superpose eq12 eq24 | exact mod_symm (superpose eq12 eq24) | exact superpose eq24 eq12 | exact mod_symm (superpose eq24 eq12)
  have eq26 : (w x (w y y)) ≠ (w y (e x)) := by first | exact superpose eq25 eq17 | exact mod_symm (superpose eq25 eq17) | exact superpose eq17 eq25 | exact mod_symm (superpose eq17 eq25)
  have eq27 : (w y (e x)) ≠ (w x (e y)) := by first | exact superpose eq25 eq26 | exact mod_symm (superpose eq25 eq26) | exact superpose eq26 eq25 | exact mod_symm (superpose eq26 eq25)
  have eq30 (X0 X1 : G) : (w X1 (e X0)) = ((e (v X1)) ◇ ((e (v X1)) ◇ (e (e (v X0))))) := by first | exact superpose eq13 eq16 | exact mod_symm (superpose eq13 eq16) | exact superpose eq16 eq13 | exact mod_symm (superpose eq16 eq13)
  have eq36 (X0 X1 : G) : (w X0 X1) = ((e (v X1)) ◇ ((e (v X1)) ◇ (e (v X0)))) := by first | exact superpose eq16 eq11 | exact mod_symm (superpose eq16 eq11) | exact superpose eq11 eq16 | exact mod_symm (superpose eq11 eq16)
  have eq39 (X0 X1 : G) : (w X1 (e X0)) = ((e (v X1)) ◇ ((e (v X1)) ◇ (e (v X0)))) := by first | exact superpose eq12 eq30 | exact mod_symm (superpose eq12 eq30) | exact superpose eq30 eq12 | exact mod_symm (superpose eq30 eq12)
  have eq43 (X0 X1 : G) : (w X1 (e X0)) = (w X1 X0) := by first | exact superpose eq16 eq39 | exact mod_symm (superpose eq16 eq39) | exact superpose eq39 eq16 | exact mod_symm (superpose eq39 eq16)
  have eq46 : (w x (e y)) ≠ (w y x) := by first | exact superpose eq43 eq27 | exact mod_symm (superpose eq43 eq27) | exact superpose eq27 eq43 | exact mod_symm (superpose eq27 eq43)
  have eq49 : (w y x) ≠ (w x y) := by first | exact superpose eq43 eq46 | exact mod_symm (superpose eq43 eq46) | exact superpose eq46 eq43 | exact mod_symm (superpose eq46 eq43)
  have eq81 (X0 X1 : G) : (w X0 X1) = (w X1 X0) := by first | exact superpose eq36 eq16 | exact mod_symm (superpose eq36 eq16) | exact superpose eq16 eq36 | exact mod_symm (superpose eq16 eq36)
  have eq107 : (w x y) ≠ (w x y) := by first | exact superpose eq81 eq49 | exact mod_symm (superpose eq81 eq49) | exact superpose eq49 eq81 | exact mod_symm (superpose eq49 eq81)
  first | exact eq107 rfl | exact eq107 _ rfl | exact eq107 _ _ rfl | exact eq107 _ _ _ rfl


theorem Equation332_termDefinableFromFin_Equation4293 :
    Law332.TermDefinableFromFin Law4293 := by
  refine termDefinableFromFin_of_iterate_pair (fun G ↦ (tm1 (Term.var 0) (tm1 (Term.var 0) (Term.var 0))))
    (fun G ↦ (tm (Term.var 0) (tm (Term.var 0) (Term.var 1)))) 0 0 true true 1 1 ?_
  intro G _ M hGL N e v he
  letI : Magma G := M
  have h : Equation4293 G := Law4293.models_iff.mp hGL
  have huv : ∀ a : G, ((v a) ◇ ((v a) ◇ (v a))) = e a := fun a ↦ he.u_comp_v a
  have hvu : ∀ a : G, v (a ◇ (a ◇ a)) = e a := fun a ↦ he.v_comp_u a
  rw [@Law332.models_iff]
  intro x y
  exact aux4293_332 h e v _ he.idem he.comm_v huv hvu (fun a b ↦ rfl) x y

theorem Equation3342_termDefinableFromFin_Equation4293 :
    Law3342.TermDefinableFromFin Law4293 := by
  refine termDefinableFromFin_of_iterate_pair (fun G ↦ (tm1 (Term.var 0) (tm1 (Term.var 0) (Term.var 0))))
    (fun G ↦ (tm (Term.var 0) (tm (Term.var 0) (Term.var 1)))) 0 0 true true 1 1 ?_
  intro G _ M hGL N e v he
  letI : Magma G := M
  ...
  intro x y
  exact aux4293_3342 h e v _ he.idem he.comm_v huv hvu (fun a b ↦ rfl) x y

theorem Equation3545_termDefinableFromFin_Equation4293 :
    Law3545.TermDefinableFromFin Law4293 := by
  refine termDefinableFromFin_of_iterate_pair (fun G ↦ (tm1 (Term.var 0) (tm1 (Term.var 0) (Term.var 0))))
    (fun G ↦ (tm (Term.var 0) (tm (Term.var 0) (Term.var 1)))) 0 0 true true 1 1 ?_
  intro G _ M hGL N e v he
  letI : Magma G := M
  ...
  intro x y
  exact aux4293_3545 h e v _ he.idem he.comm_v huv hvu (fun a b ↦ rfl) x y

theorem Equation4343_termDefinableFromFin_Equation4293 :
    Law4343.TermDefinableFromFin Law4293 := by
  refine termDefinableFromFin_of_iterate_pair (fun G ↦ (tm1 (Term.var 0) (tm1 (Term.var 0) (Term.var 0))))
    (fun G ↦ (tm (Term.var 0) (tm (Term.var 0) (Term.var 1)))) 0 0 true true 1 1 ?_
  intro G _ M hGL N e v he
  letI : Magma G := M
  ...
  intro x y
  exact aux4293_4343 h e v _ he.idem he.comm_v huv hvu (fun a b ↦ rfl) x y
