import equational_theories.Definability.Srch_S9R410_data
...
is `decide` on `Fin 9`; the searching is in `Definability/Certs/Srch9R410T*.lean`.
-/
...
theorem not_structuralFromFin_of_srch9R410 {L L' : Law.NatMagmaLaw} (v : Magma.tup9R410)
    (hsrc : @satisfies _ (Fin 9) (Magma.srch9R410 v) L')
    (htgt : ∀ u : Magma.tup9R410, ¬ @satisfies _ (Fin 9) (Magma.srch9R410 u) L) :
    ¬ L.StructuralFromFin L' :=
  Law.MagmaLaw.not_structuralFromFin_of_tupOK S9R410.E S9R410.Einv S9R410.X S9R410.Xinv S9R410.rep S9R410.tr
    S9R410.z S9R410.st S9R410.hl S9R410.hr S9R410.hxl S9R410.hxr S9R410.htr S9R410.hz S9R410.hst v.1 v.2 hsrc htgt
