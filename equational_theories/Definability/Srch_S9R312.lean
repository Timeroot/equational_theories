import equational_theories.Definability.Srch_S9R312_data
...
is `decide` on `Fin 9`; the searching is in `Definability/Certs/Srch9R312T*.lean`.
-/
...
theorem not_structuralFromFin_of_srch9R312 {L L' : Law.NatMagmaLaw} (v : Magma.tup9R312)
    (hsrc : @satisfies _ (Fin 9) (Magma.srch9R312 v) L')
    (htgt : ∀ u : Magma.tup9R312, ¬ @satisfies _ (Fin 9) (Magma.srch9R312 u) L) :
    ¬ L.StructuralFromFin L' :=
  Law.MagmaLaw.not_structuralFromFin_of_tupOK S9R312.E S9R312.Einv S9R312.X S9R312.Xinv S9R312.rep S9R312.tr
    S9R312.z S9R312.st S9R312.hl S9R312.hr S9R312.hxl S9R312.hxr S9R312.htr S9R312.hz S9R312.hst v.1 v.2 hsrc htgt
