import equational_theories.Definability.Srch_SR4_data
...
is `decide` on `Fin 6`; the searching is in `Definability/Certs/SrchR4T*.lean`.
-/
...
theorem not_structuralFromFin_of_srchR4 {L L' : Law.NatMagmaLaw} (v : Magma.tupR4)
    (hsrc : @satisfies _ (Fin 6) (Magma.srchR4 v) L')
    (htgt : ∀ u : Magma.tupR4, ¬ @satisfies _ (Fin 6) (Magma.srchR4 u) L) :
    ¬ L.StructuralFromFin L' :=
  Law.MagmaLaw.not_structuralFromFin_of_tupOK SR4.E SR4.Einv SR4.X SR4.Xinv SR4.rep SR4.tr
    SR4.z SR4.st SR4.hl SR4.hr SR4.hxl SR4.hxr SR4.htr SR4.hz SR4.hst v.1 v.2 hsrc htgt
