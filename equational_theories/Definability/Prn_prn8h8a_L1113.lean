...
1113. This is a set, not an order: the kernel picks which one to branch on at each
node. -/
def ordprn8h8a_Law1113 : List (Fin 12) := List.finRange 12
