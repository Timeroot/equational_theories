...
target, so `gcell`-style reuse can spend it on any law the companion satisfies. -/
theorem GuardAut_pxx_x_pxx_pyx_Equation3398 :
    AutBox.GuardAut ((Lf 0) ⋆ (Lf 0)) (Lf 0) ((Lf 0) ⋆ (Lf 0)) ((Lf 1) ⋆ (Lf 0)) Law3398 := by
  classical
  ...
  have eq20 : ∀ X0 X1 : G, (k (τ X0) X1) = (τ (k X0 (σ X1))) := by
    ...
    | grind (splits := 40)
    | grind (splits := 40) (ematch := 20)
  have eq21 : ∀ X0 X1 X2 X3 : G, (M.op X2 X3) = (M.op (M.op X1 (M.op X0 X2)) (M.op X3 (M.op X0 X1))) := by
    intro X0 X1 X2 X3
    first
    ...
    | grind (splits := 40)
    | grind (splits := 40) (ematch := 20)
  have eq22 : ∀ X0 X1 X2 : G, (M.op X1 X2) = (M.op (M.op X0 X2) (M.op X0 X1)) := by
    intro X0 X1 X2
    first
  ...
  have eq31 : ∀ X0 X1 : G, (k (τ X1) (τ X0)) = (τ (k X1 X0)) := by
    ...
    | grind (splits := 40) (ematch := 20)
  clear eq20
  have eq42 : ∀ X0 X1 X2 : G, X0 ≠ X0 ∨ (k X0 X1) = X0 ∨ (M.op X2 X0) = (k X0 X2) := by
    intro X0 X1 X2
    first
    | (have i₁ := eq11 X0 X1
       have i₂ := eq12 X0 X1
  ...
  have eq43 : ∀ X0 X1 : G, (σ (k X1 X0)) = (M.op (σ X0) (σ X1)) ∨ (σ X1) = (M.op (σ X1) (σ X1)) := by
    ...
    | grind (splits := 40)
    | grind (splits := 40) (ematch := 20)
  have eq47 : ∀ X0 X1 X2 : G, (k X0 X1) = X0 ∨ (M.op X2 X0) = (k X0 X2) := by
    intro X0 X1 X2
    first
    | (have j0 := eq42 X0 X1 X2
       grind)
    ...
    | grind (splits := 40) (ematch := 20)
  clear eq42
  have eq61 : ∀ X0 X1 X2 X3 : G, (M.op X2 (M.op X1 (M.op X0 X3))) = (M.op (M.op X0 X1) (M.op X3 X2)) := by
    intro X0 X1 X2 X3
    first
    | (have i₁ := eq22 X3 X2 (M.op X1 (M.op X0 X3))
       have i₂ := eq8 X0 X1 X3
       grind)
    ...
    | grind (splits := 40)
    | grind (splits := 40) (ematch := 20)
  have eq69 : ∀ X0 X1 X2 : G, (M.op X0 (M.op X0 X1)) = (M.op X2 (M.op X2 X1)) := by
    intro X0 X1 X2
    first
    ...
    | grind (splits := 40)
    | grind (splits := 40) (ematch := 20)
  have eq71 : ∀ X0 X1 X2 X3 : G, (M.op (M.op X2 X1) X3) = (M.op (M.op X2 X0) (M.op X3 (M.op X0 X1))) := by
    intro X0 X1 X2 X3
    first
    | (have i₁ := eq8 (M.op X2 X1) X3 (M.op X2 X0)
    ...
    | grind (splits := 40)
    | grind (splits := 40) (ematch := 20)
  have eq93 : ∀ X0 X1 X2 : G, (σ X0) = (σ (k X0 X1)) ∨ (M.op X2 (σ X0)) = (k (σ X0) X2) := by
    intro X0 X1 X2
    first
    | (have i₁ := eq13 X0 X1
       have i₂ := eq47 (σ X0) (σ X1) X2
       grind)
    ...
    | grind (splits := 40)
    | grind (splits := 40) (ematch := 20)
  have eq97 : ∀ X0 X1 X2 : G, (σ X0) = (k (σ X0) X1) ∨ (M.op X2 X0) = (k X0 X2) := by
    intro X0 X1 X2
    first
    | (have i₁ := eq16 X1 X0
    ...
    | grind (splits := 40) (ematch := 20)
  clear eq47
  have eq114 : ∀ X0 X1 X2 X3 : G, (M.op X0 X1) = (M.op (M.op X2 X0) (M.op X1 (M.op X0 X2))) ∨ (M.op X3 X0) = (k X0 X3) := by
    intro X0 X1 X2 X3
    first
    ...
    | grind (splits := 40)
    | grind (splits := 40) (ematch := 20)
  have eq125 : ∀ X0 X1 X2 X3 : G, (M.op X2 X3) = (M.op (M.op (M.op X0 X3) (M.op X1 X2)) (M.op X0 X1)) := by
    intro X0 X1 X2 X3
    first
    | (have i₁ := eq21 X1 (M.op X0 X3) X2 X3
       have i₂ := eq8 X0 X1 X3
       grind)
    | exact superpose eq8 eq21
    | exact resolve eq21 eq8
    ...
    | grind (splits := 40)
    | grind (splits := 40) (ematch := 20)
  have eq128 : ∀ X0 X1 X2 X3 X4 : G, (M.op X2 (M.op X3 (M.op X4 X0))) = (M.op (M.op (M.op X4 X3) (M.op X1 X2)) (M.op X0 X1)) := by
    intro X0 X1 X2 X3 X4
    first
    | (have i₁ := eq21 X1 (M.op X4 X3) X2 (M.op X3 (M.op X4 X0))
       have i₂ := eq21 X4 X3 X0 X1
       grind)
    ...
    | grind (splits := 40)
    | grind (splits := 40) (ematch := 20)
  have eq139 : ∀ X0 X1 X2 X3 X4 : G, (M.op X2 (M.op X3 (M.op X4 X0))) = (M.op X1 (M.op (M.op X1 X2) (M.op (M.op X4 X3) X0))) := by
    intro X0 X1 X2 X3 X4
    first
    | (have i₁ := eq128 X0 X1 X2 X3 X4
       have i₂ := eq61 (M.op X4 X3) (M.op X1 X2) X1 X0
       grind)
    | exact superpose eq61 eq128
    | exact resolve eq128 eq61
    | grind
    | grind (splits := 40)
    | grind (splits := 40) (ematch := 20)
  clear eq128
  have eq142 : ∀ X0 X1 X2 X3 : G, (M.op X2 X3) = (M.op X1 (M.op (M.op X1 X2) (M.op (M.op X0 X3) X0))) := by
    intro X0 X1 X2 X3
    first
    | (have i₁ := eq125 X0 X1 X2 X3
       have i₂ := eq61 (M.op X0 X3) (M.op X1 X2) X1 X0
       grind)
    | exact superpose eq61 eq125
    | exact resolve eq125 eq61
    | grind
    | grind (splits := 40)
    | grind (splits := 40) (ematch := 20)
  clear eq61 eq125
  have eq151 : ∀ X0 X1 X2 X3 : G, (M.op X0 X1) = (M.op (M.op X2 X2) X1) ∨ (M.op X3 X0) = (k X0 X3) := by
    intro X0 X1 X2 X3
    first
    | (have i₁ := eq114 X0 X1 X2 X3
       have i₂ := eq71 X0 X2 X2 X1
       grind)
    ...
    | grind (splits := 40) (ematch := 20)
  clear eq71 eq114
  have eq153 : ∀ X0 X2 X3 : G, (M.op X2 X3) = (M.op X2 (M.op X3 (M.op X0 X0))) := by
    intro X0 X2 X3
    first
    | (have i₁ := eq142 X0 x X2 X3
       have i₂ := eq139 X0 x X2 X3 X0
       grind)
    | exact superpose eq139 eq142
    | exact resolve eq142 eq139
    | grind
    | grind (splits := 40)
    | grind (splits := 40) (ematch := 20)
  clear eq139 eq142
  have eq187 : ∀ X0 X1 X2 X3 : G, (M.op X2 X3) = (M.op (M.op X1 (M.op X3 X2)) (M.op X0 (M.op X0 X1))) := by
    intro X0 X1 X2 X3
    first
    | (have i₁ := eq21 X3 X1 X2 X3
       have i₂ := eq69 X3 X1 X0
       grind)
    | (have i₁ := eq21 X3 X1 X2 X3
       have i₂ := eq69 X0 X1 X3
       grind)
    ...
    | grind (splits := 40) (ematch := 20)
  clear eq21
  have eq189 : ∀ X0 X1 X2 : G, (M.op X2 X2) = (M.op X1 (M.op X0 (M.op X0 X1))) := by
    intro X0 X1 X2
    first
    | (have i₁ := eq8 X2 X2 X1
    ...
    | grind (splits := 40)
    | grind (splits := 40) (ematch := 20)
  have eq190 : ∀ X0 X1 X2 : G, (M.op X1 X2) = (M.op X0 (M.op X0 (M.op X1 X2))) := by
    intro X0 X1 X2
    first
    | (have i₁ := eq8 X1 X2 X2
       have i₂ := eq69 X2 (M.op X1 X2) X0
       grind)
    | (have i₁ := eq8 X1 X2 X2
       have i₂ := eq69 X0 (M.op X1 X2) X2
       grind)
    | exact superpose eq69 eq8
    | exact resolve eq8 eq69
    | grind
    | grind (splits := 40)
    | grind (splits := 40) (ematch := 20)
  have eq194 : ∀ X0 X1 X2 X3 : G, (M.op (M.op X2 X1) X3) = (M.op (M.op X2 X3) (M.op X0 (M.op X0 X1))) := by
    intro X0 X1 X2 X3
    first
    | (have i₁ := eq22 X2 (M.op X2 X1) X3
       have i₂ := eq69 X2 X1 X0
       grind)
    | (have i₁ := eq22 X2 (M.op X2 X1) X3
       have i₂ := eq69 X0 X1 X2
    ...
    | grind (splits := 40) (ematch := 20)
  clear eq22 eq69
  have eq201 : ∀ X0 X2 : G, (M.op X0 X0) = (M.op X2 X2) := by
    intro X0 X2
    first
    | (have i₁ := eq189 X2 x X0
       have i₂ := eq8 X2 X2 x
       grind)
    ...
    | grind (splits := 40) (ematch := 20)
  clear eq189
  have eq203 : ∀ X1 X2 X3 : G, (M.op X2 X3) = (M.op (M.op X1 X1) (M.op X3 X2)) := by
    intro X1 X2 X3
    first
    | (have i₁ := eq187 x X1 X2 X3
       have i₂ := eq194 x X1 X1 (M.op X3 X2)
       grind)
    ...
    | grind (splits := 40) (ematch := 20)
  clear eq187 eq194
  have eq314 : ∀ X0 X1 X2 : G, (M.op X2 (M.op X0 X0)) = (M.op X1 (M.op X1 X2)) := by
    intro X0 X1 X2
    first
    | (have i₁ := eq8 X1 (M.op X1 X2) X2
       have i₂ := eq201 (M.op X1 X2) X0
       grind)
    | (have i₁ := eq8 X1 (M.op X1 X2) X2
       have i₂ := eq201 X0 (M.op X1 X2)
       grind)
    | exact superpose eq201 eq8
    | exact resolve eq8 eq201
    | grind
    | grind (splits := 40)
    | grind (splits := 40) (ematch := 20)
  have eq316 : ∀ X0 X1 X2 : G, (M.op X0 X0) ≠ X1 ∨ (M.op X0 X0) = (k X1 X2) := by
    intro X0 X1 X2
    first
    | (have i₁ := eq11 X0 X1
       have i₂ := eq201 X0 X2
    ...
    | (have i₁ := eq11 X2 X1
       have i₂ := eq201 X0 X2
       grind)
    | exact superpose eq201 eq11
    | (have r₁ := eq11 (M.op X2 X2) X1
       have r₂ := eq201 (M.op X2 X2) X2
       grind)
    | (have r₁ := eq11 (M.op X0 X0) X1
       have r₂ := eq201 X0 (M.op X0 X0)
       grind)
    | exact resolve eq11 eq201
    | grind
    | grind (splits := 40)
    | grind (splits := 40) (ematch := 20)
  have eq332 : ∀ X0 X1 : G, (M.op X0 X0) = (σ (k X1 X1)) ∨ (M.op X0 X0) = (σ X1) := by
    intro X0 X1
    first
    | (have i₁ := eq43 X0 X0
       have i₂ := eq201 (σ X0) x
    ...
    | (have i₁ := eq43 X0 X0
       ...
       grind)
    | exact superpose eq201 eq43
    | exact resolve eq43 eq201
    | grind
    | grind (splits := 40)
    | grind (splits := 40) (ematch := 20)
  clear eq43 eq201
  have eq924 : ∀ X0 X1 X2 : G, (k X1 (σ X0)) = (σ (M.op X0 (τ X1))) ∨ (σ (τ X1)) = (k (σ (τ X1)) X2) := by
    intro X0 X1 X2
    first
    | (have i₁ := eq15 X1 X0
       have i₂ := eq97 (τ X1) X2 X0
       grind)
    | exact superpose eq97 eq15
    | (have j1 := eq97 (τ X1) X2 X2
       grind)
    ...
    | grind (splits := 40) (ematch := 20)
  clear eq97
  have eq927 : ∀ X0 X1 X2 : G, (k X1 X2) = X1 ∨ (k X1 (σ X0)) = (σ (M.op X0 (τ X1))) := by
    intro X0 X1 X2
    first
    | (have i₁ := eq924 X0 X0 X2
       have i₂ := eq10 X0
       grind)
    | exact superpose eq10 eq924
    | (have j0 := eq924 X0 X1 X2
       grind)
    ...
    | grind (splits := 40) (ematch := 20)
  clear eq924
  have eq1310 : ∀ X0 X1 X2 : G, (M.op (M.op X1 X1) X0) = X0 ∨ (M.op X2 X0) = (k X0 X2) := by
    intro X0 X1 X2
    first
    | (have i₁ := eq203 X1 X0 X0
       have i₂ := eq12 X0 X1
       grind)
    ...
    | grind (splits := 40) (ematch := 20)
  clear eq203
  have eq5421 : ∀ X0 X1 X2 : G, (M.op X1 X1) ≠ (M.op X0 (M.op X0 (M.op X1 X1))) ∨ (k (M.op X1 X1) X2) = (M.op X0 (M.op X0 (M.op X1 X1))) := by
    intro X0 X1 X2
    first
    | (have i₁ := eq11 (M.op X0 X0) X1
       have i₂ := eq314 X0 X1 (M.op X0 X0)
       grind)
    | exact superpose eq314 eq11
    | exact resolve eq11 eq314
    | grind
    | grind (splits := 40)
    | grind (splits := 40) (ematch := 20)
  clear eq314
  have eq5568 : ∀ X0 X1 X2 : G, (k (M.op X1 X1) X2) = (M.op X0 (M.op X0 (M.op X1 X1))) := by
    intro X0 X1 X2
    first
    | (have j0 := eq5421 X0 X1 X2
       grind)
    | (have r₁ := eq5421 X0 X2 X2
       have r₂ := eq190 X0 X2 X2
       grind)
    | exact resolve eq5421 eq190
    | grind
    | grind (splits := 40)
    | grind (splits := 40) (ematch := 20)
  clear eq190 eq5421
  have eq5691 : ∀ X0 X1 X2 : G, (M.op X0 X0) = (k (M.op X1 X1) X2) := by
    intro X0 X1 X2
    first
    | (have i₁ := eq5568 X0 X1 X2
       have i₂ := eq153 X1 X0 X0
       grind)
    | (have i₁ := eq5568 X2 X1 X2
       have i₂ := eq153 X0 X2 (M.op X2 (M.op X1 X1))
       grind)
    | exact superpose eq153 eq5568
    | exact resolve eq5568 eq153
    | grind
    | grind (splits := 40)
    | grind (splits := 40) (ematch := 20)
  clear eq153 eq5568
  have eq12366 : ∀ X0 X1 X2 : G, (σ (k X1 X0)) = (M.op (σ X0) (σ X1)) ∨ (σ X1) = (σ (k X1 X2)) := by
    intro X0 X1 X2
    first
    | (have i₁ := eq13 X1 X0
       have i₂ := eq93 X1 X2 (σ X0)
       grind)
    | exact superpose eq93 eq13
    | (have j1 := eq93 X1 X2 X2
       grind)
    | exact resolve eq13 eq93
    | grind
    | grind (splits := 40)
    | grind (splits := 40) (ematch := 20)
  clear eq93
  have eq12885 : ∀ X0 X1 X2 X3 : G, (M.op (M.op X0 X0) X1) ≠ X1 ∨ (k X1 X2) = (M.op (M.op X0 X0) X1) ∨ (M.op X3 X1) = (k X1 X3) := by
    intro X0 X1 X2 X3
    first
    | (have i₁ := eq11 X1 X1
       have i₂ := eq151 X1 X1 X2 X3
       grind)
    | (have i₁ := eq11 (M.op X2 X2) X1
       have i₂ := eq151 X0 (M.op X2 X2) X2 X3
       grind)
    | exact superpose eq151 eq11
    | (have j1 := eq151 X1 X1 X2 X3
       grind)
    | exact resolve eq11 eq151
    | grind
    | grind (splits := 40)
    | grind (splits := 40) (ematch := 20)
  clear eq151
  have eq13187 : ∀ X0 X1 X2 X3 : G, (k X1 X2) = (M.op (M.op X0 X0) X1) ∨ (M.op X3 X1) = (k X1 X3) := by
    intro X0 X1 X2 X3
    first
    | (have j0 := eq12885 X0 X1 X2 X3
       have j1 := eq1310 X1 X1 X3
       grind)
    | (have r₁ := eq12885 X1 X0 X2 X3
       have r₂ := eq1310 X0 X1 X2
       grind)
    | exact resolve eq12885 eq1310
    | grind
    | grind (splits := 40)
    | grind (splits := 40) (ematch := 20)
  clear eq1310 eq12885
  have eq48507 : ∀ X0 X1 : G, (M.op X0 X0) = (k (σ (τ X1)) X1) ∨ (M.op X0 X0) = (σ (τ X1)) := by
    intro X0 X1
    first
    | (have i₁ := eq16 X1 (τ X1)
    ...
    | grind (splits := 40) (ematch := 20)
  clear eq16 eq332
  have eq48584 : ∀ X0 X1 : G, (M.op X0 X0) = (k (σ (τ X1)) X1) := by
    intro X0 X1
    first
    | (have j0 := eq48507 X0 X1
       have j1 := eq316 X0 (σ (τ X1)) X1
       grind)
    | (have r₁ := eq48507 X0 X1
       have r₂ := eq316 X0 (k (σ (τ X1)) X1) x
       grind)
    | (have r₁ := eq48507 X0 X1
       have r₂ := eq316 X0 (σ (τ X1)) x
       grind)
    | exact resolve eq48507 eq316
    | grind
    | grind (splits := 40)
    | grind (splits := 40) (ematch := 20)
  clear eq316 eq48507
  have eq48732 : ∀ X0 X1 : G, (M.op X0 X0) = (k X1 X1) := by
    intro X0 X1
    first
    | (have i₁ := eq48584 X0 X1
       have i₂ := eq10 X1
       grind)
    | exact superpose eq10 eq48584
    | exact resolve eq48584 eq10
    | grind
    | grind (splits := 40)
    | grind (splits := 40) (ematch := 20)
  clear eq48584
  have eq50885 : ∀ X0 X1 X3 : G, (M.op X1 X1) = (k (k X0 X0) X3) := by
    intro X0 X1 X3
    first
    | (have i₁ := eq5691 X1 x X3
       have i₂ := eq48732 x X0
       grind)
    | exact superpose eq48732 eq5691
    | exact resolve eq5691 eq48732
    | grind
    | grind (splits := 40)
    | grind (splits := 40) (ematch := 20)
  clear eq5691
  have eq51123 : ∀ X0 X1 : G, (M.op X0 X0) = (σ (k X1 X1)) := by
    intro X0 X1
    first
    | (have i₁ := eq13 X1 X1
       have i₂ := eq48732 X0 (σ X1)
       grind)
    | exact superpose eq48732 eq13
    | exact resolve eq13 eq48732
    | grind
    | grind (splits := 40)
    | grind (splits := 40) (ematch := 20)
  have eq51137 : ∀ X0 X1 : G, (M.op X0 X0) = (τ (k X1 X1)) := by
    intro X0 X1
    first
    | (have i₁ := eq31 X1 X1
       have i₂ := eq48732 X0 (τ X1)
       grind)
    | exact superpose eq48732 eq31
    | exact resolve eq31 eq48732
    | grind
    | grind (splits := 40)
    | grind (splits := 40) (ematch := 20)
  clear eq31
  have eq51142 : ∀ X0 X1 : G, (σ (M.op X0 X0)) = (k X1 (σ (τ X1))) := by
    intro X0 X1
    first
    | (have i₁ := eq15 X1 (τ X1)
       have i₂ := eq48732 X0 (τ X1)
       grind)
    | exact superpose eq48732 eq15
    | exact resolve eq15 eq48732
    | grind
    | grind (splits := 40)
    | grind (splits := 40) (ematch := 20)
  clear eq15
  have eq51150 : ∀ X0 X1 : G, (k X1 X1) = (σ (M.op X0 X0)) := by
    intro X0 X1
    first
    | (have i₁ := eq51142 X0 X1
       have i₂ := eq10 X1
       grind)
    | exact superpose eq10 eq51142
    | exact resolve eq51142 eq10
    | grind
    | grind (splits := 40)
    | grind (splits := 40) (ematch := 20)
  clear eq51142
  have eq66066 : ∀ X0 X1 : G, (k X1 X1) = (σ (σ (k X0 X0))) := by
    intro X0 X1
    first
    | (have i₁ := eq51150 x X1
       have i₂ := eq51123 x X0
       grind)
    | exact superpose eq51123 eq51150
    | exact resolve eq51150 eq51123
    | grind
    | grind (splits := 40)
    | grind (splits := 40) (ematch := 20)
  clear eq51123 eq51150
  have eq85583 : ∀ X0 X1 X3 : G, (k (k X0 X0) X1) = (τ (k X3 X3)) := by
    intro X0 X1 X3
    first
    | (have i₁ := eq51137 x X3
       have i₂ := eq50885 X0 x X1
       grind)
    | exact superpose eq50885 eq51137
    | exact resolve eq51137 eq50885
    | grind
    | grind (splits := 40)
    | grind (splits := 40) (ematch := 20)
  clear eq50885 eq51137
  have eq163835 : ∀ X0 X1 X2 : G, (σ X0) = (σ (k X0 X1)) ∨ (k (σ X0) (σ X2)) = (σ (M.op X2 (τ (σ X0)))) := by
    intro X0 X1 X2
    first
    | (have i₁ := eq13 X0 X1
       have i₂ := eq927 X2 (σ X0) (σ X1)
       grind)
    | exact superpose eq927 eq13
    | (have j1 := eq927 X2 (σ X0) X2
       grind)
    ...
    | grind (splits := 40) (ematch := 20)
  clear eq927
  have eq164005 : ∀ X0 X1 X2 : G, (k (σ X0) (σ X2)) = (σ (M.op X2 X0)) ∨ (σ X0) = (σ (k X0 X1)) := by
    intro X0 X1 X2
    first
    | (have i₁ := eq163835 X0 X1 X2
       have i₂ := eq9 X0
       grind)
    | exact superpose eq9 eq163835
    | (have j0 := eq163835 X0 X1 X2
       grind)
    | exact resolve eq163835 eq9
    | grind
    | grind (splits := 40)
    | grind (splits := 40) (ematch := 20)
  clear eq163835
  have eq164096 : ∀ X0 X1 X2 : G, (σ (k X0 X2)) = (σ (M.op X2 X0)) ∨ (σ X0) = (σ (k X0 X1)) := by
    intro X0 X1 X2
    first
    | (have i₁ := eq164005 X0 X1 X2
       have i₂ := eq13 X0 X2
       grind)
    | exact superpose eq13 eq164005
    | (have j0 := eq164005 X0 X1 X2
       grind)
    | exact resolve eq164005 eq13
    | grind
    | grind (splits := 40)
    | grind (splits := 40) (ematch := 20)
  clear eq164005
  have eq233613 : ∀ X0 : G, (σ (M.op x y)) ≠ (σ (k y x)) ∨ (σ y) = (σ (k y X0)) := by
    intro X0
    first
    | (have i₁ := eq14
       have i₂ := eq12366 x y X0
       grind)
    | exact superpose eq12366 eq14
    | (have j1 := eq12366 X0 y X0
       grind)
    | exact resolve eq14 eq12366
    | grind
    | grind (splits := 40)
    | grind (splits := 40) (ematch := 20)
  clear eq12366
  have eq234153 : ∀ X0 : G, (σ y) = (σ (k y X0)) := by
    intro X0
    first
    | (have j0 := eq233613 X0
       have j1 := eq164096 y X0 x
       grind)
    | (have r₁ := eq233613 X0
       have r₂ := eq164096 y x x
       grind)
    | exact resolve eq233613 eq164096
    | grind
    | grind (splits := 40)
    | grind (splits := 40) (ematch := 20)
  clear eq164096 eq233613
  have eq234437 : ∀ X0 : G, (k X0 X0) = (σ (σ y)) := by
    intro X0
    first
    | (have i₁ := eq66066 y X0
       have i₂ := eq234153 y
       grind)
    | exact superpose eq234153 eq66066
    | exact resolve eq66066 eq234153
    | grind
    | grind (splits := 40)
    | grind (splits := 40) (ematch := 20)
  clear eq66066
  have eq234456 : ∀ X0 : G, (k y X0) = (τ (σ y)) := by
    intro X0
    first
    | (have i₁ := eq9 (k y X0)
       have i₂ := eq234153 X0
       grind)
    | exact superpose eq234153 eq9
    | exact resolve eq9 eq234153
    | grind
    | grind (splits := 40)
    | grind (splits := 40) (ematch := 20)
  clear eq234153
  have eq234548 : ∀ X0 : G, y = (k y X0) := by
    intro X0
    first
    | (have i₁ := eq234456 X0
       have i₂ := eq9 y
       grind)
    | exact superpose eq9 eq234456
    | exact resolve eq234456 eq9
    | grind
    | grind (splits := 40)
    | grind (splits := 40) (ematch := 20)
  clear eq234456
  have eq235481 : ∀ X0 : G, (M.op X0 X0) = y := by
    intro X0
    first
    | (have i₁ := eq48732 X0 y
       have i₂ := eq234548 y
       grind)
    | exact superpose eq234548 eq48732
    | exact resolve eq48732 eq234548
    | grind
    | grind (splits := 40)
    | grind (splits := 40) (ematch := 20)
  clear eq48732
  have eq235515 : ∀ X0 X1 : G, (τ (k X1 X1)) = (k y X0) := by
    intro X0 X1
    first
    | (have i₁ := eq85583 y X0 X1
       have i₂ := eq234548 y
       grind)
    | exact superpose eq234548 eq85583
    | exact resolve eq85583 eq234548
    | grind
    | grind (splits := 40)
    | grind (splits := 40) (ematch := 20)
  clear eq85583
  have eq235578 : ∀ X1 : G, y = (τ (k X1 X1)) := by
    intro X1
    first
    | (have i₁ := eq235515 x X1
       have i₂ := eq234548 x
       grind)
    | exact superpose eq234548 eq235515
    | exact resolve eq235515 eq234548
    | grind
    | grind (splits := 40)
    | grind (splits := 40) (ematch := 20)
  clear eq234548 eq235515
  have eq235610 : y = (τ (σ (σ y))) := by
    first
    | (have i₁ := eq235578 x
       have i₂ := eq234437 x
       grind)
    | exact superpose eq234437 eq235578
    | exact resolve eq235578 eq234437
    | grind
    | grind (splits := 40)
    | grind (splits := 40) (ematch := 20)
  clear eq234437 eq235578
  have eq235625 : y = (σ y) := by
    first
    | (have i₁ := eq235610
       have i₂ := eq9 (σ y)
       grind)
    | exact superpose eq9 eq235610
    | exact resolve eq235610 eq9
    | grind
    | grind (splits := 40)
    | grind (splits := 40) (ematch := 20)
  clear eq235610
  have eq235898 : (σ (M.op x y)) ≠ (M.op (σ x) y) := by
    first
    | (have i₁ := eq14
       have i₂ := eq235625
       grind)
    | exact superpose eq235625 eq14
    | exact resolve eq14 eq235625
    | grind
    | grind (splits := 40)
    | grind (splits := 40) (ematch := 20)
  have eq235901 : ∀ X0 : G, (σ (k X0 y)) = (k (σ X0) y) := by
    intro X0
    first
    | (have i₁ := eq13 X0 y
       have i₂ := eq235625
       grind)
    | exact superpose eq235625 eq13
    | exact resolve eq13 eq235625
    | grind
    | grind (splits := 40)
    | grind (splits := 40) (ematch := 20)
  clear eq235625
  have eq236449 : ∀ X0 X1 X3 : G, (k X0 X1) = (M.op y X0) ∨ (M.op X3 X0) = (k X0 X3) := by
    intro X0 X1 X3
    first
    | (have i₁ := eq13187 x X0 X1 X3
       have i₂ := eq235481 x
       grind)
    | exact superpose eq235481 eq13187
    | (have j0 := eq13187 X0 X0 x X3
       grind)
    | exact resolve eq13187 eq235481
    | grind
    | grind (splits := 40)
    | grind (splits := 40) (ematch := 20)
  clear eq13187
  have eq236643 : ∀ X0 X1 : G, (M.op X0 (M.op X0 X1)) = (M.op X1 y) := by
    intro X0 X1
    first
    | (have i₁ := eq8 X0 (M.op X0 X1) X1
       have i₂ := eq235481 (M.op X0 X1)
       grind)
    | exact superpose eq235481 eq8
    | exact resolve eq8 eq235481
    | grind
    | grind (splits := 40)
    | grind (splits := 40) (ematch := 20)
  clear eq235481
  have eq1671118 : ∀ X0 X1 : G, (M.op X1 X0) ≠ (M.op y X0) ∨ (k X0 X1) = (M.op X1 X0) := by
    intro X0 X1
    first
    | (have j0 := eq236449 X0 X1 X1
       grind)
    | grind
    | grind (splits := 40)
    | grind (splits := 40) (ematch := 20)
  clear eq236449
  have eq1962796 : ∀ X0 : G, (k X0 y) = (M.op y X0) := by
    intro X0
    first
    | (have j0 := eq1671118 X0 y
       grind)
    | grind
    | grind (splits := 40)
    | grind (splits := 40) (ematch := 20)
  clear eq1671118
  have eq1963548 : ∀ X0 : G, (σ (k X0 y)) = (M.op y (σ X0)) := by
    intro X0
    first
    | (have i₁ := eq235901 X0
       have i₂ := eq1962796 (σ X0)
       grind)
    | exact superpose eq1962796 eq235901
    | exact resolve eq235901 eq1962796
    | grind
    | grind (splits := 40)
    | grind (splits := 40) (ematch := 20)
  clear eq235901
  have eq1964049 : ∀ X0 : G, (M.op y (σ X0)) = (σ (M.op y X0)) := by
    intro X0
    first
    | (have i₁ := eq1963548 X0
       have i₂ := eq1962796 X0
       grind)
    | exact superpose eq1962796 eq1963548
    | exact resolve eq1963548 eq1962796
    | grind
    | grind (splits := 40)
    | grind (splits := 40) (ematch := 20)
  clear eq1962796 eq1963548
  have eq1965490 : ∀ X0 : G, (σ (M.op X0 y)) = (M.op y (σ (M.op y X0))) := by
    intro X0
    first
    | (have i₁ := eq1964049 (M.op y X0)
       have i₂ := eq236643 y X0
       grind)
    | exact superpose eq236643 eq1964049
    | exact resolve eq1964049 eq236643
    | grind
    | grind (splits := 40)
    | grind (splits := 40) (ematch := 20)
  have eq1966055 : ∀ X0 : G, (σ (M.op X0 y)) = (M.op y (M.op y (σ X0))) := by
    intro X0
    first
    | (have i₁ := eq1965490 X0
       have i₂ := eq1964049 X0
       grind)
    | exact superpose eq1964049 eq1965490
    | exact resolve eq1965490 eq1964049
    | grind
    | grind (splits := 40)
    | grind (splits := 40) (ematch := 20)
  clear eq1964049 eq1965490
  have eq1966258 : ∀ X0 : G, (σ (M.op X0 y)) = (M.op (σ X0) y) := by
    intro X0
    first
    | (have i₁ := eq1966055 X0
       have i₂ := eq236643 y (σ X0)
       grind)
    | exact superpose eq236643 eq1966055
    | exact resolve eq1966055 eq236643
    | grind
    | grind (splits := 40)
    | grind (splits := 40) (ematch := 20)
  clear eq236643 eq1966055
  have eq1968391 : (M.op (σ x) y) ≠ (M.op (σ x) y) := by
    first
    | (have i₁ := eq235898
       have i₂ := eq1966258 x
       grind)
    | exact superpose eq1966258 eq235898
    | (have r₁ := eq235898
       have r₂ := eq1966258 x
       grind)
    | exact resolve eq235898 eq1966258
    | grind
    | grind (splits := 40)
    | grind (splits := 40) (ematch := 20)
  clear eq235898 eq1966258
  have eq1968425 : False := by grind
  exact eq1968425
