...
/-- No mau11h110a-invariant operation on `Fin 11` satisfies equation 3675. -/
theorem nomau11h110a_Law3675 : ∀ v : ∀ i : Fin 2,
    {x : Fin 11 // Magma.orbitOK mau11h110a.E mau11h110a.z mau11h110a.st i x},
    ¬ @satisfies _ (Fin 11)
      (Magma.mk (Magma.transport mau11h110a.E mau11h110a.tr fun i ↦ (v i).1)) Law3675 := by
