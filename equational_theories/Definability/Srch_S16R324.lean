import equational_theories.Definability.Srch_S16R324_data
...
is `decide` on `Fin 16`; the searching is in `Definability/Certs/Srch16R324T*.lean`.
-/
...
theorem not_structuralFromFin_of_srch16R324 {L L' : Law.NatMagmaLaw} (v : Magma.tup16R324)
    (hsrc : @satisfies _ (Fin 16) (Magma.srch16R324 v) L')
    (htgt : ∀ u : Magma.tup16R324, ¬ @satisfies _ (Fin 16) (Magma.srch16R324 u) L) :
    ¬ L.StructuralFromFin L' :=
  Law.MagmaLaw.not_structuralFromFin_of_tupOK S16R324.E S16R324.Einv S16R324.X S16R324.Xinv S16R324.rep S16R324.tr
    S16R324.z S16R324.st S16R324.hl S16R324.hr S16R324.hxl S16R324.hxr S16R324.htr S16R324.hz S16R324.hst v.1 v.2 hsrc htgt
