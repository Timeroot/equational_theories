import equational_theories.Definability.Srch_S7R21_data
...
is `decide` on `Fin 7`; the searching is in `Definability/Certs/Srch7R21T*.lean`.
-/
...
theorem not_structuralFromFin_of_srch7R21 {L L' : Law.NatMagmaLaw} (v : Magma.tup7R21)
    (hsrc : @satisfies _ (Fin 7) (Magma.srch7R21 v) L')
    (htgt : ∀ u : Magma.tup7R21, ¬ @satisfies _ (Fin 7) (Magma.srch7R21 u) L) :
    ¬ L.StructuralFromFin L' :=
  Law.MagmaLaw.not_structuralFromFin_of_tupOK S7R21.E S7R21.Einv S7R21.X S7R21.Xinv S7R21.rep S7R21.tr
    S7R21.z S7R21.st S7R21.hl S7R21.hr S7R21.hxl S7R21.hxr S7R21.htr S7R21.hz S7R21.hst v.1 v.2 hsrc htgt
