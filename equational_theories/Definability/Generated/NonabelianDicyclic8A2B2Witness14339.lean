...
namespace Magma.NonabelianDicyclic8A2B2Witness14339
...
def sourceRowData : Array (Array (Fin 8)) := #[#[3, 0, 0, 0, 0, 7, 0, 5], #[1, 0, 1, 1, 6, 1, 4, 1], #[2, 2, 1, 2, 2, 7, 2, 5], #[3, 3, 3, 2, 6, 3, 4, 3], #[4, 3, 4, 1, 5, 4, 4, 4], #[2, 5, 0, 5, 5, 6, 5, 5], #[6, 3, 6, 1, 6, 6, 7, 6], #[2, 7, 0, 7, 7, 7, 7, 4]]
...
end Magma.NonabelianDicyclic8A2B2Witness14339

open Magma.NonabelianDicyclic8A2B2Witness14339

theorem Equation4406_not_structuralFromFin_Equation433_nonabelianDicyclic8A2B2Witness14339 : ¬ Law4406.StructuralFromFin Law433 := by
  apply Magma.FiniteSymmetry.not_structuralFromFin source genPerm probePerm pattern fam coverage
  · exact (@Law433.models_iff (Fin 8) source).mpr (by native_decide)
...
/-- info: 'Equation4406_not_structuralFromFin_Equation433_nonabelianDicyclic8A2B2Witness14339' depends on axioms: [propext,
 Classical.choice,
 Quot.sound,
 Equation4406_not_structuralFromFin_Equation433_nonabelianDicyclic8A2B2Witness14339._native.native_decide.ax_1_1,
...
#print axioms Equation4406_not_structuralFromFin_Equation433_nonabelianDicyclic8A2B2Witness14339
