...
namespace Magma.Ring2Degree3TruncatedPower2Witness12181
...
def sourceRowData : Array (Array (Fin 8)) := #[#[2, 5, 0, 7, 6, 1, 4, 3], #[4, 3, 6, 1, 0, 7, 2, 5], #[2, 5, 0, 7, 6, 1, 4, 3], #[4, 3, 6, 1, 0, 7, 2, 5], #[2, 5, 0, 7, 6, 1, 4, 3], #[4, 3, 6, 1, 0, 7, 2, 5], #[2, 5, 0, 7, 6, 1, 4, 3], #[4, 3, 6, 1, 0, 7, 2, 5]]
...
end Magma.Ring2Degree3TruncatedPower2Witness12181

open Magma.Ring2Degree3TruncatedPower2Witness12181

theorem Equation3556_not_structuralFromFin_Equation1096_ring2Degree3TruncatedPower2Witness12181 : ¬ Law3556.StructuralFromFin Law1096 := by
  apply Magma.FiniteSymmetry.not_structuralFromFin source genPerm probePerm pattern fam coverage
  · exact (@Law1096.models_iff (Fin 8) source).mpr (by native_decide)
...
/-- info: 'Equation3556_not_structuralFromFin_Equation1096_ring2Degree3TruncatedPower2Witness12181' depends on axioms: [propext,
 Classical.choice,
 Quot.sound,
 Equation3556_not_structuralFromFin_Equation1096_ring2Degree3TruncatedPower2Witness12181._native.native_decide.ax_1_1,
...
#print axioms Equation3556_not_structuralFromFin_Equation1096_ring2Degree3TruncatedPower2Witness12181
