...
namespace Magma.NonabelianDicyclic12A1B2Witness2085
...
def sourceRowData : Array (Array (Fin 12)) := #[#[3, 4, 5, 0, 1, 2, 6, 10, 8, 6, 10, 8], #[3, 4, 5, 0, 1, 2, 9, 7, 11, 9, 7, 11], #[3, 4, 5, 0, 1, 2, 6, 10, 8, 6, 10, 8], #[3, 4, 5, 0, 1, 2, 9, 7, 11, 9, 7, 11], #[3, 4, 5, 0, 1, 2, 6, 10, 8, 6, 10, 8], #[3, 4, 5, 0, 1, 2, 9, 7, 11, 9, 7, 11], #[3, 1, 5, 3, 1, 5, 9, 10, 11, 6, 7, 8], #[0, 4, 2, 0, 4, 2, 9, 10, 11, 6, 7, 8], #[3, 1, 5, 3, 1, 5, 9, 10, 11, 6, 7, 8], #[0, 4, 2, 0, 4, 2, 9, 10, 11, 6, 7, 8], #[3, 1, 5, 3, 1, 5, 9, 10, 11, 6, 7, 8], #[0, 4, 2, 0, 4, 2, 9, 10, 11, 6, 7, 8]]
...
end Magma.NonabelianDicyclic12A1B2Witness2085

open Magma.NonabelianDicyclic12A1B2Witness2085

theorem Equation3462_not_structuralFromFin_Equation1687_nonabelianDicyclic12A1B2Witness2085 : ¬ Law3462.StructuralFromFin Law1687 := by
  apply Magma.FiniteSymmetry.not_structuralFromFin source genPerm probePerm pattern fam coverage
  · exact (@Law1687.models_iff (Fin 12) source).mpr (by native_decide)
...
/-- info: 'Equation3462_not_structuralFromFin_Equation1687_nonabelianDicyclic12A1B2Witness2085' depends on axioms: [propext,
 Classical.choice,
 Quot.sound,
 Equation3462_not_structuralFromFin_Equation1687_nonabelianDicyclic12A1B2Witness2085._native.native_decide.ax_1_1,
...
#print axioms Equation3462_not_structuralFromFin_Equation1687_nonabelianDicyclic12A1B2Witness2085
