...
namespace Magma.Ring2Degree4TruncatedPower1Witness216
...
def sourceRowData : Array (Array (Fin 16)) := #[#[0, 12, 12, 4, 0, 12, 4, 4, 0, 12, 12, 4, 0, 12, 4, 4], #[13, 1, 5, 13, 13, 1, 5, 5, 13, 1, 5, 13, 13, 1, 5, 5], #[14, 6, 2, 14, 6, 6, 2, 14, 14, 6, 2, 14, 6, 6, 2, 14], #[7, 15, 15, 3, 7, 7, 15, 3, 7, 15, 15, 3, 7, 7, 15, 3], #[4, 8, 0, 0, 4, 8, 8, 0, 4, 8, 0, 0, 4, 8, 8, 0], #[9, 5, 1, 1, 9, 5, 1, 9, 9, 5, 1, 1, 9, 5, 1, 9], #[2, 2, 6, 10, 10, 2, 6, 10, 2, 2, 6, 10, 10, 2, 6, 10], #[3, 3, 11, 7, 3, 11, 11, 7, 3, 3, 11, 7, 3, 11, 11, 7], #[8, 4, 4, 12, 8, 4, 12, 12, 8, 4, 4, 12, 8, 4, 12, 12], #[5, 9, 13, 5, 5, 9, 13, 13, 5, 9, 13, 5, 5, 9, 13, 13], #[6, 14, 10, 6, 14, 14, 10, 6, 6, 14, 10, 6, 14, 14, 10, 6], #[15, 7, 7, 11, 15, 15, 7, 11, 15, 7, 7, 11, 15, 15, 7, 11], #[12, 0, 8, 8, 12, 0, 0, 8, 12, 0, 8, 8, 12, 0, 0, 8], #[1, 13, 9, 9, 1, 13, 9, 1, 1, 13, 9, 9, 1, 13, 9, 1], #[10, 10, 14, 2, 2, 10, 14, 2, 10, 10, 14, 2, 2, 10, 14, 2], #[11, 11, 3, 15, 11, 3, 3, 15, 11, 11, 3, 15, 11, 3, 3, 15]]
...
end Magma.Ring2Degree4TruncatedPower1Witness216

open Magma.Ring2Degree4TruncatedPower1Witness216

theorem Equation4435_not_structuralFromFin_Equation1237_ring2Degree4TruncatedPower1Witness216 : ¬ Law4435.StructuralFromFin Law1237 := by
  apply Magma.FiniteSymmetry.not_structuralFromFin source genPerm probePerm pattern fam coverage
  · exact (@Law1237.models_iff (Fin 16) source).mpr (by native_decide)
...
/-- info: 'Equation4435_not_structuralFromFin_Equation1237_ring2Degree4TruncatedPower1Witness216' depends on axioms: [propext,
 Classical.choice,
 Quot.sound,
 Equation4435_not_structuralFromFin_Equation1237_ring2Degree4TruncatedPower1Witness216._native.native_decide.ax_1_1,
...
#print axioms Equation4435_not_structuralFromFin_Equation1237_ring2Degree4TruncatedPower1Witness216

theorem Equation4435_not_structuralFromFin_Equation3723_ring2Degree4TruncatedPower1Witness216 : ¬ Law4435.StructuralFromFin Law3723 := by
  apply Magma.FiniteSymmetry.not_structuralFromFin source genPerm probePerm pattern fam coverage
  · exact (@Law3723.models_iff (Fin 16) source).mpr (by native_decide)
  · exact source_generators
  · exact source_pattern
  · intro p hp
    intro hpattern
...
/-- info: 'Equation4435_not_structuralFromFin_Equation3723_ring2Degree4TruncatedPower1Witness216' depends on axioms: [propext,
 Classical.choice,
 Quot.sound,
 Equation4435_not_structuralFromFin_Equation3723_ring2Degree4TruncatedPower1Witness216._native.native_decide.ax_1_1,
 gen_inverse._native.native_decide.ax_1_1,
 probe_inverse._native.native_decide.ax_1_1,
 source_generators._native.native_decide.ax_1_1,
 source_pattern._native.native_decide.ax_1_1,
 ...
 values_complete._native.native_decide.ax_1_1] -/
#guard_msgs (whitespace := lax) in
#print axioms Equation4435_not_structuralFromFin_Equation3723_ring2Degree4TruncatedPower1Witness216
