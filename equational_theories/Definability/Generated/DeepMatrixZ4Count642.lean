...
def law642 : MagmaLaw (Fin 2) := ⟨(.Leaf 0), (.Fork (.Leaf 0) (.Fork (.Leaf 1) (.Fork (.Fork (.Leaf 1) (.Leaf 1)) (.Leaf 0))))⟩
theorem count642 : Fintype.card {p : P (ZMod 4) 2 // Test law642 p} = 205 := by
  native_decide
