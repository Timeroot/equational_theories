...
namespace Magma.ProjectionBase4By5Actions13And1234
abbrev A := ZMod 4
abbrev B := ZMod 5
abbrev K := Fin 5
...
def transportData : Array (Fin 2 × Fin 4) := #[(0, 3), (1, 0), (1, 1), (1, 2), (1, 3)]
def transport (b : B) := transportData.getD b.val (0, 0)
def choiceData : Array (Array B) := #[#[0], #[0, 1, 2, 3, 4]]
def sizes (i : Fin 2) : ℕ := (choiceData.getD i.val #[]).size
def choices (i : Fin 2) (q : Fin (sizes i)) : B := (choiceData.getD i.val #[]).getD q.val 0
def stabilizerData : Array (Array (Fin 4)) := #[#[0, 1, 2, 3], #[0, 0, 0, 0]]
def stabilizers (i : Fin 2) (j : Fin 4) := (stabilizerData.getD i.val #[]).getD j.val 0
...
private def law827 : MagmaLaw (Fin 3) := ⟨(.Leaf 0), (.Fork (.Leaf 0) (.Fork (.Fork (.Leaf 0) (.Leaf 1)) (.Fork (.Leaf 1) (.Leaf 2))))⟩
private theorem count827 : Fintype.card {p : Params // ZeroTest (model p) law827} = 50 := by native_decide

private def law3318 : MagmaLaw (Fin 2) := ⟨(.Fork (.Leaf 0) (.Leaf 1)), (.Fork (.Leaf 0) (.Fork (.Leaf 1) (.Fork (.Leaf 1) (.Leaf 0))))⟩
private theorem count3318 : Fintype.card {p : Params // ZeroTest (model p) law3318} = 44 := by native_decide

end Magma.ProjectionBase4By5Actions13And1234

open Magma.ProjectionBase4By5Actions13And1234

theorem Equation3318_not_termStructuralFromFin_Equation827_projectionBase4By5Actions13And1234 : ¬ Law3318.TermStructuralFromFin Law827 := by
  apply Magma.InvariantFamily.not_termStructuralFromFin (Magma.ProjectionBaseFamily.gen maps baseMaps)
    ...
    (fun p => ZeroTest (model p) law827) (fun p => ZeroTest (model p) law3318)
  · intro p hp φ
  ...
  · rw [count827, count3318]
    decide

/-- info: 'Equation3318_not_termStructuralFromFin_Equation827_projectionBase4By5Actions13And1234' depends on axioms: [propext,
 Classical.choice,
 Quot.sound,
 ...
 count3318._native.native_decide.ax_1_1,
 count827._native.native_decide.ax_1_1] -/
#guard_msgs (whitespace := lax) in
#print axioms Equation3318_not_termStructuralFromFin_Equation827_projectionBase4By5Actions13And1234
