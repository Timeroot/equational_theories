...
namespace Magma.NonabelianSetactionTuples5Choose2SymmetricWitness93311
...
def sourceRowData : Array (Array (Fin 20)) := #[#[4, 9, 13, 17, 4, 9, 13, 17, 9, 9, 17, 13, 13, 13, 17, 9, 17, 17, 13, 9], #[5, 8, 14, 18, 5, 5, 18, 14, 8, 5, 14, 18, 14, 18, 14, 5, 18, 14, 18, 5], #[6, 10, 12, 19, 6, 19, 6, 10, 10, 19, 10, 6, 12, 6, 10, 19, 19, 10, 6, 19], #[7, 11, 15, 16, 7, 15, 11, 7, 11, 15, 7, 11, 15, 11, 7, 15, 16, 7, 11, 15], #[0, 8, 12, 16, 0, 8, 12, 16, 8, 8, 16, 12, 12, 12, 16, 8, 16, 16, 12, 8], #[1, 1, 18, 14, 1, 9, 14, 18, 1, 9, 14, 18, 18, 14, 14, 1, 14, 18, 18, 1], #[2, 19, 2, 10, 2, 10, 13, 19, 19, 10, 10, 2, 2, 13, 10, 19, 10, 19, 2, 19], #[3, 15, 11, 3, 3, 11, 15, 17, 15, 11, 3, 11, 11, 15, 3, 15, 3, 17, 11, 15], #[4, 1, 12, 16, 4, 4, 16, 12, 1, 4, 12, 16, 12, 16, 12, 4, 16, 12, 16, 4], #[0, 0, 17, 13, 0, 5, 13, 17, 0, 5, 13, 17, 17, 13, 13, 0, 13, 17, 17, 0], #[19, 2, 2, 6, 19, 6, 6, 2, 2, 6, 14, 19, 2, 6, 14, 19, 6, 2, 19, 19], #[15, 3, 7, 3, 15, 7, 3, 7, 3, 7, 15, 18, 7, 3, 15, 15, 3, 7, 18, 15], #[4, 8, 2, 16, 4, 16, 4, 8, 8, 16, 8, 4, 2, 4, 8, 16, 16, 8, 4, 16], #[0, 17, 0, 9, 0, 9, 6, 17, 17, 9, 9, 0, 0, 6, 9, 17, 9, 17, 0, 17], #[18, 1, 1, 5, 18, 5, 5, 1, 1, 5, 10, 18, 1, 5, 10, 18, 5, 1, 18, 18], #[11, 7, 3, 3, 11, 3, 7, 7, 7, 3, 11, 11, 3, 7, 11, 19, 3, 7, 11, 19], #[4, 8, 12, 3, 4, 12, 8, 4, 8, 12, 4, 8, 12, 8, 4, 12, 3, 4, 8, 12], #[0, 13, 9, 0, 0, 9, 13, 7, 13, 9, 0, 9, 9, 13, 0, 13, 0, 7, 9, 13], #[14, 1, 5, 1, 14, 5, 1, 5, 1, 5, 14, 11, 5, 1, 14, 14, 1, 5, 11, 14], #[10, 6, 2, 2, 10, 2, 6, 6, 6, 2, 10, 10, 2, 6, 10, 15, 2, 6, 10, 15]]
...
end Magma.NonabelianSetactionTuples5Choose2SymmetricWitness93311

open Magma.NonabelianSetactionTuples5Choose2SymmetricWitness93311

theorem Equation1278_not_structuralFromFin_Equation1645_nonabelianSetactionTuples5Choose2SymmetricWitness93311 : ¬ Law1278.StructuralFromFin Law1645 := by
  apply Magma.FiniteSymmetry.not_structuralFromFin source genPerm probePerm pattern fam coverage
  · exact (@Law1645.models_iff (Fin 20) source).mpr (by native_decide)
  · exact source_generators
  · exact source_pattern
  · intro p hp
    exact target1278 p ((@Law1278.models_iff (Fin 20) (fam p)).mp hp)

/-- info: 'Equation1278_not_structuralFromFin_Equation1645_nonabelianSetactionTuples5Choose2SymmetricWitness93311' depends on axioms: [propext,
 Classical.choice,
 Quot.sound,
 Equation1278_not_structuralFromFin_Equation1645_nonabelianSetactionTuples5Choose2SymmetricWitness93311._native.native_decide.ax_1_1,
...
#print axioms Equation1278_not_structuralFromFin_Equation1645_nonabelianSetactionTuples5Choose2SymmetricWitness93311
