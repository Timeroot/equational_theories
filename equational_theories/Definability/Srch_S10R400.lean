import equational_theories.Definability.Srch_S10R400_data
...
is `decide` on `Fin 10`; the searching is in `Definability/Certs/Srch10R400T*.lean`.
-/
...
theorem not_structuralFromFin_of_srch10R400 {L L' : Law.NatMagmaLaw} (v : Magma.tup10R400)
    (hsrc : @satisfies _ (Fin 10) (Magma.srch10R400 v) L')
    (htgt : ∀ u : Magma.tup10R400, ¬ @satisfies _ (Fin 10) (Magma.srch10R400 u) L) :
    ¬ L.StructuralFromFin L' :=
  Law.MagmaLaw.not_structuralFromFin_of_tupOK S10R400.E S10R400.Einv S10R400.X S10R400.Xinv S10R400.rep S10R400.tr
    S10R400.z S10R400.st S10R400.hl S10R400.hr S10R400.hxl S10R400.hxr S10R400.htr S10R400.hz S10R400.hst v.1 v.2 hsrc htgt
