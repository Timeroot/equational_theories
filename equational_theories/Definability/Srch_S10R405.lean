import equational_theories.Definability.Srch_S10R405_data
...
is `decide` on `Fin 10`; the searching is in `Definability/Certs/Srch10R405T*.lean`.
-/
...
theorem not_structuralFromFin_of_srch10R405 {L L' : Law.NatMagmaLaw} (v : Magma.tup10R405)
    (hsrc : @satisfies _ (Fin 10) (Magma.srch10R405 v) L')
    (htgt : ∀ u : Magma.tup10R405, ¬ @satisfies _ (Fin 10) (Magma.srch10R405 u) L) :
    ¬ L.StructuralFromFin L' :=
  Law.MagmaLaw.not_structuralFromFin_of_tupOK S10R405.E S10R405.Einv S10R405.X S10R405.Xinv S10R405.rep S10R405.tr
    S10R405.z S10R405.st S10R405.hl S10R405.hr S10R405.hxl S10R405.hxr S10R405.htr S10R405.hz S10R405.hst v.1 v.2 hsrc htgt
