...
- [Equation 46]({{ '/implications/?46' | relative_url }}): `x ◇ y = z ◇ w`.  The constant law.
- [Equation 4512]({{ '/implications/?4512' | relative_url }}): `x ◇ (y ◇ z) = (x ◇ y) ◇ z`.  The associative law.
...
- [Graphiti]({{ '/graphiti' | relative_url }}) visualizes the order of equivalence classes for each of these relations.
