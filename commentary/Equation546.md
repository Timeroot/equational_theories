...
The affine Gaussian-module representation and the exact positive finite spectrum
are now proved in Lean. `Spectrum.exact_546` in
`equational_theories/Spectrum/Equation546.lean` proves that the spectrum consists
of the positive sums of two squares. See
[the formal proof description](../docs/546_gaussian_spectrum_theorem.md).
