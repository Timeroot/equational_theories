...
The finite spectrum is exactly the positive integers except {2, 6}. This is proved in Lean by `Spectrum.Catalogue.exact_873`; see the [construction and exclusion proofs](../docs/quasigroup_spectra.md).
