...
- [extract_implications --json]({{site.baseurl}}/raw_data/general.json.gz)
- [extract_implications --json --closure --only-implications]({{site.baseurl}}/raw_data/general_implications_closure.json.gz)
- [extract_implications raw --full-entries]({{site.baseurl}}/raw_data/general_raw_full_entries.json.gz)
- [extract_implications outcomes]({{site.baseurl}}/raw_data/general_outcomes.json.gz)

Finite graph:

- [extract_implications --json --finite-only]({{site.baseurl}}/raw_data/finite.json.gz)
- [extract_implications --json --closure --only-implications --finite-only]({{site.baseurl}}/raw_data/finite_implications_closure.json.gz)
- [extract_implications raw --full-entries --finite-only]({{site.baseurl}}/raw_data/finite_raw_full_entries.json.gz)
- [extract_implications outcomes --finite-only]({{site.baseurl}}/raw_data/finite_outcomes.json.gz)
\n\n"""
    )
...
\n\n""")
    ...
    outfile.write("""
<script src="{{site.baseurl}}/progresswidget/progresswidget.js"></script>
<script>
progresswidget({
  container: 'progress-container',
  statusbar: 'progress-status',
  small: '{{site.baseurl}}/dashboard/outcomes.png',
  full: '{{site.baseurl}}/dashboard/outcomes.png',
  eqdb: '{{site.baseurl}}/fme/eqdb.json'
});
</script>
\n\n"""
    )
